const vw = window.VLibrasWidget = Object.assign({ path: "https://diegofrr.github.io/vlibras-widget-plus/v7-customization" }, window.VLibrasWidget);
(window.VLibras = window.VLibras || {}).Widget = function(path, configUrl, avatar, position) {
	Object.assign(vw, {
		path: path || vw.path,
		configUrl,
		avatar,
