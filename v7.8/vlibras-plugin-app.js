...
}, useCallback: Ce, useContext: ve, useDebugValue: jn, useDeferredValue: Jn, useEffect: C, useId: Vn, useImperativeHandle: Fn, useInsertionEffect: Kn, useLayoutEffect: rt, useMemo: W, useReducer: Yr, useRef: K, useState: Q, useSyncExternalStore: Hn, useTransition: Xn } } };
function Ei(e) {
...
var Bi = F, Qi = er, pt = { useState: Q, useId: Vn, useReducer: Yr, useEffect: C, useLayoutEffect: rt, useInsertionEffect: Kn, useTransition: Xn, useDeferredValue: Jn, useSyncExternalStore: Hn, startTransition: $r, useRef: K, useImperativeHandle: Fn, useMemo: W, useCallback: Ce, useContext: ve, useDebugValue: jn, version: "18.3.1", Children: ui, render: wi, hydrate: yi, unmountComponentAtNode: Ni, createPortal: to, createElement: Ee, createContext: Ge, createFactory: Ei, cloneElement: Ii, createRef: qa, Fragment: F, isValidElement: er, isElement: Qi, isFragment: Ri, isMemo: Pi, findDOMNode: Ti, Component: Se, PureComponent: Or, memo: li, forwardRef: di, flushSync: Oi, unstable_batchedUpdates: Ui, StrictMode: Bi, Suspense: zt, lazy: hi, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ci };
const Di = (e) => e;
function $n(e, t = Di) {
...
const Vi = (e) => e.replace(new RegExp("(?<!:)\\/+", "g"), "/"), ta = () => Math.random().toString(36).slice(2, 8), Ae = (...e) => {
  const t = W(() => (r) => tr(r, ...e), [JSON.stringify(e)]);
  return ji(t);
...
const Qr = (e) => (t) => {
  ...
  ie(le.PLAYER, J.PLAY, e), I.set({ gloss: e }), Re.get().onPlay?.(e), I.get().isWelcomeFinished || va();
}, Aa = () => {
  ie(le.PLAYER, J.PLAY_WELCOME), ie(le.PLAYER, J.SET_SUBTITLES_STATE, 0), I.set({ isPlayingWelcome: !0 });
}, nr = (e) => {
  const { region: t } = I.get(), r = `${be.DICTIONARY_STATIC_URL}${t.abbreviation}/`, o = be.DICTIONARY_URL;
  gt({ baseUrl: r }), e ? (ie(le.PLAYER, J.PLAY, e), Re.get().onPlayStatic?.(e)) : ie(le.PLAYER, J.SET_PAUSE_STATE, 0), gt({ baseUrl: o }), I.get().isWelcomeFinished || va();
}, so = () => {
  const { gloss: e } = I.get();
  ...
  ie(le.PLAYER, J.SET_SPEED, e), I.set({ speed: e });
}, sr = (e) => {
  const t = I.get().avatar, r = (Ar.indexOf(e || t) + (e ? 0 : 1)) % Ar.length, o = Ar[r];
  ie(le.PLAYER, J.SET_AVATAR, o), I.set({ avatar: o });
}, co = (e) => {
  const { showSubtitles: t } = I.get(), r = e ?? !t;
  ie(le.PLAYER, J.SET_SUBTITLES_STATE, Number(r)), I.set({ showSubtitles: r });
}, Nc = (e) => {
  const t = `${be.DICTIONARY_URL}${e.abbreviation}/`;
  gt({ baseUrl: t }), I.set({ region: e });
}, wa = (e) => {
  I.set({ emotion: e }), ie(le.EMOTION, e.action);
  ...
  "button",
  {
    ...
    ...n,
    children: /* @__PURE__ */ a(P, { name: "hands", "aria-hidden": "true", className: "size-4" })
  }
), fe = pe()((e) => ({
  screen: "main",
  open: (t) => e({ screen: t }),
...
function Oc({ children: e }) {
  const t = K(null), r = K({ x: 0, y: 0 }), o = G((b) => b.isExpanded), [n, i] = Q({ x: 0, y: 0 }), [s, l] = Q(!1), [c, u] = Q(!1), p = () => {
    i({ x: 0, y: 0 }), l(!1);
  };
  C(() => {
...
const rn = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, on = na, yt = (e, t) => (r) => {
  ...
  return /* @__PURE__ */ a(
    D,
    {
      ...
      className: e,
      ...t,
      children: /* @__PURE__ */ a(P, { name: "arrow-left", "aria-hidden": "true" })
    }
  );
          ...
          "div",
          {
            ...
            children: Bc.map((t) => /* @__PURE__ */ a(
              "a",
              {
                ...
                children: /* @__PURE__ */ a(P, { name: t.iconName, className: "size-4 bg-primary", "aria-label": t.name })
              },
              t.name
            ))
          }
        ),
        /* @__PURE__ */ a(P, { name: "icaro", className: "absolute top-4 left-0 z-1 size-32 opacity-15 dark:text-white dark:opacity-10" }),
...
const qe = pe()(
  ...
  const e = K(null), t = K(null), r = K(null), o = Ke(), [n, i] = Q("categories"), { data: s, isLoading: l, refetch: c } = ja(), { signs: u } = qe(), [p, h] = Q(null), { data: d = [], isLoading: b } = Yt({
  ...
  }, A = W(() => s ? new Ma(s).searchSigns("") : [], [s]), [{ filteredSigns: w, visibleCount: y, search: v }, S] = Q({
    filteredSigns: [],
    search: "",
    visibleCount: Ne
  }), N = W(() => {
    ...
    () => x ? Id(N) : {},
    [N, x]
  ), te = W(() => Object.entries(L), [L]), [oe, X] = Q(Ne);
  C(() => {
    He(Ne), X(20);
  }, [p]);
  ...
  const R = w.slice(0, y), Et = { all: A.length, recents: u.length }, [st, He] = Q(Ne), lt = W(() => N.slice(0, st), [N, st]), ee = Ce(
    (B) => {
      const H = B.currentTarget;
  ...
  onSettled: () => {
    I.set({ gloss: void 0 }), se.set({ isTranslating: !1 });
  }
}), xn = (async () => null)(), Pe = {
  _getContext: () => ({
...
const wo = ({ className: e, size: t = 24, ...r }) => /* @__PURE__ */ a("span", { className: E("flex aspect-square items-center justify-center text-primary", e), ...r, children: [
      ...
      return /* @__PURE__ */ a("li", { className: "break-word flex min-w-0 flex-1 items-center justify-between pl-4", children: [
        ...
        /* @__PURE__ */ a(
          "button",
          {
            ...
            children: /* @__PURE__ */ a(P, { name: "libras", className: E(o ? "size-5" : "size-6") })
          }
        )
      ] }, i);
    }) })
  ...
  }, m = W(() => zd(e.filteredSigns), [e.filteredSigns]), [g, f] = Q(ze), A = K(null);
  if (C(() => {
      ...
      /* @__PURE__ */ a("div", { className: E("flex min-w-0 items-center", S ? "bg-muted" : ""), children: [
        ...
        /* @__PURE__ */ a(
          D,
          {
            ...
            children: /* @__PURE__ */ a(P, { name: S ? "chevron-up" : "chevron-down", className: "size-4", "aria-hidden": "true" })
          }
        )
      ] }),
      S && /* @__PURE__ */ a(
          ...
          children: [
            /* @__PURE__ */ a(
              "button",
              {
                ...
                children: [
                  v === "#" ? "0–9" : v,
                  /* @__PURE__ */ a(P, { name: N ? "chevron-up" : "chevron-down", className: "size-4", "aria-hidden": "true" })
                ]
              }
            ),
  ...
  const { search: e, setSelectedCategory: t, categories: r, listRef: o } = Be(), n = W(() => r.filter((i) => i.name.toLowerCase().includes(e.toLocaleLowerCase())).sort((i, s) => i.name.localeCompare(s.name)), [r, e]);
      ...
      /* @__PURE__ */ a(
        "button",
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "flex items-center gap-2 py-2", children: [
            /* @__PURE__ */ a(P, { name: s, className: "mobile:size-5 size-6 shrink-0 dark:bg-foreground" }),
  ...
  return e && /* @__PURE__ */ a("div", { className: "flex w-full animate-move-up items-center gap-1 bg-primary/20 mobile:px-3 px-4 mobile:py-2 py-3", children: /* @__PURE__ */ a(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ a(P, { "aria-hidden": "true", name: r, className: "mobile:size-5 size-6 shrink-0" }),
      ...
      /* @__PURE__ */ a("div", { className: E("flex min-w-0 items-center hover:bg-muted", p && "bg-muted"), children: [
        ...
        /* @__PURE__ */ a(
          "button",
          {
            ...
            children: /* @__PURE__ */ a(P, { name: p ? "chevron-up" : "chevron-down", "aria-hidden": "true", className: "size-4" })
          }
        )
      ] }),
          ...
          /* @__PURE__ */ a("ul", { className: "ml-4 border-border/40 border-l", children: d.map((b) => /* @__PURE__ */ a("li", { children: /* @__PURE__ */ a(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a(P, { name: "arrow-right", className: "size-4" }),
  ...
  const c = W(() => Pd(r.visibleCategoryWords), [r.visibleCategoryWords]);
  ...
  return /* @__PURE__ */ a("div", { className: "flex items-center gap-2 px-4 [&_button]:rounded-full", children: [
    ...
    t === "recents" && /* @__PURE__ */ a(
      D,
      {
        ...
        children: /* @__PURE__ */ a(P, { name: "trash" })
      }
    )
  ] });
...
const au = () => {
  ...
  return /* @__PURE__ */ a("div", { className: "absolute top-1 right-1 flex flex-col rounded-lg", children: [
    /* @__PURE__ */ a(D, { tabindex: 1, onClick: e, size: "icon-xs", "aria-label": "Fechar guia", children: /* @__PURE__ */ a(P, { name: "x", "aria-hidden": "true" }) }),
    o && /* @__PURE__ */ a(D, { tabindex: 1, "aria-label": "Repetir texto", onClick: so, size: "icon-xs", className: "animate-move-right", children: /* @__PURE__ */ a(P, { name: "repeat", "aria-hidden": "true" }) })
  ] });
}, Hr = [
  {
  ...
  const e = K(null), t = K(null), { index: r, setIndex: o, onClose: n } = Ha(), i = W(() => r === 0, [r]), s = W(() => r === Hr.length - 1, [r]);
  return C(() => e.current?.focus(), [i]), C(() => t.current?.focus(), [s]), /* @__PURE__ */ a("div", { className: "flex items-center justify-between gap-2", children: [
    /* @__PURE__ */ a(
      D,
      {
        ...
        onClick: () => o(r - 1),
        children: [
          /* @__PURE__ */ a(P, { name: "arrow-left", "aria-hidden": "true" }),
          "Voltar"
        ]
      }
    ),
    ...
    /* @__PURE__ */ a(
      D,
      {
        ...
        children: [
          s ? "Concluir" : "Avançar",
          !s && /* @__PURE__ */ a(P, { name: "arrow-right", "aria-hidden": "true" })
        ]
      }
    )
  ] });
  ...
  const { pos: e } = lr(), { innerWidth: t, innerHeight: r } = window, [o, n] = Q(0), i = ye(), s = G((g) => g.isExpanded), l = G((g) => g.isTranslating), c = Ye((g) => g.appRoot), u = $(), p = W(() => e.x < (t - (c?.clientWidth || 0)) / 2, [e.x, t]), h = W(() => e.y < (r - (c?.clientHeight || 0)) / 2, [e.y, r]), d = W(() => Hr[o], [o]), b = () => {
    se.set({ text: void 0 }), I.set({ gloss: void 0 }), Cn.get().reset(), m(), ar();
  };
  if (C(() => {
    l && b();
  }, [l]), C(() => {
  ...
  const t = (r) => {
    if (r.data?.type === "unity_event") {
      ...
      if (r.data.event === ut.ON_LOAD_PLAYER && (I.set({ isLoaded: !0 }), Re.get().onLoaded?.()), r.data.event === ut.UPDATE_PROGRESS) {
      ...
      if (r.data.event === ut.ON_PLAYING_STATE_CHANGE) {
        ...
        n ? I.set({ status: "paused" }) : o && !n ? I.set({ status: "playing" }) : !o && !i && I.set({ status: "idle" });
      }
  ...
  return /* @__PURE__ */ a("div", { className: "dropdown dropdown-center dropdown-top focus-within:**:data-[slot=tooltip-content]:hidden", children: [
    /* @__PURE__ */ a(Qe, { offset: 8, content: "Emoções", placement: "top", arrow: { position: "bottom" }, children: /* @__PURE__ */ a(
      Ja,
      {
        ...
        size: e ? "icon-sm" : "icon",
        children: [
          /* @__PURE__ */ a(P, { name: t.icon, "aria-hidden": "true" }),
            ...
            return /* @__PURE__ */ a("li", { children: /* @__PURE__ */ a(
              "button",
              {
                ...
                children: /* @__PURE__ */ a("div", { className: "flex items-center justify-start gap-2", children: [
                  /* @__PURE__ */ a(P, { name: n.icon, className: "size-4.5" }),
    ...
    Qe,
    {
      ...
      children: /* @__PURE__ */ a(
        D,
        {
          ...
          variant: "ghost-gov",
          size: e ? "icon-sm" : "icon",
          children: /* @__PURE__ */ a(P, { name: n.icon })
        }
      )
    }
  );
  ...
  return C(() => {
    if (e) return;
    const { isPausedByUser: u } = se.get(), { gloss: p, isWelcomeFinished: h, status: d } = I.get();
  ...
  const e = K(null), t = G((n) => n.opacity), { onOpen: r } = xo(), o = (n) => {
  ...
  const e = q((o) => o.region), { onOpen: t } = xo(), r = (o) => {
    I.set({ region: o }), Pe.trackEvent("region_change", { region: o });
  };
  ...
  const r = $(), o = q((u) => u.region), n = G((u) => u.opacity), { theme: i, setTheme: s } = no(), l = () => {
    const u = io[0];
    s("light"), I.set({ region: u }), se.set({ opacity: 1 });
  }, c = W(() => o.abbreviation === "BR" && n === 1 && i === "light", [o, n, i]);
  return /* @__PURE__ */ a(
    yu,
    {
      data: {
              ...
              Qe,
              {
                ...
                children: /* @__PURE__ */ a(
                  D,
                  {
                    ...
                    children: /* @__PURE__ */ a(P, { name: "rotate-left" })
                  }
                )
              }
            ),
  ...
  return /* @__PURE__ */ a(F, { children: [
    /* @__PURE__ */ a(
      Qe,
      {
        ...
        children: /* @__PURE__ */ a(D, { onClick: () => r(!0), variant: "ghost-gov", size: e ? "icon-sm" : "icon", children: /* @__PURE__ */ a(P, { name: "settings" }) })
      }
    ),
    ...
    Qe,
    {
      ...
      children: /* @__PURE__ */ a(
        D,
        {
          ...
          variant: "ghost-gov",
          size: e ? "icon-sm" : "icon",
          children: /* @__PURE__ */ a(P, { name: t ? "subtitle" : "subtitle-off" })
        }
      )
    }
  );
}, Nu = () => {
  const e = G((o) => o.isOpen), t = ye((o) => o.open), { onPointerDown: r } = lr();
  return /* @__PURE__ */ a(
    "div",
    {
      className: E(
    ...
    Qe,
    {
      ...
      children: /* @__PURE__ */ a(
        D,
        {
          ...
          size: e ? "icon-sm" : "icon",
          variant: "default",
          children: /* @__PURE__ */ a(P, { name: r ? "collapse" : "expand", "aria-hidden": "true" })
        }
      )
    }
  );
}, Bu = ({ open: e, onOpenChange: t }) => {
  const r = K(null), o = G((d) => d.isTranslating), [n, i] = Q(""), { mutateAsync: s, isPending: l } = it(), c = oo(i, 300), u = async () => {
      ...
      children: [
        /* @__PURE__ */ a(
          D,
          {
            ...
            size: o ? "icon-sm" : "icon",
            variant: "outline-gov",
            children: r && /* @__PURE__ */ a(P, { name: r, className: "mobile:size-5 size-5.5" })
          }
        ),
    ...
    /* @__PURE__ */ a("div", { className: "dropdown dropdown-bottom z-1", children: [
      /* @__PURE__ */ a(
        D,
        {
          ...
          size: e ? "icon-sm" : "icon",
          variant: "default",
          children: /* @__PURE__ */ a(P, { name: "menu" })
        }
      ),
  ...
  const { onPointerDown: e } = lr(), t = $(), r = G((i) => i.setOpen), o = ye((i) => i.open), n = () => {
    r(!1), ir();
  };
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a("div", { className: "mr-2 flex items-center gap-1.5 font-semibold text-primary-foreground text-sm", children: [
            /* @__PURE__ */ a("div", { className: "flex size-5.5 items-end justify-center rounded-full bg-primary-foreground text-primary", children: /* @__PURE__ */ a(P, { name: "icaro", className: "size-4.5" }) }),
            "VLibras"
          ] }),
...
const Fu = ({ suggestions: e, coords: t, onSelect: r }) => e.length === 0 ? null : /* @__PURE__ */ a(
  ...
  C(() => d(I.get().gloss || ""), []);
  const b = W(() => n ? new Ma(n) : null, [n]), m = oo(() => {
    if (!r.current) return;
    ...
    /* @__PURE__ */ a("div", { className: "flex h-full flex-col gap-2 px-4 py-4", children: [
      ...
      /* @__PURE__ */ a("div", { className: "space-y-2 [&>button]:h-10 [&>button]:w-full [&>button]:rounded-full mobile:[&>button]:text-sm", children: [
        /* @__PURE__ */ a(D, { variant: "default", onClick: async () => {
          const { text: A } = se.get(), { gloss: w } = I.get();
          if (!(!A || !w || !h)) {
            s(!0);
            try {
              const y = await Fa({
              ...
              y.success ? (t(!1), Zt("Agradecemos sua contribuição!", { variant: "primary", className: "font-semibold" }), nr("AGRADECER"), I.set({ gloss: void 0 })) : (console.error(y.error), y.error && Zt(y.error, { variant: "destructive" }));
            } finally {
              s(!1);
            }
          }
        ...
        /* @__PURE__ */ a("div", { className: "flex items-center justify-center gap-4 [&>button]:flex-col [&>button]:text-muted-foreground", children: [
          /* @__PURE__ */ a(
            D,
            {
              ...
              onClick: async () => {
                const { gloss: s } = I.get(), { text: l } = se.get();
                if (!s || !l) return;
                const c = await Fa({ text: l, translation: s, review: s, rating: "good" });
                c.success ? (t(!1), Zt("Agradecemos sua contribuição!", { variant: "primary", className: "font-semibold" }), nr("AGRADECER"), I.set({ gloss: void 0 })) : (t(!1), c.error && Zt(ue.SEND_REVIEW_ERROR, { variant: "destructive" }), console.error(c.error));
              },
              children: [
                /* @__PURE__ */ a(P, { name: "thumbs-up" }),
  ...
  const [e, t] = Q(!1), r = $(), o = G((i) => i.isExpanded);
          ...
          Qe,
          {
            ...
            children: /* @__PURE__ */ a(
              D,
              {
                ...
                children: /* @__PURE__ */ a(P, { name: r.icon, "aria-hidden": "true", className: "size-5.5 text-primary" })
              }
            )
          }
        ),
  ...
  const e = $(), t = ye((y) => y.open), { status: r, gloss: o, isPlayingWelcome: n } = q(Ae("status", "gloss", "isPlayingWelcome")), { isExpanded: i, isTranslating: s, text: l } = G(Ae("isExpanded", "text", "isTranslating")), { action: c, content: u } = ft(Ae("action", "content")), p = r === "playing", h = r === "paused", d = r === "idle";
  C(() => {
    if (!d) return;
    ...
    D,
    {
      ...
      children: [
        i || /* @__PURE__ */ a(F, { children: [
          /* @__PURE__ */ a(P, { name: t === "button" ? "touch" : "link", className: "size-5" }),
  ...
  const e = q((o) => o.isLoaded), t = G((o) => o.isOpen), { mutateAsync: r } = it();
  C(() => {
