...
const L2 = ({ size: e = 24, iconTitle: r, ...t }) => /* @__PURE__ */ i(
  ...
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      className: z(
        "fixed py-2 px-4 text-2xl max-w-md rounded-md bg-black/90 text-white border-2 border-white/20 z-[2147483647]",
