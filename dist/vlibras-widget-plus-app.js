...
const ws = /* @__PURE__ */ Rc(Rd), Md = "Beta", Id = "Esta opção pode apresentar problemas", Pd = "Tema da página", Od = "Clique Fácil", Dd = "Navegação por teclas ativada", Hd = "Comandos por voz ativados", zd = "Apenas Português", Bd = "Selecionar cor", Fd = "Expandir", Vd = "Colapsar", $d = "Lupa de Conteúdo", Ud = "Filtro Noturno", jd = "Diminuir brilho", Gd = "Leitor de Texto ativado", Zd = "Filtro de daltonismo", qd = "Desativar Sons", Wd = "Desativar Autoplay", Xd = "Fonte para Dislexia", Yd = "Leitor de Texto", Kd = "Descrever Imagem", Jd = "Contraste", Qd = "Aumentar Fonte", e0 = "Espaço entre letras", t0 = "Espaço entre linhas", r0 = "Destacar links", o0 = "Destacar títulos", i0 = "Modo Leitor", n0 = "Pausar animações", a0 = "Navegar por teclas", s0 = "Comandos por voz", l0 = "Cores da página", c0 = "Ocultar imagens", d0 = "Guia de leitura", u0 = "Máscara de leitura", p0 = "Cursor grande", h0 = "Cor do texto", g0 = "Saturação", f0 = "Estrutura da Página", m0 = "Dicionário", v0 = "Personalizada", b0 = "Médio", C0 = "Grande", w0 = "Muito grande", y0 = "Desativado", _0 = "Em breve", x0 = "Ativado", k0 = "Tela inteira", A0 = "Normal", E0 = "Claro", S0 = "Escuro", L0 = "Invertido", N0 = "Configurações", T0 = "Resetar", R0 = "Redefinir", M0 = "Alterar idioma", I0 = "Sem suporte", P0 = "O sintetizador de voz não é suportado pelo seu navegador", O0 = "O reconhecimento de voz não é suportado pelo seu navegador", D0 = "Interagir", H0 = "Acessar link", z0 = "Mover para cima", B0 = "Mover para baixo", F0 = "Azul", V0 = "Amarelo", $0 = { content_zoom: "Ativar a lupa de conteúdo", describe_image: "Mostrar a descrição da imagem ao passar o mouse", page_theme: "Alterar tema da página", contrast: "Alterar o contraste das cores", easy_click: "Ativar clique fácil", keyboard_navigation: "Ativar navegação por teclas", voice_commands: "Ativar comandos por voz", page_structure: "Visualizar estrutura da página", page_colors: "Alterar as cores da páginas", disable_autoplay: "Impedir início automático de mídias", adjust_saturation: "Ajustar saturação", open_settings: "Abrir configurações", large_window: "Janela grande", small_window: "Janela pequena", night_filter: "Ativar filtro noturno", reduce_brightness: "Diminuir o brilho da tela", color_blind_filter: "Ativar filtro para daltonismo", disable_sound: "Desativar o som de vídeos e audios", dyslexic_font: "Ativar font para dyslexia", "dictionary.search": "Pesquisar no dicionário", definition_to_libras: "Ler definição em Libras", read_definition: "Ler definição", dictionary: "Ativar o dicionário", text_reader: "Ouvir o texto", font_increase: "Aumentar o tamanho da fonte", letter_spacing: "Modificar espaço entre as letras", line_spacing: "Modificar espaço entre linhas", highlight_links: "Destacar links", highlight_titles: "Destacar títulos", reset: "Resetar definições", close: "Fechar", change_language: "Alterar o idioma da ferramenta", reader_mode: "Ativar modo leitor", toggle_theme: "Alterar o tema", pause_animations: "Pausar animações", hide_images: "Esconder todas as imagens", reading_guide: "Ativar o Guia de leitura", reading_mask: "Ativar a Máscara de leitura", move_reading_mask: "Mover a Máscara de leitura", move_reading_guide: "Mover o Guia de leitura", large_cursor: "Ativar o cursor grande", text_color: "Alterar a cor do texto", open_navigation_profiles: "Abrir ou fechar os perfis de navegação", blind: "Definições para pessoas cegas", low_vision: "Definições para pessoas com baixa visão" }, U0 = { reset: "Resetar definições", close: "Fechar", settings: "Configurações", toggle_theme: "Alterar o tema" }, j0 = { text_and_typography: "Texto e Tipografia", reading_and_comprehension: "Leitura e Compreensão", focus_and_visibility: "Foco e Acessibilidade Visual", colors_filters_and_contrast: "Cores, Filtros e Contraste", distraction_reduction: "Redução de Distrações", navigation_profiles: "Perfis de Navegação", navigation_and_motor_accessibility: "Navegação e Acessibilidade Motora", profiles: "Perfis" }, G0 = "Definição em Libras", Z0 = "Ler definição", q0 = "Acessibilidade em Libras", W0 = "Contato e Suporte", X0 = "Fale conosco ou relate algum problema", Y0 = "Sobre o projeto", K0 = "Saiba mais sobre o projeto e quem o desenvolve", J0 = "Novidades da versão", Q0 = "Veja o que há de novo", e7 = {
  ...
  return P(() => {
    var n;
    e || t("0.10.1"), r || o(((n = window == null ? void 0 : window.VLibrasWidgetPlus) == null ? void 0 : n.path) ?? "./");
...
const _p = me(
  ...
  ({ children: e, className: t, ...r }, o) => /* @__PURE__ */ i(
    "span",
    {
      ref: o,
      className: z(
        "relative mb-1 group-data-[actived=true]:fill-primary group-data-[actived=true]:text-primary [&_svg]:size-7 xs:[&_svg]:size-8",
        t
      ),
      ...r,
      children: e
...
`, { shadowRoot: pl } = S1(), Z6 = () => {
  ...
  return P(() => {
    ...
    r === "speech" && /* @__PURE__ */ i(Go, { className: "absolute top-1.5 left-2 size-5 group-data-[actived=true]:text-primary" }),
    /* @__PURE__ */ i(rt, { size: 2, actived: o }),
