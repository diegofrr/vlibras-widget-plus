...
`, { shadowRoot: ll } = Uc(), b6 = () => {
  ...
  return /* @__PURE__ */ i(
    Io,
    {
      ...
      className: "whitespace-nowrap bg-primary border-none animate-move-up",
      content: /* @__PURE__ */ i("div", { className: "relative text-primary-foreground -top-px", children: t("libras_accessibility") }),
...
const q6 = "https://docs.google.com/forms/d/e/1FAIpQLSdfy9dl4TvTXXoPMvJfnBaCPm_NcfD0IULTg0xMXOZpTldJdA/formResponse", W6 = async ({
  ...
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        r === "pt" && t && /* @__PURE__ */ i(T6, { className: "size-9 p-0 m-1.5 mb-0" }),
        /* @__PURE__ */ i("div", { className: "flex items-center flex-col justify-center p-1.5", children: [
          /* @__PURE__ */ i(
            Io,
            {
              align: "end",
              ...
              className: "bg-background animate-move-up",
