...
const _p = me(
  ...
  ({ children: e, className: t, ...r }, o) => /* @__PURE__ */ i(
    ...
    {
      ref: o,
      className: z("mb-1 group-data-[actived=true]:text-primary [&_svg]:size-8", t),
      ...r,
      children: e
    }
  )
