var N, On, Ve, Ro, Zt, Un, Bn, eo, Ur, Br, Qn, $t = {}, Ln = [], oi = /(mi|mn|mo|ms$|mte|msp)/, Rt = Array.isArray, lr = Ln.slice, Ie = Object.assign;
function to(e) {
...
function Ne(e, t, r) {
  ...
  return arguments.length > 2 && (s.children = arguments.length > 3 ? lr.call(arguments, 2) : r), At(e, s, o, n, null);
}
...
function Qr(e) {
  (8 & e.__g || !(e.__g |= 8) || !Ve.push(e) || Zt++) && Ro == N.debounceRendering || ((Ro = N.debounceRendering) || queueMicrotask)(ai);
}
function ai() {
...
function Mn(e, t, r, o, n, i, s, l, c, u, p, m) {
  ...
  for (c = ii(r, t, v, c, y), d = 0; d < y; d++) (h = r.__k[d]) != null && (g = h.__i != -1 && v[h.__i] || $t, h.__i = d, w = ro(e, h, g, n, i, s, l, c, u, p, m), f = h.__e, h.ref && g.ref != h.ref && (g.ref && oo(g.ref, null, h), p.push(h.ref, h.__c || f, h)), b == null && f != null && (b = f), (A = 4 & h.__u) || g.__k === h.__k ? c = zn(h, c, e, A) : typeof h.type == "function" && w !== void 0 ? c = w : f && (c = f.nextSibling), h.__u &= -7);
  return r.__e = b, c;
}
function ii(e, t, r, o, n) {
  var i, s, l, c, u, p = r.length, m = p, d = 0;
  for (e.__k = new Array(n), i = 0; i < n; i++) (s = t[i]) != null && typeof s != "boolean" && typeof s != "function" ? (typeof s == "string" || typeof s == "number" || typeof s == "bigint" || s.constructor == String ? s = e.__k[i] = At(null, s, null, null, null) : Rt(s) ? s = e.__k[i] = At(Q, { children: s }, null, null, null) : s.constructor === void 0 && s.__b > 0 ? s = e.__k[i] = At(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v) : e.__k[i] = s, c = i + d, s.__ = e, s.__b = e.__b + 1, l = null, (u = s.__i = si(s, r, c, m)) != -1 && (m--, (l = r[u]) && (l.__u |= 2)), l == null || l.__v == null ? (u == -1 && (n > p ? d-- : n < p && d++), typeof s.type != "function" && (s.__u |= 4)) : u != c && (u == c - 1 ? d-- : u == c + 1 ? d++ : (u > c ? d-- : d++, s.__u |= 4))) : e.__k[i] = null;
...
function Mt(e, t, r, o, n) {
  ...
  else if (t[0] == "o" && t[1] == "n") i = t != (t = t.replace(Bn, "$1")), t = t.slice(2).toLowerCase(), e.__l || (e.__l = {}), e.__l[t + i] = r, r ? o ? r.l = o.l : (r.l = eo, e.addEventListener(t, i ? Br : Ur, i)) : e.removeEventListener(t, i ? Br : Ur, i);
  else {
...
function ro(e, t, r, o, n, i, s, l, c, u, p) {
  ...
  e: if (typeof ne == "function") try {
    ...
    while (8 & d.__g && ++D < 25);
    d.state = d.__s, d.getChildContext != null && (o = Ie({}, o, d.getChildContext())), w && r.__c && d.getSnapshotBeforeUpdate != null && (f = d.getSnapshotBeforeUpdate(g, h)), x = m != null && m.type === Q && m.key == null ? Vn(m.props.children) : m, l = Mn(e, Rt(x) ? x : [x], t, r, o, n, i, s, l, c, u, p), t.__u &= -161, d.__h.length && s.push(d), 2 & d.__g && (d.__g &= -4);
  } catch (le) {
...
function Vn(e) {
  return typeof e != "object" || e == null || e.__b > 0 ? e : Rt(e) ? e.map(Vn) : Ie({}, e);
}
function li(e, t, r, o, n, i, s, l, c, u) {
  var p, m, d, g, h, f, b, w, A = r.props || $t, v = t.props, y = t.type;
  ...
  if (y == null) A === v || l && e.data == v || (e.data = v);
    ...
    if (i = i && lr.call(e.childNodes), !l && i != null) for (A = {}, p = 0; p < e.attributes.length; p++) A[(h = e.attributes[p]).name] = h.value;
    for (p in A) h = A[p], p == "dangerouslySetInnerHTML" ? d = h : p == "children" || p in v || p == "value" && "defaultValue" in v || p == "checked" && "defaultChecked" in v || Mt(e, p, null, h, n);
    for (p in w = 1 & r.__u, v) h = v[p], p == "children" ? g = h : p == "dangerouslySetInnerHTML" ? m = h : p == "value" ? f = h : p == "checked" ? b = h : l && typeof h != "function" || A[p] === h && !w || Mt(e, p, h, A[p], n);
    if (m) l || d && (m.__html == d.__html || m.__html == e.innerHTML) || (e.innerHTML = m.__html), t.__k = [];
    else if (d && (e.innerHTML = ""), (y == "foreignObject" || n == "http://www.w3.org/1998/Math/MathML" && oi.test(y)) && (n = "http://www.w3.org/1999/xhtml"), Mn(y == "template" ? e.content : e, Rt(g) ? g : [g], t, r, o, n, i, s, i ? i[0] : r.__k && at(r, 0), l, c, u), i != null) for (p = i.length; p--; ) to(i[p]);
    l || (p = "value", y == "progress" && f == null ? e.removeAttribute("value") : f == null || f === e[p] && (y !== "progress" || f) || Mt(e, p, f, A[p], n), p = "checked", b != null && b != e[p] && Mt(e, p, b, A[p], n));
  }
  return e;
}
function oo(e, t, r) {
...
function it(e, t) {
  var r, o, n, i;
  t == document && (t = document.documentElement), N.__ && N.__(e, t), o = (r = e && 32 & e.__u) ? null : t.__k, t.__k = Ne(Q, null, [e]), n = [], i = [], ro(t, t.__k, o || $t, $t, t.namespaceURI, o ? null : t.firstChild ? lr.call(t.childNodes) : null, n, o ? o.__e : t.firstChild, r, i, t.ownerDocument), Fn(n, t.__k, i);
}
function di(e, t) {
  e.__u |= 32, it(e, t);
}
function ui(e, t, r) {
  ...
  return arguments.length > 2 && (s.children = arguments.length > 3 ? lr.call(arguments, 2) : r), At(e.type, s, o || e.key, n || e.ref, null);
}
function He(e) {
  function t(r) {
    var o, n;
...
}, Te.prototype.render = Q, Ve = [], Zt = 0, Un = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, Bn = /(PointerCapture)$|Capture$/i, eo = 0, Ur = Io(!1), Br = Io(!0), Qn = 0;
var pi = 0;
...
var Le, F, wr, To, Dr = Object.is, st = 0, Gn = [], W = N, No = W.__b, Oo = W.__r, Uo = W.diffed, Bo = W.__c, Qo = W.unmount, Lo = W.__;
function lt(e, t) {
...
function hi() {
  for (var e; e = Gn.shift(); ) if (e.__P && e.__H) try {
    e.__H.__h.some(Jt), e.__H.__h.some(Mr), e.__H.__h = [];
  } catch (t) {
...
W.__b = function(e) {
  ...
  Oo && Oo(e), Le = 0;
  var t = (F = e.__c).__H;
  t && (wr === F ? (t.__h = [], F.__h = [], t.__.some(function(r) {
    r.__N && (r.__ = r.__N), r.u = r.__N = void 0;
  })) : (t.__h.some(Jt), t.__h.some(Mr), t.__h = [], Le = 0)), wr = F;
}, W.diffed = function(e) {
  Uo && Uo(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (Gn.push(t) !== 1 && To === W.requestAnimationFrame || ((To = W.requestAnimationFrame) || mi)(hi)), t.__H.__.some(function(r) {
...
function ki(e) {
  ...
  it(Ne(xi, { context: t.context }, e.__v), t.l);
}
function lo(e, t) {
  var r = Ne(ki, { __v: e, i: t });
...
var co, Oi = { enumerable: !1, configurable: !0, get: function() {
  return this.class;
} }, jo = N.vnode;
N.vnode = function(e) {
    ...
    for (var c in n) {
      ...
      if (!(c === "value" && "defaultValue" in n && u == null || Ci && c === "children" && i === "noscript" || c === "class" || c === "className")) {
        if (c === "style" && typeof u == "object") for (var p in u) typeof u[p] != "number" || gi.test(p) || (u[p] += "px");
          ...
          var m = c.toLowerCase();
          m === "ondoubleclick" ? c = "ondblclick" : m !== "onchange" || i !== "input" && i !== "textarea" || Ei(n.type) ? m === "onfocus" ? c = "onfocusin" : m === "onblur" && (c = "onfocusout") : m = c = "oninput", m === "oninput" && s[c = m] && (c = "oninputCapture");
...
var ji = Q, Gi = cr, bt = { useState: O, useId: Hn, useReducer: no, useEffect: S, useLayoutEffect: Ke, useInsertionEffect: $n, useTransition: Zn, useDeferredValue: Yn, useSyncExternalStore: Xn, startTransition: io, useRef: te, useImperativeHandle: Wn, useMemo: z, useCallback: Se, useContext: ke, useDebugValue: Jn, version: "18.3.1", Children: Ai, render: Ri, hydrate: Pi, unmountComponentAtNode: Mi, createPortal: lo, createElement: Ne, createContext: He, createFactory: Bi, cloneElement: Di, createRef: ni, Fragment: Q, isValidElement: cr, isElement: Gi, isFragment: Qi, isMemo: Li, findDOMNode: zi, Component: Te, PureComponent: Fr, memo: fi, forwardRef: vi, flushSync: Fi, unstable_batchedUpdates: Vi, StrictMode: ji, Suspense: Ht, lazy: yi, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ui };
const Wi = (e) => e;
function oa(e, t = Wi) {
...
}, fe = ((e) => e ? Jo(e) : Jo), Kt = fe()(() => ({ path: "", version: "" })), na = () => (S(() => {
  const e = Kt.getState();
  e.path && e.version || Kt.setState({
...
const Yi = (e) => e.replace(new RegExp("(?<!:)\\/+", "g"), "/"), aa = () => Math.random().toString(36).slice(2, 8), q = (...e) => {
  const t = z(() => (r) => dr(r, ...e), [JSON.stringify(e)]);
  return Xi(t);
}, kr = "@vlibras-theme", Zi = (e) => ["light", "dark"].includes(e), yt = fe((e) => ({
  theme: (() => {
  ...
  n.id = t, n.innerHTML = e, er[t] = n, document.head.appendChild(n);
}, es = (e) => {
  const t = er[e];
  t && (document.head.removeChild(t), delete er[e]);
}, ts = async (e, t) => {
  const r = [
...
const os = (e, t) => {
  ...
  return {
    getClassGroupId: (s) => {
      if (s.startsWith("[") && s.endsWith("]"))
        return ss(s);
      const l = s.split(tr), c = l[0] === "" && l.length > 1 ? 1 : 0;
      return da(l, c, t);
    },
  ...
  if (s === null)
    return;
  const l = t === 0 ? e.join(tr) : e.slice(t).join(tr), c = s.length;
  for (let u = 0; u < c; u++) {
    const p = s[u];
    if (p.validator(l))
  ...
  for (let u = l.length - 1; u >= 0; u -= 1) {
    ...
    const A = d.length === 0 ? "" : d.length === 1 ? d[0] : i(d).join(":"), v = g ? A + jr : A, y = v + w;
    if (s.indexOf(y) > -1)
      continue;
    s.push(y);
    const I = n(w, b);
...
}, ha = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, ma = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Ss = /^\d+\/\d+$/, Cs = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Es = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Rs = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, Ps = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Is = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, et = (e) => Ss.test(e), T = (e) => !!e && !Number.isNaN(Number(e)), Ue = (e) => !!e && Number.isInteger(Number(e)), Sr = (e) => e.endsWith("%") && T(e.slice(0, -1)), Pe = (e) => Cs.test(e), Ts = () => !0, Ns = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  Es.test(e) && !Rs.test(e)
), ga = () => !1, Os = (e) => Ps.test(e), Us = (e) => Is.test(e), Bs = (e) => !k(e) && !_(e), Qs = (e) => ct(e, va, ga), k = (e) => ha.test(e), Fe = (e) => ct(e, Aa, Ns), Cr = (e) => ct(e, Fs, T), $o = (e) => ct(e, fa, ga), Ls = (e) => ct(e, ba, Us), zt = (e) => ct(e, wa, Os), _ = (e) => ma.test(e), gt = (e) => dt(e, Aa), Ds = (e) => dt(e, Vs), en = (e) => dt(e, fa), Ms = (e) => dt(e, va), zs = (e) => dt(e, ba), Ft = (e) => dt(e, wa, !0), ct = (e, t, r) => {
  const o = ha.exec(e);
  ...
  const e = Z("color"), t = Z("font"), r = Z("text"), o = Z("font-weight"), n = Z("tracking"), i = Z("leading"), s = Z("breakpoint"), l = Z("container"), c = Z("spacing"), u = Z("radius"), p = Z("shadow"), m = Z("inset-shadow"), d = Z("text-shadow"), g = Z("drop-shadow"), h = Z("blur"), f = Z("perspective"), b = Z("aspect"), w = Z("ease"), A = Z("animate"), v = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], y = () => [
    ...
    span: ["full", Ue, _, k]
  }, Ue, _, k], H = () => [Ue, "auto", _, k], me = () => ["auto", "min", "max", "fr", _, k], ne = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], le = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], we = () => ["auto", ...x()], Re = () => [et, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...x()], E = () => [e, _, k], Qt = () => [...y(), en, $o, {
    position: [_, k]
  }], Lt = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], Dt = () => ["auto", "cover", "contain", Ms, Qs, {
    size: [_, k]
  }], Xe = () => [Sr, gt, Fe], Y = () => [
    ...
    _,
    k
  ], ce = () => ["", T, gt, Fe], Ye = () => ["solid", "dashed", "dotted", "double"], Ze = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], j = () => [T, Sr, en, $o], pt = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    h,
...
const Ws = () => /* @__PURE__ */ a("div", { className: "absolute bottom-15 left-1/2 grid -translate-x-1/2 animate-move-up place-content-center rounded-full border bg-background p-0.5 pr-2", children: /* @__PURE__ */ a("span", { className: "flex items-center gap-1 font-semibold text-xs", children: [
...
const Gr = (e) => (t) => {
  ...
  let i = {
    storage: ur(() => window.localStorage),
    partialize: (b) => b,
    version: 0,
    merge: (b, w) => ({
      ...w,
  ...
  const f = () => {
    ...
    return Gr(p.getItem.bind(p))(i.name).then((y) => {
      if (y)
...
}, ya = ["default", "happy", "sad", "angry", "disgust", "fear", "surprise", "upset"], wt = {
  default: {
    name: "Padrão",
  ...
  pr(
    ...
    }),
    {
      name: "@vlibras/player",
      version: 1,
      storage: ur(() => localStorage),
      partialize: (e) => dr(e, "speed", "showSubtitles", "avatar", "config")
    }
  )
), P = {
  get: X.getState,
  ...
  "/src/widget/icons/categories/numbers.webp": Gl,
  "/src/widget/icons/categories/people.webp": Wl,
  ...
  const i = Gc[`/src/widget/icons/${t}.webp`];
  return /* @__PURE__ */ a(
    "i",
    {
      ...n,
...
}, Jc = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1, VITE_PUBLIC_POSTHOG_DEBUG: "true", VITE_PUBLIC_POSTHOG_ENABLED: "true", VITE_PUBLIC_POSTHOG_HOST: "https://us.i.posthog.com", VITE_PUBLIC_POSTHOG_PROJECT_TOKEN: "phc_rkupE6DkPSJl7SntaagI0wq0FCKtg3lVP0UkC95NGYe" }, Hc = 1e4, rn = {
  development: {
...
}, xa = "production", Kc = rn[xa] || rn.development, xe = {
  ...Jc,
  ...Kc,
  REQUEST_TIMEOUT: Hc,
  MODE: xa
  ...
  re(ae.PLAYER, G.PLAY, e), P.set({ gloss: e }), Oe.get().onPlay?.(e), P.get().isWelcomeFinished || ka();
}, _a = () => {
  ...
  xt({ baseUrl: r }), e ? (re(ae.PLAYER, G.PLAY, e), Oe.get().onPlayStatic?.(e)) : re(ae.PLAYER, G.SET_PAUSE_STATE, 0), xt({ baseUrl: o }), P.get().isWelcomeFinished || ka();
}, mo = () => {
  const { gloss: e } = P.get();
  ...
  xt({ baseUrl: t }), P.set({ region: e });
}, Sa = (e, t) => {
  if (!ya.includes(e)) return console.error(`Emoção "${e}" inválida!`);
  const r = wt[e];
  P.set({ emotion: r }), re(ae.EMOTION, r.action, t || r.intensity);
  ...
  ...Ea
})), rr = () => _t.setState(Ea), bo = (e) => {
  setTimeout(() => _t.setState(e), 300);
}, on = {
  get: _t.getState,
  set: _t.setState
  ...
  {
    onClick: (s) => {
      rr(), kt(t), o?.(s), r && bo({ action: r, auto: !0 });
    },
    type: "button",
  ...
  pr(
    ...
    {
      name: "@vlibras-widget",
      partialize: (e) => dr(e, "position", "isActive", "isOpen", "opacity"),
      version: 1
    }
  )
);
...
const an = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, sn = la, It = (e, t) => (r) => {
  var o;
...
var ut = class {
  ...
  setTimeoutProvider(e) {
    Vt.NODE_ENV !== "production" && this.#t && e !== this.#e && console.error(
      "[timeoutManager]: Switching provider after calls to previous provider might result in unexpected behavior.",
      { previous: this.#e, provider: e }
    ), this.#e = e, Vt.NODE_ENV !== "production" && (this.#t = !1);
  }
  setTimeout(e, t) {
    return Vt.NODE_ENV !== "production" && (this.#t = !0), this.#e.setTimeout(e, t);
  }
  clearTimeout(e) {
    this.#e.clearTimeout(e);
  }
  setInterval(e, t) {
    return Vt.NODE_ENV !== "production" && (this.#t = !0), this.#e.setInterval(e, t);
  }
  clearInterval(e) {
...
function Ba(e, t) {
  return Oa.NODE_ENV !== "production" && e.queryFn === nr && console.error(
    `Attempted to invoke queryFn when set to skipToken. This is likely a configuration error. Query hash: '${e.queryHash}'`
  ), !e.queryFn && t?.initialPromise ? () => t.initialPromise : !e.queryFn || e.queryFn === nr ? () => Promise.reject(new Error(`Missing queryFn: '${e.queryHash}'`)) : e.queryFn;
}
function Qa(e, t) {
  return typeof e == "function" ? e(...t) : !!e;
}
...
function Da(e) {
  ...
  const n = Xr(), i = () => n.status !== "pending", s = (f) => {
    ...
    t = !1;
  }, u = () => wo.isFocused() && (e.networkMode === "always" || ar.isOnline()) && e.canRun(), p = () => La(e.networkMode) && e.canRun(), m = (f) => {
    i() || (o?.(), n.resolve(f));
  }, d = (f) => {
    i() || (o?.(), n.reject(f));
  }, g = () => new Promise((f) => {
    ...
    Promise.resolve(f).then(m).catch((w) => {
      if (i())
        return;
      const A = e.retry ?? (Et.isServer() ? 0 : 3), v = e.retryDelay ?? gd, y = typeof v == "function" ? v(r, w) : v, I = A === !0 || typeof A == "number" && r < A || typeof A == "function" && A(r, w);
      if (t || !I) {
        d(w);
        return;
      }
...
var Ma = class {
  ...
  isDisabled() {
    return this.getObserversCount() > 0 ? !this.isActive() : this.options.queryFn === nr || !this.isFetched();
  }
  isFetched() {
...
var bd = class extends ut {
  ...
  setOptions(e) {
    ...
    this.#x(), this.#t.setOptions(this.options), t._defaulted && !or(this.options, t) && this.#e.getQueryCache().notify({
  ...
  #f() {
    ...
    if (Et.isServer() || this.#n.isStale || !Jr(e))
      return;
  ...
  #v(e) {
    this.#y(), this.#c = e, !(Et.isServer() || be(this.options.enabled, this.#t) === !1 || !Jr(this.#c) || this.#c === 0) && (this.#u = je.setInterval(() => {
  ...
  updateResult() {
    ...
    if (this.#o = this.#t.state, this.#a = this.options, this.#o.data !== void 0 && (this.#m = this.#t), or(t, e))
      return;
    this.#n = t;
    const r = () => {
      if (!e)
...
function fn(e, t) {
  return vd(e, t) || e.state.data !== void 0 && Zr(e, t, t.refetchOnMount);
}
function Zr(e, t, r) {
  ...
  return {
    onFetch: (t, r) => {
      ...
      const u = async () => {
        ...
        }, d = Ba(t.options, t.fetchOptions), g = async (h, f, b) => {
          if (p)
        ...
        if (n && i.length) {
          const h = n === "backward", f = h ? wd : An, b = {
            pages: i,
            pageParams: s
          }, w = f(o, b);
          l = await g(b, w, h);
...
var kd = class extends ut {
  ...
  setOptions(t) {
    ...
    this.options = this.#e.defaultMutationOptions(t), or(this.options, r) || this.#e.getMutationCache().notify({
      type: "observerOptionsUpdated",
      mutation: this.#r,
      observer: this
  ...
  resumePausedMutations() {
    return ar.isOnline() ? this.#t.resumePausedMutations() : Promise.resolve();
  }
  getQueryCache() {
    return this.#e;
  }
  ...
  getQueryDefaults(e) {
    ...
    return t.forEach((o) => {
      Ct(e, o.queryKey) && Object.assign(r, o.defaultOptions);
    }), r;
  }
  ...
  getMutationDefaults(e) {
    ...
    return t.forEach((o) => {
      Ct(e, o.mutationKey) && Object.assign(r, o.defaultOptions);
    }), r;
  }
...
function Ld(e, t, r) {
  ...
  const o = Cd(), n = Id(), i = Ga(), s = i.defaultQueryOptions(e);
  ...
  return i.getDefaultOptions().queries?._experimental_afterQuery?.(
    s,
    u
  ), s.experimental_prefetchInRender && !Et.isServer() && Bd(u, o) && (l ? (
...
}, Gd = ["#", ..."ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")], Wd = {
  "1S_": "EU",
  "2S_": "VOCÊ",
  "3S_": "ELE(A)",
  "1P_": "NÓS",
...
function qd(e) {
  ...
  for (const r of e) {
    ...
    if (t[o] ??= { conjugation: [], desambiguation: [] }, r.includes("&"))
      ...
      const n = r.match(kn);
      if (n) {
        const i = n[1] ?? "", s = n[2], l = n[3] ?? "", c = Wd[i] ?? "", u = Jd[l] ?? "";
...
const rt = fe()(
  pr((e) => ({ isMaxRetries: !1, retriesCount: 0 }), {
    name: "@vlibras/dictionary",
    version: 1,
    storage: ur(() => sessionStorage),
    partialize: (e) => dr(e, "isMaxRetries"),
...
const ot = fe()(
  ...
  const e = te(null), t = te(null), r = te(null), o = rt(), [n, i] = O("categories"), { data: s, isLoading: l, refetch: c } = Ka(), { signs: u } = ot(), [p, m] = O(null), [d, g] = O(null), { data: h = [], isLoading: f } = ir({
    queryKey: ["categories"],
    queryFn: Vd,
    select: ({ data: B }) => B.filter((M) => M.name !== "INDEFINIDO")
  }), { data: b = [], isLoading: w } = ir({
  ...
  const Lt = y.slice(0, I), Dt = { all: v.length, recents: u.length }, [Xe, Y] = O(ye), ce = z(() => x.slice(0, Xe), [x, Xe]), Ye = Se(
    (B) => {
      const M = B.currentTarget;
...
}, { Provider: Yd, useCtx: _e } = Ao(), Zd = ({ children: e }) => {
  const t = Xd();
...
}), Sn = 0.07, Za = "production", $d = Za !== "production", Cn = (async () => {
  ...
  _n.set({ signs: r }), St.set({ screen: "main" }), bo({
    action: () => St.set({ screen: "dictionary" }),
...
const $a = (e) => {
  ...
  const o = new DOMParser().parseFromString(e, "text/html"), n = o.querySelector("tbody")?.innerHTML.match(new RegExp(`title='(?<gender>${eu.join("|")})'`))?.groups?.gender, i = Array.from(o.querySelectorAll("ol > li")).map((h) => {
    let f = Rn(h);
  ...
  )?.textContent?.trim(), u = tu(o), p = {}, m = o.querySelector("table.traduções");
  ...
  const [e, t] = O(null), { data: r, isFetching: o } = ir({
  ...
  const m = (g) => {
    ...
    (g) => {
      ...
      h.scrollTop + h.clientHeight >= h.scrollHeight - 100 && u((b) => Math.min(b + Gt, e.filteredSigns.length));
    },
...
}, So = () => /* @__PURE__ */ a("div", { className: "grid h-full place-content-center", children: /* @__PURE__ */ a(_o, {}) }), au = () => {
  ...
  const e = fr(), t = _e(q("visibleVerbGroups", "onVerbScroll", "listRef")), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = br(), l = async (c) => {
    try {
      const u = await r(c);
  ...
  const e = fr(), t = _e(q("visibleCategoryWords", "isVerbCategory", "listRef", "onCategoryScroll")), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = br(), l = async (u) => {
    try {
      const p = await r(u);
  ...
  const e = _e(q("visibleLetterWords", "onLetterScroll", "listRef")), t = fr(), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = br(), l = async (c) => {
    try {
      const u = await r(c);
      ue(u), ve.setState({ screen: "main" });
    } catch (u) {
...
let tt = [], qt = [];
const Ir = () => qt.forEach((e) => e([...tt])), sr = (e, t) => {
...
const Ru = () => {
  ...
  const e = te(null), t = te(null), { index: r, setIndex: o, onClose: n } = ei(q("index", "setIndex", "onClose")), i = z(() => r === 0, [r]), s = z(() => r === $r.length - 1, [r]);
  ...
  get: Ee.getState,
  set: Ee.setState
}, Iu = It("absolute flex flex-col gap-4 z-50 widget-radius bg-primary p-4 transition-position", {
  variants: {
    isMobile: { true: "", false: "" },
    isLeft: { true: "", false: "" },
    isTop: { true: "", false: "" },
...
}), { Provider: Tu, useCtx: ei } = Ao(), Nu = () => {
  const { pos: e } = gr(), { innerWidth: t, innerHeight: r } = window, [o, n] = O(0), i = Ee(), s = J((f) => f.isExpanded), l = J((f) => f.isTranslating), c = nt((f) => f.appRoot), u = ee(), p = z(() => e.x < (t - (c?.clientWidth || 0)) / 2, [e.x, t]), m = z(() => e.y < (r - (c?.clientHeight || 0)) / 2, [e.y, r]), d = z(() => $r[o], [o]), g = () => {
    oe.set({ text: void 0 }), P.set({ gloss: void 0 }), In.get().reset(), h(), hr();
  };
  if (S(() => {
    l && g();
  }, [l]), S(() => {
  ...
  const h = () => {
    if (!c) return;
    Ar("[data-highlight=true]", c)?.forEach((b) => b.dataset.highlight = "false");
  };
  return /* @__PURE__ */ a(Tu, { data: { index: o, setIndex: n, onClose: g, ...i }, children: /* @__PURE__ */ a(
    "div",
    {
      className: C(
        Iu({ isMobile: u, isLeft: p, isTop: m, isExpanded: s }),
        !s && !u && d.guideClx,
  ...
  const { path: t } = na(), r = X((s) => s.isLoaded), o = te(null), n = Yi(`${t}/unity/index.html`), i = (s, l, c) => {
    if (!o.current) return;
  ...
  const e = ee(), { gloss: t, status: r, isPlayingWelcome: o } = X(q("gloss", "status", "isPlayingWelcome")), n = () => {
    ...
    s === "idle" ? mo() : s === "paused" ? ue() : s === "playing" && (Pt(), oe.set({ isPausedByUser: !0 }));
  }, i = Mu[r];
  return /* @__PURE__ */ a(
    Me,
    {
...
}, Tt = He(null), Vu = ({ children: e }) => {
  const t = aa(), r = ke(Tt), o = X((s) => s.status === "playing"), [n, i] = O(!0);
  return S(() => {
  ...
  return S(() => {
    ...
    if (l && d === "playing") return Pt();
    !l && !u && (p || !m) && setTimeout(ue, 300);
  }, [l, e]), /* @__PURE__ */ a(Tt.Provider, { value: { open: l, onOpenChange: c, nested: e, overlay: t }, children: n });
}, ju = ({ children: e, ...t }) => {
  const r = ke(Tt);
...
}, Ut = ({ children: e, icon: t, className: r, ...o }) => /* @__PURE__ */ a(
  "h3",
  {
  ...
  const n = ke(Tt), i = nt((s) => s.appRoot);
  return !n || !i ? null : lo(
  ...
  return /* @__PURE__ */ a("div", { className: "flex w-full items-center justify-between", children: [
    ...
    /* @__PURE__ */ a(Nt, { nested: !0, children: [
      /* @__PURE__ */ a(ju, { className: C(vo({ variant: "ghost" }), "h-auto border p-1"), children: [
      ...
      /* @__PURE__ */ a(Bt, { className: "max-h-[70%]", children: ({ onOpenChange: o }) => /* @__PURE__ */ a(Q, { children: [
        /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a(Ut, { children: "Regionalismo" }) }),
  ...
  const e = yt((o) => o.theme), t = Co((o) => o.onOpen);
  return /* @__PURE__ */ a("div", { className: "flex w-full items-start justify-between", children: [
    ...
    /* @__PURE__ */ a(
      "input",
      {
        type: "checkbox",
        onChange: () => {
          const { theme: o, toggleTheme: n } = yt.getState(), i = o === "dark" ? "Claro" : "Escuro";
  ...
  const r = ee(), o = X((u) => u.region), n = J((u) => u.opacity), { theme: i, setTheme: s } = yt(), l = () => {
    const u = ho[0];
  ...
  return /* @__PURE__ */ a(
    Gu,
    {
      ...
      children: /* @__PURE__ */ a(Nt, { open: e, onOpenChange: t, children: /* @__PURE__ */ a(Bt, { children: [
        /* @__PURE__ */ a(Ot, { className: "relative", children: [
          /* @__PURE__ */ a(Ut, { icon: "settings", children: "Configurações" }),
  ...
  return /* @__PURE__ */ a("div", { className: "dropdown dropdown-center dropdown-top focus-within:**:data-[slot=tooltip-content]:hidden", children: [
    /* @__PURE__ */ a(Me, { offset: 8, content: "Velocidade", placement: "top", arrow: { position: "bottom" }, children: /* @__PURE__ */ a(ti, { "aria-label": "Alterar velocidade", variant: "ghost-gov", size: e ? "icon-sm" : "icon", children: /* @__PURE__ */ a("span", { inert: !0, className: "-mt-0.5 font-bold mobile:text-xs text-sm", children: [
      t,
      "x"
    ] }) }) }),
  ...
  const e = J((o) => o.isOpen), t = Ee((o) => o.open), { onPointerDown: r } = gr();
  return /* @__PURE__ */ a(
    "div",
    {
      className: C(
  ...
  return /* @__PURE__ */ a(Nt, { open: e, onOpenChange: t, children: /* @__PURE__ */ a(Bt, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a(Ut, { icon: "translator", children: "Tradutor" }) }),
  ...
  const { onPointerDown: e } = gr(), t = ee(), r = J((i) => i.setOpen), o = Ee((i) => i.open), n = () => {
    r(!1), Pt();
  };
...
const dp = ({ suggestions: e, coords: t, onSelect: r }) => e.length === 0 ? null : /* @__PURE__ */ a(
  ...
  const r = te(null), o = ee(), { data: n } = Ka(), { mutateAsync: i, isPending: s } = qa(), [l, c] = O([]), [u, p] = O({ top: 0, left: 0 }), [m, d] = O(""), g = !m.trim();
  S(() => d(P.get().gloss || ""), []);
  const h = z(() => n ? new Ha(n) : null, [n]), f = uo(() => {
    if (!r.current) return;
    ...
    c(h ? h.searchSigns(I) : []), p(cp(A, v));
  }, 300);
  return /* @__PURE__ */ a(Nt, { open: e, onOpenChange: t, children: /* @__PURE__ */ a(Bt, { children: [
    /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a(Ut, { children: "Feedback" }) }),
          ...
          if (!(!A || !v || !m))
            try {
              await i({
                ...
                rating: "bad"
              }), t(!1), sr("Agradecemos sua contribuição!", { variant: "primary", className: "font-semibold" }), kt("AGRADECER"), oe.set({ text: void 0 });
            } catch (y) {
              const I = y;
              I.message && sr(I.message, { variant: "destructive" });
            }
        }, disabled: s || g, children: s ? "Enviando..." : "Enviar sugestão" }),
        /* @__PURE__ */ a(U, { disabled: s || g, variant: "outline", onClick: () => kt(m), children: "Reproduzir" })
      ] })
    ] })
  ] }) });
  ...
  return /* @__PURE__ */ a(Q, { children: [
    /* @__PURE__ */ a(Nt, { open: e, onOpenChange: t, children: /* @__PURE__ */ a(Bt, { children: [
      /* @__PURE__ */ a(Ot, { children: /* @__PURE__ */ a(Ut, { icon: "comment", children: "Feedback" }) }),
              ...
              onClick: async () => {
                ...
                if (!(!c || !u))
                  try {
                    ...
                    const m = p;
                    m.message && sr(m.message, { variant: "destructive" });
                  } finally {
                    t(!1);
                  }
              },
  ...
  const { path: t } = Kt.getState();
  return `${t}/assets/images/avatars/${e}`;
}, gp = () => {
  const e = X((n) => n.avatar), t = Ee((n) => n.open), r = Tr.find(({ name: n }) => n === e) || Tr[0], o = (n) => {
    document.activeElement?.blur(), setTimeout(() => mr(n), 150), he.trackEvent("avatar_selected", { avatar: n });
  };
  return /* @__PURE__ */ a(
    "div",
    {
  ...
  const e = ee(), t = Ee((v) => v.open), { status: r, gloss: o, isPlayingWelcome: n } = X(q("status", "gloss", "isPlayingWelcome")), { isExpanded: i, isTranslating: s, text: l } = J(q("isExpanded", "text", "isTranslating")), { action: c, content: u } = _t(q("action", "content")), p = r === "playing", m = r === "paused", d = r === "idle";
  S(() => {
    if (!d) return;
  ...
  onLoaded: () => {
    ...
    xt({ baseUrl: xe.DICTIONARY_URL, personalizationUrl: e }), mr(t || r), go(o), setTimeout(_a, 1e3);
  },
  onPlay: () => {
    const { screen: e, open: t } = St.get();
  ...
  const e = te(null), { type: t, event: r, onClick: o, isActive: n, render: i } = Xt(), [s, l] = O({ x: 0, y: 0, arrow: "bottom" });
  return S(() => {
    const c = (u) => {
      e.current && !e.current.contains(u.target) && Yt.set({ isActive: !1 });
    };
  ...
  const e = yt((r) => r.theme), t = X((r) => r.isLoaded);
  return S(() => {
    if (!t) return;
    const r = Pp[e];
    Ca(r);
...
}, Wp = ({ callback: e, isWordByWord: t, hoverClss: r, activeClass: o }) => {
  const n = (p) => {
    const m = p.target;
    (!(Nr(m) && t) || !Ce(m, "IMG")) && m.classList.add(r);
  }, i = (p) => {
    !t || !r || io(() => {
      const m = p.target;
      if (!Nr(m)) return;
      jp(r);
      const { word: d, node: g, offset: h } = Vp(p.clientX, p.clientY) || {};
    ...
    if (Yt.set({ isActive: !1 }), Gp(o), g || m.classList.add(o), !Nr(m)) return;
    ...
    const h = m.tagName === "A" ? m : ri(m);
    h && c(h, p), Ce(m, "LABEL") ? Fp(m) : (Ce(m, "BUTTON") || Eo(m)) && c(m, p);
  }, l = (p) => {
    ...
    Yt.set({
      ...
      onClick: () => {
        p.dispatchEvent(new MouseEvent("click", { bubbles: !0 })), Yt.set({ isActive: !1 });
      }
    });
  }, u = () => {
...
}, Kp = () => (Jp(), Cp(), Hp(), Tp(), Ep(), Ip(), Rp(), null), qp = ({ children: e, root: t }) => {
  const [r, o] = O(!1);
  return S(() => {
    t && Eu(t, () => o(!0));
...
}, { root: Or, shadowRoot: vt, isRootActive: Nn } = $i();
function Xp() {
  ...
  return S(() => De.set({ root: Or, shadowRoot: vt }), [Or, vt]), S(() => {
    ...
    if (!o || ((async () => (await ts(o, vt), r(!0)))(), !t)) return;
    e(Nn());
  ...
  }, [o, e, t, r]), t ? /* @__PURE__ */ a(qp, { root: vt, children: /* @__PURE__ */ a(wp, {}) }) : null;
}
it(/* @__PURE__ */ a(Xp, {}), vt);
