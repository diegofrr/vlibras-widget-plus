var N, Nn, Ve, Ro, qt, On, Un, eo, Or, Ur, Bn, Yt = {}, Qn = [], ei = /(mi|mn|mo|ms$|mte|msp)/, Et = Array.isArray, ir = Qn.slice, Ie = Object.assign;
function to(e) {
...
function Br(e) {
  (8 & e.__g || !(e.__g |= 8) || !Ve.push(e) || qt++) && Ro == N.debounceRendering || ((Ro = N.debounceRendering) || queueMicrotask)(ri);
}
function ri() {
...
function Dn(e, t, r, o, n, i, s, l, c, u, p, m) {
  ...
  for (c = oi(r, t, v, c, y), d = 0; d < y; d++) (h = r.__k[d]) != null && (g = h.__i != -1 && v[h.__i] || Yt, h.__i = d, w = ro(e, h, g, n, i, s, l, c, u, p, m), f = h.__e, h.ref && g.ref != h.ref && (g.ref && oo(g.ref, null, h), p.push(h.ref, h.__c || f, h)), b == null && f != null && (b = f), (A = 4 & h.__u) || g.__k === h.__k ? c = zn(h, c, e, A) : typeof h.type == "function" && w !== void 0 ? c = w : f && (c = f.nextSibling), h.__u &= -7);
  return r.__e = b, c;
}
...
function ro(e, t, r, o, n, i, s, l, c, u, p) {
  var m, d, g, h, f, b, w, A, v, y, I, D, V, x, L, se, ie, J, he, oe = t.type;
  if (t.constructor !== void 0) return null;
  128 & r.__u && (c = 32 & r.__u) && r.__c.__z && (l = (i = r.__c.__z)[0], r.__c.__z = null), (m = N.__b) && m(t);
  e: if (typeof oe == "function") try {
    if (b = t.props, w = "prototype" in oe && oe.prototype.render, A = (m = oe.contextType) && o[m.__c], v = m ? A ? A.props.value : m.__ : o, r.__c ? 2 & (d = t.__c = r.__c).__g && (d.__g |= 1) : (w ? t.__c = d = new oe(b, v) : (t.__c = d = new Te(b, v), d.constructor = oe, d.render = ii), A && A.sub(d), d.state || (d.state = {}), d.__n = o, d.__g |= 8, d.__h = [], d._sb = []), w && d.__s == null && (d.__s = d.state), w && oe.getDerivedStateFromProps != null && (d.__s == d.state && (d.__s = Ie({}, d.__s)), Ie(d.__s, oe.getDerivedStateFromProps(b, d.__s))), g = d.props, h = d.state, d.__v = t, r.__c) {
      if (w && oe.getDerivedStateFromProps == null && b !== g && d.componentWillReceiveProps != null && d.componentWillReceiveProps(b, v), t.__v == r.__v || !(4 & d.__g) && d.shouldComponentUpdate != null && d.shouldComponentUpdate(b, d.__s, v) === !1) {
    ...
    } else w && oe.getDerivedStateFromProps == null && d.componentWillMount != null && d.componentWillMount(), w && d.componentDidMount != null && d.__h.push(d.componentDidMount);
    ...
    if (t.__v = null, c || i != null) if (le.then) {
      for (L = 0, t.__u |= c ? 160 : 128, t.__c.__z = [], ie = 0; ie < i.length; ie++) (J = i[ie]) == null || se || (J.nodeType == 8 ? (J.data == "$s" ? (L && t.__c.__z.push(J), L++) : J.data == "/$s" && (--L && t.__c.__z.push(J), se = L == 0, l = i[ie]), i[ie] = null) : L && (t.__c.__z.push(J), i[ie] = null));
      if (!se) {
...
function ai(e, t, r, o, n, i, s, l, c, u) {
  var p, m, d, g, h, f, b, w, A = r.props || Yt, v = t.props, y = t.type;
  ...
  if (y == null) A === v || l && e.data == v || (e.data = v);
    ...
    for (p in w = 1 & r.__u, v) h = v[p], p == "children" ? g = h : p == "dangerouslySetInnerHTML" ? m = h : p == "value" ? f = h : p == "checked" ? b = h : l && typeof h != "function" || A[p] === h && !w || Lt(e, p, h, A[p], n);
    ...
    l || (p = "value", y == "progress" && f == null ? e.removeAttribute("value") : f == null || f === e[p] && (y !== "progress" || f) || Lt(e, p, f, A[p], n), p = "checked", b != null && b != e[p] && Lt(e, p, b, A[p], n));
  }
  return e;
}
function oo(e, t, r) {
...
function it(e, t) {
  var r, o, n, i;
  t == document && (t = document.documentElement), N.__ && N.__(e, t), o = (r = e && 32 & e.__u) ? null : t.__k, t.__k = Ne(Q, null, [e]), n = [], i = [], ro(t, t.__k, o || Yt, Yt, t.namespaceURI, o ? null : t.firstChild ? ir.call(t.childNodes) : null, n, o ? o.__e : t.firstChild, r, i, t.ownerDocument), Mn(n, t.__k, i);
}
function si(e, t) {
  e.__u |= 32, it(e, t);
}
...
var Le, F, Ar, To, Lr = Object.is, st = 0, jn = [], W = N, No = W.__b, Oo = W.__r, Uo = W.diffed, Bo = W.__c, Qo = W.unmount, Lo = W.__;
function lt(e, t) {
...
W.__b = function(e) {
  ...
  Uo && Uo(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (jn.push(t) !== 1 && To === W.requestAnimationFrame || ((To = W.requestAnimationFrame) || ui)(di)), t.__H.__.some(function(r) {
...
function Bi(e) {
  return sr(e) ? li.apply(null, arguments) : e;
}
function Qi(e) {
...
var Mi = Q, Fi = sr, bt = { useState: O, useId: Hn, useReducer: no, useEffect: S, useLayoutEffect: Ke, useInsertionEffect: Zn, useTransition: Yn, useDeferredValue: qn, useSyncExternalStore: Xn, startTransition: io, useRef: te, useImperativeHandle: Wn, useMemo: M, useCallback: _e, useContext: xe, useDebugValue: Gn, version: "18.3.1", Children: fi, render: Si, hydrate: Ci, unmountComponentAtNode: Qi, createPortal: lo, createElement: Ne, createContext: Je, createFactory: Ni, cloneElement: Bi, createRef: ti, Fragment: Q, isValidElement: sr, isElement: Fi, isFragment: Oi, isMemo: Ui, findDOMNode: Li, Component: Te, PureComponent: Mr, memo: hi, forwardRef: gi, flushSync: Di, unstable_batchedUpdates: zi, StrictMode: Mi, Suspense: Gt, lazy: vi, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ti };
const Vi = (e) => e;
function ra(e, t = Vi) {
...
}, ge = ((e) => e ? Ho(e) : Ho), Ht = ge()(() => ({ path: "", version: "" })), oa = () => (S(() => {
  const e = Ht.getState();
...
function Hi(e, t) {
  return Object.is(e, t) ? !0 : typeof e != "object" || e === null || typeof t != "object" || t === null || Object.getPrototypeOf(e) !== Object.getPrototypeOf(t) ? !1 : Jo(e) && Jo(t) ? Ko(e) && Ko(t) ? Xo(e, t) : Gi(e, t) : Xo(
...
function Ji(e) {
  ...
  return (r) => {
    const o = e(r);
    return Hi(t.current, o) ? t.current : t.current = o;
  };
}
function yr(e, ...t) {
  const r = { ...e };
...
const Ki = (e) => e.replace(new RegExp("(?<!:)\\/+", "g"), "/"), na = () => Math.random().toString(36).slice(2, 8), X = (...e) => {
  const t = M(() => (r) => lr(r, ...e), [JSON.stringify(e)]);
  return Ji(t);
}, xr = "@vlibras-theme", Xi = (e) => ["light", "dark"].includes(e), wt = ge((e) => ({
  theme: (() => {
...
const es = (e, t) => {
  ...
  _s.test(e) && !Ss.test(e)
), ma = () => !1, Is = (e) => Cs.test(e), Ts = (e) => Es.test(e), Ns = (e) => !k(e) && !_(e), Os = (e) => ct(e, ba, ma), k = (e) => pa.test(e), Fe = (e) => ct(e, va, Ps), Sr = (e) => ct(e, Ds, T), $o = (e) => ct(e, ga, ma), Us = (e) => ct(e, fa, Ts), Dt = (e) => ct(e, Aa, Is), _ = (e) => ha.test(e), gt = (e) => dt(e, va), Bs = (e) => dt(e, zs), en = (e) => dt(e, ga), Qs = (e) => dt(e, ba), Ls = (e) => dt(e, fa), zt = (e) => dt(e, Aa, !0), ct = (e, t, r) => {
  const o = pa.exec(e);
  ...
  const e = Z("color"), t = Z("font"), r = Z("text"), o = Z("font-weight"), n = Z("tracking"), i = Z("leading"), s = Z("breakpoint"), l = Z("container"), c = Z("spacing"), u = Z("radius"), p = Z("shadow"), m = Z("inset-shadow"), d = Z("text-shadow"), g = Z("drop-shadow"), h = Z("blur"), f = Z("perspective"), b = Z("aspect"), w = Z("ease"), A = Z("animate"), v = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], y = () => [
    ...
    span: ["full", Ue, _, k]
  }, Ue, _, k], J = () => [Ue, "auto", _, k], he = () => ["auto", "min", "max", "fr", _, k], oe = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], le = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], Ae = () => ["auto", ...x()], Re = () => [et, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...x()], E = () => [e, _, k], Ut = () => [...y(), en, $o, {
    position: [_, k]
  }], Bt = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], Qt = () => ["auto", "cover", "contain", Qs, Os, {
    size: [_, k]
  }], qe = () => [_r, gt, Fe], Y = () => [
...
const jr = (e) => (t) => {
  ...
  "/src/widget/icons/categories/technology.webp": Hl,
  "/src/widget/icons/categories/undefined.webp": Jl,
  "/src/widget/icons/categories/verbs.webp": Kl,
  "/src/widget/icons/chevron-down.webp": Xl,
  "/src/widget/icons/chevron-left.webp": ql,
  ...
  "/src/widget/icons/emotions/automatic.webp": rc,
  "/src/widget/icons/emotions/default.webp": oc,
  "/src/widget/icons/emotions/disgust.webp": nc,
  "/src/widget/icons/emotions/fear.webp": ac,
  "/src/widget/icons/emotions/happy.webp": ic,
  "/src/widget/icons/emotions/sad.webp": sc,
  "/src/widget/icons/emotions/surprise.webp": lc,
...
var md = class extends ut {
  ...
  #v(e) {
    this.#y(), this.#c = e, !(Ct.isServer() || fe(this.options.enabled, this.#t) === !1 || !Hr(this.#c) || this.#c === 0) && (this.#u = je.setInterval(() => {
...
const ot = ge()(
  ...
  const e = te(null), t = te(null), r = te(null), o = rt(), [n, i] = O("categories"), { data: s, isLoading: l, refetch: c } = Ha(), { signs: u } = ot(), [p, m] = O(null), [d, g] = O(null), { data: h = [], isLoading: f } = nr({
    ...
    () => se ? Hd(x) : {},
    [x, se]
  ), J = M(() => Object.entries(ie), [ie]), [he, oe] = O(we);
  S(() => {
    Y(we), oe(20);
  }, [p]);
  const le = J.slice(0, he), Ae = _e(
    (B) => {
  ...
  S(() => {
    ...
    const B = new IntersectionObserver(
      (z) => {
        z[0].isIntersecting && y.length > I && V((ue) => ({ ...ue, visibleCount: ue.visibleCount + we }));
      },
      { threshold: 0.1 }
    );
    return e.current && B.observe(e.current), () => B.disconnect();
  }, [y.length, I]);
  const Bt = y.slice(0, I), Qt = { all: v.length, recents: u.length }, [qe, Y] = O(we), ce = M(() => x.slice(0, qe), [x, qe]), Ye = _e(
    (B) => {
      const z = B.currentTarget;
...
}, { Provider: Kd, useCtx: ke } = Ao(), Xd = ({ children: e }) => {
  const t = Jd();
  return /* @__PURE__ */ a(Kd, { data: t, children: e });
}, Xe = () => Dd({
  onMutate: (e) => {
    ae.set({ text: e, isTranslating: !0 });
  },
  onSettled: () => {
    P.set({ gloss: void 0 }), ae.set({ isTranslating: !1 });
  }
}), Sn = (async () => null)(), Ee = {
  _getContext: () => ({
...
const qa = (e) => {
  ...
  return t.querySelectorAll("ul, ol").forEach((r) => r.remove()), t.querySelectorAll("style, script, link, meta, noscript").forEach((r) => r.remove()), t.querySelectorAll("span.mw-cite-backlink, sup.reference, sup.cite_ref").forEach((r) => r.remove()), qa(t.textContent || "");
}, Rn = (e, t) => {
  const o = new DOMParser().parseFromString(e, "text/html"), n = o.querySelector("tbody")?.innerHTML.match(new RegExp(`title='(?<gender>${qd.join("|")})'`))?.groups?.gender, i = Array.from(o.querySelectorAll("ol > li")).map((h) => {
    let f = En(h);
...
}, gu = () => /* @__PURE__ */ a(Xd, { children: /* @__PURE__ */ a(Ea, { children: [
...
const _u = () => {
  const e = Ya((n) => n.onClose), { status: t, gloss: r } = q(X("gloss", "status")), o = M(() => r && t === "idle", [r, t]);
  ...
  const e = te(null), t = te(null), { index: r, setIndex: o, onClose: n } = Ya(X("index", "setIndex", "onClose")), i = M(() => r === 0, [r]), s = M(() => r === $r.length - 1, [r]);
  ...
  get: Ce.getState,
  set: Ce.setState
}, Cu = Rt("absolute flex flex-col gap-4 z-50 widget-radius bg-primary p-4 transition-position", {
  variants: {
    isMobile: { true: "", false: "" },
    isLeft: { true: "", false: "" },
    isTop: { true: "", false: "" },
  ...
  const { pos: e } = mr(), { innerWidth: t, innerHeight: r } = window, [o, n] = O(0), i = Ce(), s = H((f) => f.isExpanded), l = H((f) => f.isTranslating), c = nt((f) => f.appRoot), u = ee(), p = M(() => e.x < (t - (c?.clientWidth || 0)) / 2, [e.x, t]), m = M(() => e.y < (r - (c?.clientHeight || 0)) / 2, [e.y, r]), d = M(() => $r[o], [o]), g = () => {
    ae.set({ text: void 0 }), P.set({ gloss: void 0 }), Pn.get().reset(), h(), ur();
  };
  if (S(() => {
    l && g();
  }, [l]), S(() => {
  ...
  const { path: t } = oa(), { isLoaded: r } = q(), o = te(null), n = Ki(`${t}/unity/index.html`), i = (s, l, c) => {
    if (!o.current) return;
  ...
  const e = ee(), { gloss: t, status: r, isPlayingWelcome: o } = q(X("gloss", "status", "isPlayingWelcome")), n = () => {
    ...
    s === "idle" ? mo() : s === "paused" ? pe() : s === "playing" && (pr(), ae.set({ isPausedByUser: !0 }));
  }, i = Bu[r];
  return /* @__PURE__ */ a(
    ze,
    {
  ...
  return S(() => {
    if (e) return;
    const { isPausedByUser: u } = ae.get(), { gloss: p, isWelcomeFinished: m, status: d } = P.get();
  ...
  const e = te(null), t = H((n) => n.opacity), r = Co((n) => n.onOpen), o = (n) => {
    ae.set({ opacity: n / 100 }), e.current && clearTimeout(e.current), e.current = setTimeout(() => Ee.trackEvent("opacity_change", { opacity: n }), 2e3);
  };
  ...
  const r = ee(), o = q((u) => u.region), n = H((u) => u.opacity), { theme: i, setTheme: s } = wt(), l = () => {
    const u = ho[0];
    s("light"), P.set({ region: u }), ae.set({ opacity: 1 });
        ...
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a("div", { id: "settings-option", className: "col-span-1!", children: /* @__PURE__ */ a(Hu, {}) })
            ]
          }
        )
      ]
  ...
  const o = () => {
    ...
    const { root: s } = De.get(), { isExpanded: l } = ae.get();
    s && (ae.set({ isExpanded: !l }), Ee.trackEvent("expanded"));
...
const ip = ({ suggestions: e, coords: t, onSelect: r }) => e.length === 0 ? null : /* @__PURE__ */ a(
  ...
  const r = te(null), o = ee(), { data: n } = Ha(), { mutateAsync: i, isPending: s } = Ja(), [l, c] = O([]), [u, p] = O({ top: 0, left: 0 }), [m, d] = O(""), g = !m.trim();
  S(() => d(P.get().gloss || ""), []);
    ...
    /* @__PURE__ */ a("div", { className: "flex h-full flex-col gap-2 px-4 py-4", children: [
      ...
      /* @__PURE__ */ a("div", { className: "space-y-2 [&>button]:h-10 [&>button]:w-full [&>button]:rounded-full mobile:[&>button]:text-sm", children: [
        /* @__PURE__ */ a(U, { variant: "default", onClick: async () => {
          const { text: A } = ae.get(), { gloss: v } = P.get();
          if (!(!A || !v || !m))
            try {
              await i({
                text: A,
                ...
                rating: "bad"
              }), t(!1), ar("Agradecemos sua contribuição!", { variant: "primary", className: "font-semibold" }), xt("AGRADECER"), ae.set({ text: void 0 });
            } catch (y) {
              const I = y;
              I.message && ar(I.message, { variant: "destructive" });
            }
  ...
  const [r, o] = O(!1), { mutateAsync: n, isPending: i } = Ja();
  return /* @__PURE__ */ a(Q, { children: [
        ...
        /* @__PURE__ */ a("div", { className: "flex items-center justify-center gap-4 [&>button]:flex-col [&>button]:text-muted-foreground", children: [
          /* @__PURE__ */ a(
            U,
            {
              ...
              onClick: async () => {
                const { gloss: c } = P.get(), { text: u } = ae.get();
                if (!(!c || !u))
                  try {
                    await n({
                      text: u,
                    ...
                    const m = p;
                    m.message && ar(m.message, { variant: "destructive" });
                  } finally {
                    t(!1);
                  }
              },
  ...
  onPlay: () => {
    ...
    e !== "main" && t("main"), ae.set({ isPausedByUser: !1 });
  },
  onPlayStatic: () => {
    const { screen: e, open: t } = _t.get();
    e !== "main" && t("main"), ae.set({ isPausedByUser: !1 });
  ...
  const e = be((n) => n.screen), { isOpen: t, position: r, isExpanded: o } = H(X("isOpen", "position", "isExpanded"));
...
}, Mp = ({ callback: e, isWordByWord: t, hoverClss: r, activeClass: o }) => {
  const n = (p) => {
    const m = p.target;
    ...
    !t || !r || io(() => {
      ...
      if (!Tr(m)) return;
      Dp(r);
      const { word: d, node: g, offset: h } = Lp(p.clientX, p.clientY) || {};
    ...
    if (Xt.set({ isActive: !1 }), zp(o), g || m.classList.add(o), !Tr(m)) return;
    ...
    if (p.preventDefault(), p.stopPropagation(), t && r) {
      ...
      const f = !!m.dataset.vlibrasGloss?.trim(), b = Ip(m)?.trim();
      b && e?.({ text: b, element: m, isGloss: f });
    }
    const h = m.tagName === "A" ? m : $a(m);
    h && c(h, p), Se(m, "LABEL") ? Qp(m) : (Se(m, "BUTTON") || Eo(m)) && c(m, p);
  }, l = (p) => {
  ...
  S(() => {
    e && (t ? aa(Ep, "@text-capture.style") : Yi("@text-capture.style"));
  }, [t, e]), S(() => {
    if (!e) return;
    const o = Mp({
...
}, jp = () => (Fp(), xp(), Vp(), kp(), Cp(), _p(), null), Wp = ({ children: e, root: t }) => {
  const [r, o] = O(!1);
  return S(() => {
    t && ku(t, () => o(!0));
...
}, { root: Nr, shadowRoot: vt, isRootActive: Tn } = qi();
function Gp() {
  ...
  }, [o, e, t, r]), t ? /* @__PURE__ */ a(Wp, { root: vt, children: /* @__PURE__ */ a(fp, {}) }) : null;
}
it(/* @__PURE__ */ a(Gp, {}), vt);
