var N, On, Ve, Ro, Yt, Un, Bn, eo, Or, Ur, Qn, Zt = {}, Ln = [], ri = /(mi|mn|mo|ms$|mte|msp)/, Et = Array.isArray, sr = Ln.slice, Ie = Object.assign;
function to(e) {
...
function Ne(e, t, r) {
  ...
  return arguments.length > 2 && (s.children = arguments.length > 3 ? sr.call(arguments, 2) : r), At(e, s, o, n, null);
}
...
function Br(e) {
  (8 & e.__g || !(e.__g |= 8) || !Ve.push(e) || Yt++) && Ro == N.debounceRendering || ((Ro = N.debounceRendering) || queueMicrotask)(ni);
}
function ni() {
  for (var e, t, r, o, n, i, s, l, c = 1; Ve.length; ) Ve.length > c && Ve.sort(Un), e = Ve.shift(), c = Ve.length, 8 & e.__g && (r = void 0, o = void 0, n = (o = (t = e).__v).__e, i = [], s = [], (l = t.__P) && ((r = Ie({}, o)).__v = o.__v + 1, N.vnode && N.vnode(r), ro(l, r, o, t.__n, l.namespaceURI, 32 & o.__u ? [n] : null, i, n ?? at(o), !!(32 & o.__u), s, l.ownerDocument), r.__v = o.__v, r.__.__k[r.__i] = r, Fn(i, r, s), o.__ = o.__e = null, r.__e != n && Dn(r)));
  Yt = 0;
}
function Mn(e, t, r, o, n, i, s, l, c, u, p, m) {
  var d, g, h, f, b, w, A, v = o && o.__k || Ln, y = t.length;
  for (c = ai(r, t, v, c, y), d = 0; d < y; d++) (h = r.__k[d]) != null && (g = h.__i != -1 && v[h.__i] || Zt, h.__i = d, w = ro(e, h, g, n, i, s, l, c, u, p, m), f = h.__e, h.ref && g.ref != h.ref && (g.ref && oo(g.ref, null, h), p.push(h.ref, h.__c || f, h)), b == null && f != null && (b = f), (A = 4 & h.__u) || g.__k === h.__k ? c = zn(h, c, e, A) : typeof h.type == "function" && w !== void 0 ? c = w : f && (c = f.nextSibling), h.__u &= -7);
  return r.__e = b, c;
}
function ai(e, t, r, o, n) {
  var i, s, l, c, u, p = r.length, m = p, d = 0;
  for (e.__k = new Array(n), i = 0; i < n; i++) (s = t[i]) != null && typeof s != "boolean" && typeof s != "function" ? (typeof s == "string" || typeof s == "number" || typeof s == "bigint" || s.constructor == String ? s = e.__k[i] = At(null, s, null, null, null) : Et(s) ? s = e.__k[i] = At(Q, { children: s }, null, null, null) : s.constructor === void 0 && s.__b > 0 ? s = e.__k[i] = At(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v) : e.__k[i] = s, c = i + d, s.__ = e, s.__b = e.__b + 1, l = null, (u = s.__i = ii(s, r, c, m)) != -1 && (m--, (l = r[u]) && (l.__u |= 2)), l == null || l.__v == null ? (u == -1 && (n > p ? d-- : n < p && d++), typeof s.type != "function" && (s.__u |= 4)) : u != c && (u == c - 1 ? d-- : u == c + 1 ? d++ : (u > c ? d-- : d++, s.__u |= 4))) : e.__k[i] = null;
  if (m) for (i = 0; i < p; i++) (l = r[i]) != null && (2 & l.__u) == 0 && (l.__e == o && (o = at(l)), jn(l, l));
  return o;
}
function zn(e, t, r, o) {
  var n, i;
...
function Dt(e, t, r, o, n) {
  ...
  else if (t[0] == "o" && t[1] == "n") i = t != (t = t.replace(Bn, "$1")), t = t.slice(2).toLowerCase(), e.__l || (e.__l = {}), e.__l[t + i] = r, r ? o ? r.l = o.l : (r.l = eo, e.addEventListener(t, i ? Ur : Or, i)) : e.removeEventListener(t, i ? Ur : Or, i);
  else {
...
function ro(e, t, r, o, n, i, s, l, c, u, p) {
  var m, d, g, h, f, b, w, A, v, y, I, D, V, x, L, se, ie, H, me, ne = t.type;
  if (t.constructor !== void 0) return null;
  128 & r.__u && (c = 32 & r.__u) && r.__c.__z && (l = (i = r.__c.__z)[0], r.__c.__z = null), (m = N.__b) && m(t);
  e: if (typeof ne == "function") try {
    if (b = t.props, w = "prototype" in ne && ne.prototype.render, A = (m = ne.contextType) && o[m.__c], v = m ? A ? A.props.value : m.__ : o, r.__c ? 2 & (d = t.__c = r.__c).__g && (d.__g |= 1) : (w ? t.__c = d = new ne(b, v) : (t.__c = d = new Te(b, v), d.constructor = ne, d.render = li), A && A.sub(d), d.state || (d.state = {}), d.__n = o, d.__g |= 8, d.__h = [], d._sb = []), w && d.__s == null && (d.__s = d.state), w && ne.getDerivedStateFromProps != null && (d.__s == d.state && (d.__s = Ie({}, d.__s)), Ie(d.__s, ne.getDerivedStateFromProps(b, d.__s))), g = d.props, h = d.state, d.__v = t, r.__c) {
    ...
    if (d.context = v, d.props = b, d.__P = e, d.__g &= -5, I = N.__r, D = 0, w) d.state = d.__s, d.__g &= -9, I && I(t), m = d.render(d.props, d.state, d.context), (V = d.__h).push.apply(V, d._sb), d._sb = [];
    else do
      d.__g &= -9, I && I(t), m = d.render(d.props, d.state, d.context), d.state = d.__s;
    while (8 & d.__g && ++D < 25);
    d.state = d.__s, d.getChildContext != null && (o = Ie({}, o, d.getChildContext())), w && r.__c && d.getSnapshotBeforeUpdate != null && (f = d.getSnapshotBeforeUpdate(g, h)), x = m != null && m.type === Q && m.key == null ? Vn(m.props.children) : m, l = Mn(e, Et(x) ? x : [x], t, r, o, n, i, s, l, c, u, p), t.__u &= -161, d.__h.length && s.push(d), 2 & d.__g && (d.__g &= -4);
  } catch (le) {
    if (t.__v = null, c || i != null) if (le.then) {
      ...
      for (me = i.length; me--; ) to(i[me]);
      Qr(t);
    }
    else t.__e = r.__e, t.__k = r.__k, le.then || Qr(t);
    N.__e(le, t, r);
  }
  else l = t.__e = si(r.__e, t, r, o, n, i, s, c, u, p);
...
function Vn(e) {
  return typeof e != "object" || e == null || e.__b > 0 ? e : Et(e) ? e.map(Vn) : Ie({}, e);
}
function si(e, t, r, o, n, i, s, l, c, u) {
  var p, m, d, g, h, f, b, w, A = r.props || Zt, v = t.props, y = t.type;
  if (y == "svg" ? n = "http://www.w3.org/2000/svg" : y == "math" ? n = "http://www.w3.org/1998/Math/MathML" : n || (n = "http://www.w3.org/1999/xhtml"), i != null) {
    for (p = 0; p < i.length; p++) if ((h = i[p]) && "setAttribute" in h == !!y && (y ? h.localName == y : h.nodeType == 3)) {
      e = h, i[p] = null;
      break;
    }
  }
  ...
  if (y == null) A === v || l && e.data == v || (e.data = v);
    ...
    if (i = i && sr.call(e.childNodes), !l && i != null) for (A = {}, p = 0; p < e.attributes.length; p++) A[(h = e.attributes[p]).name] = h.value;
    for (p in A) h = A[p], p == "dangerouslySetInnerHTML" ? d = h : p == "children" || p in v || p == "value" && "defaultValue" in v || p == "checked" && "defaultChecked" in v || Dt(e, p, null, h, n);
    for (p in w = 1 & r.__u, v) h = v[p], p == "children" ? g = h : p == "dangerouslySetInnerHTML" ? m = h : p == "value" ? f = h : p == "checked" ? b = h : l && typeof h != "function" || A[p] === h && !w || Dt(e, p, h, A[p], n);
    if (m) l || d && (m.__html == d.__html || m.__html == e.innerHTML) || (e.innerHTML = m.__html), t.__k = [];
    else if (d && (e.innerHTML = ""), (y == "foreignObject" || n == "http://www.w3.org/1998/Math/MathML" && ri.test(y)) && (n = "http://www.w3.org/1999/xhtml"), Mn(y == "template" ? e.content : e, Et(g) ? g : [g], t, r, o, n, i, s, i ? i[0] : r.__k && at(r, 0), l, c, u), i != null) for (p = i.length; p--; ) to(i[p]);
    l || (p = "value", y == "progress" && f == null ? e.removeAttribute("value") : f == null || f === e[p] && (y !== "progress" || f) || Dt(e, p, f, A[p], n), p = "checked", b != null && b != e[p] && Dt(e, p, b, A[p], n));
  }
  return e;
}
function oo(e, t, r) {
...
function jn(e, t, r) {
  var o, n;
  if (N.unmount && N.unmount(e), !(o = e.ref) || o.current && o.current != e.__e || oo(o, null, t), (o = e.__c) != null) {
...
function it(e, t) {
  var r, o, n, i;
  t == document && (t = document.documentElement), N.__ && N.__(e, t), o = (r = e && 32 & e.__u) ? null : t.__k, t.__k = Ne(Q, null, [e]), n = [], i = [], ro(t, t.__k, o || Zt, Zt, t.namespaceURI, o ? null : t.firstChild ? sr.call(t.childNodes) : null, n, o ? o.__e : t.firstChild, r, i, t.ownerDocument), Fn(n, t.__k, i);
}
function ci(e, t) {
  e.__u |= 32, it(e, t);
}
function di(e, t, r) {
  ...
  return arguments.length > 2 && (s.children = arguments.length > 3 ? sr.call(arguments, 2) : r), At(e.type, s, o || e.key, n || e.ref, null);
}
function He(e) {
  function t(r) {
    var o, n;
...
N = { __e: function(e, t, r, o) {
  ...
  throw Yt = 0, e;
} }, On = 0, Te.prototype.setState = function(e, t) {
  var r;
...
}, Te.prototype.render = Q, Ve = [], Yt = 0, Un = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, Bn = /(PointerCapture)$|Capture$/i, eo = 0, Or = Io(!1), Ur = Io(!0), Qn = 0;
var ui = 0;
function a(e, t, r, o, n, i) {
  t || (t = {});
  var s, l, c = t;
  if ("ref" in c && typeof e != "function") for (l in c = {}, t) l == "ref" ? s = t[l] : c[l] = t[l];
  var u = { type: e, props: c, key: r, ref: s, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --ui, __i: -1, __u: 0, __source: n, __self: i };
  return N.vnode && N.vnode(u), u;
}
var Le, F, Ar, To, Lr = Object.is, st = 0, Gn = [], W = N, No = W.__b, Oo = W.__r, Uo = W.diffed, Bo = W.__c, Qo = W.unmount, Lo = W.__;
function lt(e, t) {
...
function pi() {
  for (var e; e = Gn.shift(); ) if (e.__P && e.__H) try {
...
W.__b = function(e) {
  ...
  Uo && Uo(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (Gn.push(t) !== 1 && To === W.requestAnimationFrame || ((To = W.requestAnimationFrame) || hi)(pi)), t.__H.__.some(function(r) {
...
var $n = Ke, so = Object.assign;
function Mr(e, t) {
  for (var r in e) if (r !== "__source" && !(r in t)) return !0;
  for (var o in t) if (o !== "__source" && e[o] !== t[o]) return !0;
  return !1;
}
var mi = /^(-|f[lo].*[^se]$|g.{5,}[^ps]$|z|o[pr]|(W.{5})?[lL]i.*(t|mp)$|an|(bo|s).{4}Im|sca|m.{6}[ds]|ta|c.*[st]$|wido|ini)/;
function zr(e, t) {
...
(zr.prototype = new Te()).isPureReactComponent = !0, zr.prototype.shouldComponentUpdate = function(e, t) {
  return Mr(this.props, e) || Mr(this.state, t);
};
var fi = /* @__PURE__ */ Symbol.for("react.forward_ref");
function bi(e) {
  function t(r) {
    var o = so({}, r);
    return delete o.ref, e(o, r.ref || null);
  }
  return t.$$typeof = fi, t.render = e, t.prototype.isReactComponent = !0, t.displayName = "ForwardRef(" + (e.displayName || e.name) + ")", t;
}
var zo = function(e, t, r) {
  return e == null ? null : Be(Be(e).map(t.bind(r)));
}, vi = { map: zo, forEach: zo, count: function(e) {
...
function xi(e) {
  ...
  it(Ne(yi, { context: t.context }, e.__v), t.l);
}
function lo(e, t) {
  var r = Ne(xi, { __v: e, i: t });
  return r.containerInfo = t, r;
}
N.unmount = function(e) {
  var t = e.__c;
  t && (t.__z = !0), t && t.__R && t.__R(), Fo && Fo(e);
}, (Jt.prototype = new Te()).__c = function(e, t) {
  var r = t.__c, o = this;
...
var ra = /* @__PURE__ */ Symbol.for("react.element"), ki = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, _i = /[A-Z0-9]/g, Si = typeof document < "u", Ci = function(e) {
...
function Ri(e, t, r) {
  return ci(e, t), typeof r == "function" && r(), e ? e.__c : null;
}
...
N.event = function(e) {
  return Vo && (e = Vo(e)), e.persist = Pi, e.isPropagationStopped = Ii, e.isDefaultPrevented = Ti, e.nativeEvent = e;
};
var co, Ni = { enumerable: !1, configurable: !0, get: function() {
  return this.class;
} }, jo = N.vnode;
N.vnode = function(e) {
  if (typeof e.type == "string") (function(o) {
    ...
    for (var c in n) {
      var u = n[c];
      if (!(c === "value" && "defaultValue" in n && u == null || Si && c === "children" && i === "noscript" || c === "class" || c === "className")) {
        if (c === "style" && typeof u == "object") for (var p in u) typeof u[p] != "number" || mi.test(p) || (u[p] += "px");
        else if (c === "defaultValue" && "value" in n && n.value == null) c = "value";
        else if (c === "download" && u === !0) u = "";
        else if (c === "translate" && u === "no") u = !1;
        else if (c[0] === "o" && c[1] === "n") {
          var m = c.toLowerCase();
          m === "ondoubleclick" ? c = "ondblclick" : m !== "onchange" || i !== "input" && i !== "textarea" || Ci(n.type) ? m === "onfocus" ? c = "onfocusin" : m === "onblur" && (c = "onfocusout") : m = c = "oninput", m === "oninput" && s[c = m] && (c = "oninputCapture");
        } else l && ki.test(c) ? c = c.replace(_i, "-$&").toLowerCase() : u === null && (u = void 0);
        s[c] = u;
      }
    }
    ...
    })), n.class && !n.className ? (s.class = n.class, Object.defineProperty(s, "className", Ni)) : n.className && (s.class = s.className = n.className), o.props = s;
  })(e);
...
}, useCallback: Se, useContext: ke, useDebugValue: Jn, useDeferredValue: Yn, useEffect: S, useId: Hn, useImperativeHandle: Wn, useInsertionEffect: $n, useLayoutEffect: Ke, useMemo: z, useReducer: no, useRef: te, useState: O, useSyncExternalStore: Xn, useTransition: Zn } } };
function Ui(e) {
...
var Vi = Q, ji = lr, bt = { useState: O, useId: Hn, useReducer: no, useEffect: S, useLayoutEffect: Ke, useInsertionEffect: $n, useTransition: Zn, useDeferredValue: Yn, useSyncExternalStore: Xn, startTransition: io, useRef: te, useImperativeHandle: Wn, useMemo: z, useCallback: Se, useContext: ke, useDebugValue: Jn, version: "18.3.1", Children: vi, render: Ei, hydrate: Ri, unmountComponentAtNode: Di, createPortal: lo, createElement: Ne, createContext: He, createFactory: Ui, cloneElement: Li, createRef: oi, Fragment: Q, isValidElement: lr, isElement: ji, isFragment: Bi, isMemo: Qi, findDOMNode: Mi, Component: Te, PureComponent: zr, memo: gi, forwardRef: bi, flushSync: zi, unstable_batchedUpdates: Fi, StrictMode: Vi, Suspense: Jt, lazy: wi, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Oi };
const Gi = (e) => e;
function oa(e, t = Gi) {
...
}, fe = ((e) => e ? Jo(e) : Jo), Ht = fe()(() => ({ path: "", version: "" })), na = () => (S(() => {
  const e = Ht.getState();
...
function Ki(e, t) {
  return Object.is(e, t) ? !0 : typeof e != "object" || e === null || typeof t != "object" || t === null || Object.getPrototypeOf(e) !== Object.getPrototypeOf(t) ? !1 : Ho(e) && Ho(t) ? Ko(e) && Ko(t) ? qo(e, t) : Hi(e, t) : qo(
...
function qi(e) {
  ...
  return (r) => {
    const o = e(r);
    return Ki(t.current, o) ? t.current : t.current = o;
  };
}
function yr(e, ...t) {
  const r = { ...e };
...
const Xi = (e) => e.replace(new RegExp("(?<!:)\\/+", "g"), "/"), aa = () => Math.random().toString(36).slice(2, 8), q = (...e) => {
  const t = z(() => (r) => cr(r, ...e), [JSON.stringify(e)]);
  return qi(t);
}, xr = "@vlibras-theme", Yi = (e) => ["light", "dark"].includes(e), wt = fe((e) => ({
  theme: (() => {
...
const rs = (e, t) => {
  ...
  t.validators === null && (t.validators = []), t.validators.push(os(r, e));
}, ps = (e, t, r, o) => {
  ...
  return r;
}, hs = (e) => "isThemeGetter" in e && e.isThemeGetter === !0, ms = (e) => {
  if (e < 1)
    return {
      get: () => {
      },
  ...
  if (t) {
    const n = t + Yo, i = o;
    o = (s) => s.startsWith(n) ? i(s.slice(n.length)) : Zo(gs, !1, s, void 0, !0);
  }
  if (r) {
    const n = o;
    o = (i) => r({
  ...
  for (let u = l.length - 1; u >= 0; u -= 1) {
    ...
    let b = !!f, w = o(b ? h.substring(0, f) : h);
    if (!w) {
      if (!b) {
        c = p + (c.length > 0 ? " " + c : c);
        continue;
    ...
    const A = d.length === 0 ? "" : d.length === 1 ? d[0] : i(d).join(":"), v = g ? A + Vr : A, y = v + w;
    if (s.indexOf(y) > -1)
      continue;
    s.push(y);
    const I = n(w, b);
  ...
  const s = (c) => {
    ...
    return r = vs(u), o = r.cache.get, n = r.cache.set, i = l, l(c);
  }, l = (c) => {
    const u = o(c);
    if (u)
      return u;
...
}, ha = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, ma = /^\((?:(\w[\w-]*):)?(.+)\)$/i, _s = /^\d+\/\d+$/, Ss = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Cs = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Es = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, Rs = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Ps = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, et = (e) => _s.test(e), T = (e) => !!e && !Number.isNaN(Number(e)), Ue = (e) => !!e && Number.isInteger(Number(e)), _r = (e) => e.endsWith("%") && T(e.slice(0, -1)), Pe = (e) => Ss.test(e), Is = () => !0, Ts = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  Cs.test(e) && !Es.test(e)
), ga = () => !1, Ns = (e) => Rs.test(e), Os = (e) => Ps.test(e), Us = (e) => !k(e) && !_(e), Bs = (e) => ct(e, va, ga), k = (e) => ha.test(e), Fe = (e) => ct(e, Aa, Ts), Sr = (e) => ct(e, zs, T), $o = (e) => ct(e, fa, ga), Qs = (e) => ct(e, ba, Os), Mt = (e) => ct(e, wa, Ns), _ = (e) => ma.test(e), gt = (e) => dt(e, Aa), Ls = (e) => dt(e, Fs), en = (e) => dt(e, fa), Ds = (e) => dt(e, va), Ms = (e) => dt(e, ba), zt = (e) => dt(e, wa, !0), ct = (e, t, r) => {
  const o = ha.exec(e);
  return o ? o[1] ? t(o[1]) : r(o[2]) : !1;
}, dt = (e, t, r = !1) => {
  const o = ma.exec(e);
  return o ? o[1] ? t(o[1]) : r : !1;
}, fa = (e) => e === "position" || e === "percentage", ba = (e) => e === "image" || e === "url", va = (e) => e === "length" || e === "size" || e === "bg-size", Aa = (e) => e === "length", zs = (e) => e === "number", Fs = (e) => e === "family-name", wa = (e) => e === "shadow", Vs = () => {
  const e = Z("color"), t = Z("font"), r = Z("text"), o = Z("font-weight"), n = Z("tracking"), i = Z("leading"), s = Z("breakpoint"), l = Z("container"), c = Z("spacing"), u = Z("radius"), p = Z("shadow"), m = Z("inset-shadow"), d = Z("text-shadow"), g = Z("drop-shadow"), h = Z("blur"), f = Z("perspective"), b = Z("aspect"), w = Z("ease"), A = Z("animate"), v = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], y = () => [
    "center",
    "top",
    "bottom",
    "left",
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], I = () => [...y(), _, k], D = () => ["auto", "hidden", "clip", "visible", "scroll"], V = () => ["auto", "contain", "none"], x = () => [_, k, c], L = () => [et, "full", "auto", ...x()], se = () => [Ue, "none", "subgrid", _, k], ie = () => ["auto", {
    span: ["full", Ue, _, k]
  }, Ue, _, k], H = () => [Ue, "auto", _, k], me = () => ["auto", "min", "max", "fr", _, k], ne = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], le = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], we = () => ["auto", ...x()], Re = () => [et, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...x()], E = () => [e, _, k], Bt = () => [...y(), en, $o, {
    position: [_, k]
  }], Qt = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], Lt = () => ["auto", "cover", "contain", Ds, Bs, {
    size: [_, k]
  }], Xe = () => [_r, gt, Fe], Y = () => [
    ...
    _,
    k
  ], ce = () => ["", T, gt, Fe], Ye = () => ["solid", "dashed", "dotted", "double"], Ze = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], j = () => [T, _r, en, $o], pt = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    h,
    _,
    k
  ], ze = () => ["none", T, _, k], $e = () => ["none", T, _, k], ht = () => [T, _, k], B = () => [et, "full", ...x()];
  return {
    cacheSize: 500,
    theme: {
    ...
    classGroups: {
       ...
       */
      "text-decoration-thickness": [{
        decoration: [T, "from-font", "auto", _, Fe]
      }],
      /**
...
const jr = (e) => (t) => {
  ...
  let i = {
    storage: dr(() => window.localStorage),
    partialize: (b) => b,
    version: 0,
    merge: (b, w) => ({
      ...w,
  ...
  const f = () => {
    ...
    return jr(p.getItem.bind(p))(i.name).then((y) => {
      ...
      A === l && (v?.(h, void 0), h = o(), s = !0, u.forEach((y) => y(h)));
    }).catch((y) => {
      A === l && v?.(void 0, y);
    });
  };
  ...
  ur(
    ...
    }),
    {
      name: "@vlibras/player",
      version: 1,
      storage: dr(() => localStorage),
      partialize: (e) => cr(e, "speed", "showSubtitles", "avatar", "config")
    }
  )
), P = {
  get: X.getState,
...
}, Al = "data:image/webp;base64,UklGRn4AAABXRUJQVlA4THIAAAAvP8APEA+wTyvxWv9dj2Ewim27yacvkRApSANpSEFClvQ0buj7iP4rchs1CrQndniF/EH67MgAdHVkxLeCPTlijpG6FkkbJFVIWiNp9XRSY4ypRHRAXYcmIVCkfvbD/tgv++c84vN5tvDIPrgf7usPRyE=", wl = "data:image/webp;base64,UklGRnoAAABXRUJQVlA4TG0AAAAvP8APEA+wUDPxWv9Vj2GwiWS7zXcuPwRBETQLmqAYgkrn+JNTH9F/RW7bNsx1t7+AP0RoGGQc45mWJW7MmlFzQfUNlZDqHBWfXTxu27YhQLo4O57CD+b7a/ds/F5+v/Ye6emhwav/gcJ//SAAAA==", yl = "data:image/webp;base64,", xl = "data:image/webp;base64,UklGRqIAAABXRUJQVlA4TJYAAAAvP8APEA8QEfMfwnFt205yzEMaAG3Dka8tM8wsSzqwBUr4Q8NfXMP75gIi+j8B/OExzB8MYqJNdTylek71xMipn8icJnWYOCG1M+eoVOnEJ/QK0VmzdqZMHf8djTInyJzje3LLw8PMrNYEyr1xzEAy4shre9BqgjoQlVUCjhrVJRDUazSBRp0gg1ocH6rSwwjOmKAJ/xc=", kl = "data:image/webp;base64,", _l = "data:image/webp;base64,", Sl = "data:image/webp;base64,UklGRqwAAABXRUJQVlA4TJ8AAAAvP8APEA8QEfMfwlEkSY7TF3LPg7BQBtrJEFshEAUx8F4TW481cgQi+j8B+sc4KqWhEGGU7aHPHCxLMEiaA3RSxJyRtCXcmUn7rG+5Z0FyzDHJT7AxKa1hNUgpwmiQyGhawwrNucGObk7xC7E0ajAvhXvWzT+luTlgmgNIEmCVUOmz9Ja3hOxe2bdYtq3EyryiVPHKvhIJBaW+FEelHwcA", Cl = "data:image/webp;base64,UklGRqIAAABXRUJQVlA4TJYAAAAvP8APEA8QEfMfwm1t7W3ymfSXbIBH0Vp0qPNaGsXZrUuCDh9Bn4gDRPRfkdu2jXIancov8IvwRUpYptT2X+yf7IBY1OYdEJe1hSfb2uYnrrbogCNrYwnU7CoaEDhNXAIgSQCIpHsyk2XyLdISbWQq7nqAooku0YMy79f/ZP6Hmk1F0/+LD/WT8aX+1Oe/zenV/D1+EQA=", El = "data:image/webp;base64,", Rl = "data:image/webp;base64,UklGRqgAAABXRUJQVlA4TJsAAAAvP8APEA8QEfMfAm5t7W2bp4gSrTLWkOSAtdxBo3ETYwSUzF/xw9kDRPR/AkCSgGwcFOOhNQFGE2E26TOqfio9P88/U/2O2SQYTfxMawJk46ExK2B8HyJA60uouFxbPGpQeYOLucLJ7GBnfrzxUFaQA7QO2gRz+MwoUPwLbYI5fCYHaB00HsqKh+SytGgkX6RVlkIruSLFUfL/FwA=", Pl = "data:image/webp;base64,", Il = "data:image/webp;base64,", Tl = "data:image/webp;base64,UklGRnQAAABXRUJQVlA4TGcAAAAvP8APEA8QEfMfwk0kSY5Ur82DcFAW2h7UhTDm6zLmTz+AiP5PADt8qycYVHtoqUCM3Ge9dwT3VCFSgZbqlEiq26gQIy2VkQqRhPsP9X/0Izd4H6AlVjuMqHZwT2VKjLSRYYS32rF9AA==", Nl = "data:image/webp;base64,", Ol = "data:image/webp;base64,", Ul = "data:image/webp;base64,", Bl = "data:image/webp;base64,", Ql = "data:image/webp;base64,", Ll = "data:image/webp;base64,", Dl = "data:image/webp;base64,", Ml = "data:image/webp;base64,", zl = "data:image/webp;base64,", Fl = "data:image/webp;base64,", Vl = "data:image/webp;base64,", jl = "data:image/webp;base64,", Gl = "data:image/webp;base64,UklGRqwAAABXRUJQVlA4TJ8AAAAvP8APEA8QEfMfwm1tu23zFVliBIyC0STZi6VFOAJKBRyhIEynBSL6PwH4x7mJlKKV63IyyQlQMlECVjZZucbExKRm5ZVXLpQKpZyUCqC4dcCtw1dzilYuNJlkAiydUxbgTO55AvzqfveKOWpqnu5Pb25R942r+927OWpqknv2BhFw0jnpBBiZqADGJutfrAUDSiZKAGCC8NXK0a2LfhwA", Wl = "data:image/webp;base64,UklGRpQAAABXRUJQVlA4TIcAAAAvP8APEA8QEfMfwlFs223znLqLGFhM8ill2fMFzVAEQcuUP2r+rggi+j8BAPwRajDax2pCUyIvJTTlY7VgNNf0fAO4IxB6BpCGxBEQPcmRgfOHxD6BVkjoCpyEI12AVlKi6xyLd0ndroKjRjKFo9ZfABoW7FJKaTvG9Zo1oIdVxJR4HZISjQEA", Jl = "data:image/webp;base64,UklGRpgAAABXRUJQVlA4TIwAAAAvP8APEA8QEfMfwlFsW3H0My+RgBRaSjtJpEVKJLDsgeIueGQ0ENH/CbBHviufTqVJZaeo+auyO5ImFRt1ODUqT4vAxc7MFvxnMrMVn1TIxQbsi0BXaczsA7OpUCTwKrki8+nEHBv1MhHsiD+SarP6oCKN2JjEghNGUHkuVqDYgOZQV2l2rYCVEMTdAQ==", Hl = "data:image/webp;base64,", Kl = "data:image/webp;base64,UklGRnoAAABXRUJQVlA4TG4AAAAvP8APEA8QEfMfwnEkSY4yJ4DnmjCOIBw7ZdqasufBPhET0YgRKAMi+j8B9HczgFPFrgDgM1J9EQefYx0RDYtB2t4YDFkMfMuwaHuKDIsm+JmVzwCSZIUlcw0VZeWsgMl6/Y4CsCcpZ+1UsaO/Cw==", ql = "data:image/webp;base64,", Xl = "data:image/webp;base64,", Yl = "data:image/webp;base64,UklGRoAAAABXRUJQVlA4THMAAAAvP8APEA+wUDNx2v+tj2G4iW0rkk7vIQ4GKdiaDKQhBQmEs1CNg44j+p+e+w0vBiTGQkmMjZoYFy3xCfRIj3wCLTEuaubeKJO5YC5lwr3VDONqCT6hR+jxE6ClcUHN9wZlzgXMCdwZGAn4RKAHoF1AWTwAAA==", Zl = "data:image/webp;base64,UklGRnQAAABXRUJQVlA4TGgAAAAvP8APEA8wUTMxtFsfh2AU23aTl4SyRAJSkEakIQUJWdL7pQuI6L8it20b5dRpO/mFflkBNObIACYwH/GzDlTlkbqAaA7RDKIpRN3nopfpRbjgFX5E/8zDfFd5/UmAHxm/nFcDgn5YAg==", $l = "data:image/webp;base64,UklGRoAAAABXRUJQVlA4THMAAAAvP8APEA8wUTNx2v+tj2G4iW0rkk7vIQ4GKdiaDKQhBQmEs1CNg44j+p8eQFmAdgE9AJ8IjATcGZgTlDkXqPneoKVxQY+fAJ/QI4yrJbi3mmEuZaJM5kLN3BstMS565BP4BHpkXLTE2KiJsVASAxJveHluAA==", ec = "data:image/webp;base64,UklGRpwAAABXRUJQVlA4TJAAAAAvP8APEA+wUCuxs2QDFIX/7zXGh8NVtW1tAyfzjigIRjJsdbdOagUpSOCyG5L8b5eCiP5PgPrzBlbwgJeWYrZoTlLnYrXY+ZgtHiFq4RqVEI8wggUDFWSgP8qgAgMWRrAf/PgSxw8ecIEAHhycPnLgIcAFHvCCeBZO0QguVsPCx6xbuKhrSYmno6RGaKGGvwU=", tc = "data:image/webp;base64,UklGRpoAAABXRUJQVlA4TI4AAAAvP8APEA8wUSMxtGTSNm3n3/Cu+HA4qm3baQ59iASkII0v7TuIBSRkSL+D+yBFQUT/J4B/zlUkBbPU2SINdkmTSRKQrIDZOnhbD4sNTw4b4bLpicIHKSruclT9zxx1n+Wo+l2Kis+IeHDZ9OSwERYb4LD+poPLqpsC5EQjJOvtJVWQVR0jRjgPUe6ixL8D", rc = "data:image/webp;base64,", oc = "data:image/webp;base64,", nc = "data:image/webp;base64,UklGRrYAAABXRUJQVlA4TKoAAAAvP8APEA8QEfMfAlJsW3GgR2VaIgEpSAsO2hJSkJDeZaByF48eFUT0fwL0n9s2gkGFyU5I1iEbgKRiQao2Sc026bAonZakbvk7r+0Sw18oo/BVJffcmSrpTKfFMx3fS2c6mRq5587WGP6DOpr+4gM+mQoRDkIhvvtBEOlMJxK5Tt126UV6CYVd6sSDbGCnJemwKDXbpGqTVCxIMknqkO2EZBUmE2jYttE/BQ==", ac = "data:image/webp;base64,", ic = "data:image/webp;base64,", sc = "data:image/webp;base64,", lc = "data:image/webp;base64,", cc = "data:image/webp;base64,UklGRrIAAABXRUJQVlA4TKUAAAAvP8APEA8QEfMfwlFsW3H0qB5YIgEpSAvSkIKELHugchfv96ggov8ToH+eOYJgwMluUG1BMwBJ3ZI07CRNy9JuRbpZlZa1dw7bJMIv9Ci9GrTVFqdBvdWblVvd36u3euM0aast8iT8gwHbAacBZY/yjE7jrR6lDqlDUiTBabx32CYt8qRZ2e3GdlClHaBI07I07CR1S5JMkhY0u0G1AScTKJw5+lMA", dc = "data:image/webp;base64,", uc = "data:image/webp;base64,UklGRpAAAABXRUJQVlA4TIQAAAAvP8APEA8wUSuxsxegj0M4qm2rrWClDZGAFKSBk1h5UpDAMJ12b35RENH/CVD//WTdhZwHsnxHsYdcZPvoIg/JKBAhkaS8gy0ncPk4ACfIKrgZlBYUByQa/ToMSBYUDUoWba6T4ULLA6LJFqzZgJwXMhBNFPLEEfuRI55kpr8jJGSv/hs=", pc = "data:image/webp;base64,UklGRq4AAABXRUJQVlA4TKEAAAAvP8APEA8wUSuxs2TSNm3n3+7u+HC4iW07bq7GSX4pCIYiSmFgQROUD+GX2V/xlZ1ARP8ngF8ey0yaDGlJIdV0k1qSJKCnAiMt4FJxg9CGVzip4SvctOIt1ckjbckmSpoMiS6ZS+XZkCxeWb7nM3NV8CfxypgtXzq9ULpkoQ/AGxs8Xmtwe3JK65MKkQw8LTBSgZ4AHhYt3SxqCosldTvyjwA=", hc = "data:image/webp;base64,", mc = "data:image/webp;base64,UklGRqAAAABXRUJQVlA4TJMAAAAvP8APEA8wUSsxtGTSNm3n3/Cu+HA4im0rcm7mJRKQ0tIaaTgJElj2/BafD5UoiOj/BEC60Sw4ZW7UQ5+GFM0lTeaQ5N2AS9IDkiR9IJvoTFDM3FONepa+rxP/LvyiDpWhbCKkvgnwLudwFkkRqJICULo+QHaSg6SHubxw3IxCpvHBJicPFYWh2KgdkzMPLJJ3+wUA", gc = "data:image/webp;base64,", fc = "data:image/webp;base64,", bc = "data:image/webp;base64,UklGRqQAAABXRUJQVlA4TJgAAAAvP8APEA+wUCsxs2TSNm3nX/C++HA4qm2rdW76EAlIQRpIQ0qKgd5ZnAHllxiI6P8ESApG1bOvJVwlQxGAhaQI7KR4Aox0BrDSu5EKJ+U+38Pf5D7bkwa9G+fCSbGhM+Al7QG6IuAbTlIArCRlcEUCW5wb+0YEM84edkXgtqqpem75Ie/REq1FJbMaALuGKUKPHeSK2OPHAA==", vc = "data:image/webp;base64,", Ac = "data:image/webp;base64,UklGRrAAAABXRUJQVlA4TKQAAAAvP8APEA8wUSsxtGQDFIX/zzXHh8NRbdtNdbNoQyQgJdKItCcFCQxbFmdw86uCiP5PgP45uhZrI6CzHWarkA1AUrEkhXXSZpO02ywdtkjV8juPrZarwXLAG6WVXgXk2vLuJ90B3QbpgOmt7sVkAfmA7nellQpMW6sLSIJUQG88dMFqYNXyO4ct0m6ztNkkhXVSsSTJJKlCth1mC+hMz6pmdK0/BQ==", wc = "data:image/webp;base64,", yc = "data:image/webp;base64,", xc = "data:image/webp;base64,UklGRoAAAABXRUJQVlA4THQAAAAvP8APEA+wUCuxsy+wj0O4rm2ria75kxIshdLAziiFEvhUJ9wJ7y5jARH9nwDcorOit1LYkrmlqGDNm55+y3vcQuUAREaSROL0V4kmbxlEs1slICrR7DaIZrfKCjibF6NwyKzUWzxFIQckVtlCJBvAAyXgxA==", kc = "data:image/webp;base64,UklGRowAAABXRUJQVlA4TH8AAAAvP8APEA+wUCsxtATZNtvu73qE+HC4jWw3bj5HB0KUgFJUmlAaSmEJCCVfP/jjVHFE/ycAz7XozQVoxkUHLgngJ6d4CwGAyEM+I0OuUS69lMlcypIcUuQyl2lT7F9ZyVKWJASAuPSSIdfIQz4DFAI/evOUuOSSAFocKHpzwXMFAA==", _c = "data:image/webp;base64,UklGRlwAAABXRUJQVlA4TE8AAAAvP8APEA8wUCsxtATZNtvuT3uB+HAwjiSpzWRCKIRG2t57kP4R/SeatmndXHcG/1GnlJKA2FCQOtdMZnxD8jnHnnv9k78+59i1378xf1YAAA==", Sc = "data:image/webp;base64,UklGRlgAAABXRUJQVlA4TEwAAAAvP8APEA8wUSsxtGQDFIX/7zXGh4NRbLtO7m+wjIRIwRrSIiVO6L0uI/ovICgywQtuUFfTJWg7sU7AOvW5xjsF/31shXony78rvy8P", Cc = "data:image/webp;base64,UklGRnwAAABXRUJQVlA4TG8AAAAvP8APEA+wUDNx2v8L7McwXMW2GzfSePtUGJhCGQiaiHfvu90QRPR/Aux/T3CGa1O3gIQbNViwoeDmsGBDwc2hQUDCjRoEJBTcHNpH66P2kasylRDQwFRCQANTBRsWuCpTGxY0MJUQ6trU2fQBfwsA", Ec = "data:image/webp;base64,", Rc = "data:image/webp;base64,", Pc = "data:image/webp;base64,UklGRqoAAABXRUJQVlA4TJ4AAAAvP8APEA+wUCtx2n8yaZu28693b2w8XEW23TY3/VMQBEXQFDMzg1AwhPSeHDdVBBH9V+S2bcPcuuv2FapZ3W7uaee+rpa/z3NsoDHS8wAXOwIYfSdO+k98hJhVjj/ui5e+mCNOerLrsNKRVYuROhZ7dlI7WcVJMenmcKHw/OF9wvvN71uSRzq3MM8w30jeOi6gMbnvU/t9nzbyPyqWAA==", Ic = "data:image/webp;base64,UklGRnYAAABXRUJQVlA4TGkAAAAvP8APEA+wUDOxs2TSNm3n3/Cu+HAwaiPJUV+c50JYKANtqQ2UCwAOQpz6LYCI/k+A+hsmxSRFlTaTNoebBjAo4NDgHsCggEODe4cTLri7c8EJe9a2zKGAwZA1ZQ4FDAZQ5llUMCkm9RcA", Tc = "data:image/webp;base64,UklGRq4AAABXRUJQVlA4TKEAAAAvP8APEA+wUCsxsy+Ij0M4qm2ndi5lkCESkIKlOgBpkRIJGb5+M+CmXwMR/Z8A/L0lXpKayBERAWu+Fe22VR1KbK5NLJCUJ6t3JgdrzrqxoWwuFkjKk9U7k4M1Z93YUDbX1jwAFxOLAiM1kaRtEdE1yEjmYoGkPFm9iwngchBrzrqxoWIN8LnEYocoKSdWsYgApIFqZ2swzOSZ3JMjOSffBAA=", Nc = "data:image/webp;base64,UklGRlwAAABXRUJQVlA4TFAAAAAvP8APEA+wUCsxtC+gj0MwaiPJUV/s51BeaAtlIAyDS5vDvSP6PwEY9xWECy0+tMU0xB8gJoBRqQS0xhVsiYBSawhgYtQrSB/aYi60IIRxAw==", Oc = "data:image/webp;base64,UklGRrYAAABXRUJQVlA4TKoAAAAvP8APEA+wUJ/4n1kCAYrC/6suRKcDcm3tjZNnG/iXKkGNzNFPSXQwf2l/KWS2XpK/hTSBUEBE/yeA//hVPvjW3IWkLiUdgFvntTsb5wN8vp24PYEEt0ZohtuyyiEKaQ5U0uoescCSL7SFaaFt8oW64AttYdrUSHMk70KqpM25pnQhnUhTFCBM1E46LDUAvZwG3w+jm7SpI60NoixUH6kOWPouo9fT6Jo/CQ==", Uc = "data:image/webp;base64,UklGRqgAAABXRUJQVlA4TJwAAAAvP8APEA+wUJ/431kCAYrC/6suRKfDUSRZldQTP45IeEYmeOuM52As4WAtIGGPnOgDvP0LiOj/BOAXb05bZz3OKC+Y6CymSQneOalreuGxeDJpcCwOPRu5AsyFjLCJwKjmgFSUIACSc76UHHXEUSc550vJUUc+os9YRAkZKE4dCNQwrKjrEPBYYBcVbYHxTnK4SAJg6MwA+tqo+MM=", Bc = "data:image/webp;base64,UklGRrAAAABXRUJQVlA4TKQAAAAvP8APEA+wUCuxs2QDFIX/v7XHh8NxZNtSchn/khBIw52GZADgkBlm8s1gnn9xF+9dKI0gov8TgB+m4LF1dtw6kVSZOTWpMK/i5WUxmASvw+CthsaJe2dzmtNNOKhgknidjuJQmPVpnxmcMvwLuRTMRBDNlIVpgVHwKp7CtsAoknjNOokoBrGbBTWKJF6TGgAnEUkGAAPJAsCOZAYA5Bb2xeD8KQ==", Qc = "data:image/webp;base64,", Lc = "data:image/webp;base64,UklGRmgAAABXRUJQVlA4TFsAAAAvP8APEA+wUJ/4P+0/2QBF4f97jZH5YBvbVpTnHloCpVgalEYplmC4ewPA3Tyi/xOgJ+82BhEH2TEPhaQRwEhr0N0xBkYP7gGaL/BB8UcuyL5EgSTtYIMB2uDpAA==", Dc = "data:image/webp;base64,", Mc = "data:image/webp;base64,UklGRrYAAABXRUJQVlA4TKkAAAAvP8APEA+wUCuxs2QDFIX/37XGh8NRbdtNRWcYCUiJtJcZtiIlOMgQfnl3LV6hKIjoPwO3bRux+/ad7xXNmyX3GpO+HKCGCgTxA6IAgFMSrbqHOrCIWd1MnbiLRd0RiB4W5IEqjqS117LW37HF33qivOw994VyqD3PhVKorccu9CHehe6/z/33v/xO19/x+jvb72/zsPnYvGx+Jk+br83bz79hcv6PF0sDAA==", zc = "data:image/webp;base64,", Fc = "data:image/webp;base64,UklGRqwAAABXRUJQVlA4TJ8AAAAvP8APEA/wqP+RmNllD0s4im0rjm7PSyR8KUgL0iIFCSx7zvB4rCIgov9q27ZhnKkX+wuOaw0gwfMEJeB5gVl4QBUStIDWpaBm+D5gnuB/gbLAcgKWkwIqV1IjagZ4phYALbRUh2upDtdSKEu3FJaFDv+pA9/cgWc43BmU+CC/3//x//xf/9/5GPDjfDl/zqfz63wb/67HQB/Xa6DfYQ0A", Vc = "data:image/webp;base64,UklGRnYAAABXRUJQVlA4TGkAAAAvP8APEA8wUStx2v8n1McwWEW21eZlEIAEpCCNwRlWcMAnqbR70wVE9H8C5H9zKaUYCQWqhHRGZkOWHci9r5QyFxyJJ9NBNpJIIMK2SwUFkshGDuQLjmQejgLd+zZkWUYmIR2QkjwY+V8A", jc = /* @__PURE__ */ Object.assign({
  "/src/widget/icons/arrow-left.webp": Al,
  "/src/widget/icons/arrow-right.webp": wl,
  "/src/widget/icons/categories/adjective.webp": yl,
  "/src/widget/icons/categories/all.webp": xl,
  "/src/widget/icons/categories/alphabet.webp": kl,
  "/src/widget/icons/categories/animals.webp": _l,
  "/src/widget/icons/categories/art.webp": Sl,
  "/src/widget/icons/categories/asterisk.webp": Cl,
  "/src/widget/icons/categories/body.webp": El,
  "/src/widget/icons/categories/communication.webp": Rl,
  "/src/widget/icons/categories/countries.webp": Pl,
  "/src/widget/icons/categories/economy.webp": Il,
  "/src/widget/icons/categories/education.webp": Tl,
  "/src/widget/icons/categories/family.webp": Nl,
  "/src/widget/icons/categories/fashion.webp": Ol,
  "/src/widget/icons/categories/feelings.webp": Ul,
  "/src/widget/icons/categories/foods.webp": Bl,
  "/src/widget/icons/categories/fruits.webp": Ql,
  "/src/widget/icons/categories/health.webp": Ll,
  "/src/widget/icons/categories/jobs.webp": Dl,
  "/src/widget/icons/categories/locations.webp": Ml,
  "/src/widget/icons/categories/machines.webp": zl,
  "/src/widget/icons/categories/measures.webp": Fl,
  "/src/widget/icons/categories/nature.webp": Vl,
  "/src/widget/icons/categories/numbers.webp": jl,
  "/src/widget/icons/categories/people.webp": Gl,
  "/src/widget/icons/categories/politics.webp": Wl,
  "/src/widget/icons/categories/religion.webp": Jl,
  "/src/widget/icons/categories/sports.webp": Hl,
  "/src/widget/icons/categories/technology.webp": Kl,
  "/src/widget/icons/categories/undefined.webp": ql,
  "/src/widget/icons/categories/verbs.webp": Xl,
  "/src/widget/icons/chevron-down.webp": Yl,
  "/src/widget/icons/chevron-left.webp": Zl,
  "/src/widget/icons/chevron-up.webp": $l,
  "/src/widget/icons/collapse.webp": ec,
  "/src/widget/icons/comment.webp": tc,
  "/src/widget/icons/dictionary.webp": rc,
  "/src/widget/icons/emotions/angry.webp": oc,
  "/src/widget/icons/emotions/default.webp": nc,
  "/src/widget/icons/emotions/disgust.webp": ac,
  "/src/widget/icons/emotions/fear.webp": ic,
  "/src/widget/icons/emotions/happy.webp": sc,
  "/src/widget/icons/emotions/sad.webp": lc,
  "/src/widget/icons/emotions/surprise.webp": cc,
  "/src/widget/icons/emotions/upset.webp": dc,
  "/src/widget/icons/expand.webp": uc,
  "/src/widget/icons/facebook.webp": pc,
  "/src/widget/icons/govbr.webp": hc,
  "/src/widget/icons/guga.webp": mc,
  "/src/widget/icons/hands.webp": gc,
  "/src/widget/icons/help.webp": fc,
  "/src/widget/icons/hosana.webp": bc,
  "/src/widget/icons/icaro.webp": vc,
  "/src/widget/icons/info.webp": Ac,
  "/src/widget/icons/instagram.webp": wc,
  "/src/widget/icons/libras.webp": yc,
  "/src/widget/icons/like.webp": xc,
  "/src/widget/icons/link.webp": kc,
  "/src/widget/icons/menu.webp": _c,
  "/src/widget/icons/pause.webp": Sc,
  "/src/widget/icons/play.webp": Cc,
  "/src/widget/icons/repeat.webp": Ec,
  "/src/widget/icons/rotate-left.webp": Rc,
  "/src/widget/icons/settings.webp": Pc,
  "/src/widget/icons/skip.webp": Ic,
  "/src/widget/icons/subtitle-off.webp": Tc,
  "/src/widget/icons/subtitle.webp": Nc,
  "/src/widget/icons/thumbs-down.webp": Oc,
  "/src/widget/icons/thumbs-up.webp": Uc,
  "/src/widget/icons/touch.webp": Bc,
  "/src/widget/icons/translator.webp": Qc,
  "/src/widget/icons/trash.webp": Lc,
  "/src/widget/icons/twitter.webp": Dc,
  "/src/widget/icons/waiting.webp": Mc,
  "/src/widget/icons/worldwide.webp": zc,
  "/src/widget/icons/x.webp": Fc,
  "/src/widget/icons/youtube.webp": Vc
}), R = ({ className: e, name: t, colored: r = !1, style: o, ...n }) => {
  const i = jc[`/src/widget/icons/${t}.webp`];
  return /* @__PURE__ */ a(
    "i",
    {
      ...n,
...
}, Wc = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1, VITE_PUBLIC_POSTHOG_DEBUG: "true", VITE_PUBLIC_POSTHOG_ENABLED: "true", VITE_PUBLIC_POSTHOG_HOST: "https://us.i.posthog.com", VITE_PUBLIC_POSTHOG_PROJECT_TOKEN: "phc_rkupE6DkPSJl7SntaagI0wq0FCKtg3lVP0UkC95NGYe" }, Jc = 1e4, rn = {
  development: {
...
}, ya = "production", Hc = rn[ya] || rn.development, xe = {
  ...Wc,
  ...Hc,
  REQUEST_TIMEOUT: Jc,
  MODE: ya
...
}, Er = ["icaro", "guga", "hosana"], xa = () => {
  P.set({ isPlayingWelcome: !1, isWelcomeFinished: !0 });
}, re = (e, t, r) => {
  P.get().send(e, t, r);
}, yt = (e) => {
  if (!e.baseUrl && !e.personalizationUrl) return;
  e.baseUrl && re(ae.PLAYER, G.SET_BASE_URL, e.baseUrl), e.personalizationUrl && re(ae.CUSTOMIZATION, G.SET_PERSONALIZATION, e.personalizationUrl);
  const { config: t } = P.get();
  P.set({ config: { ...t, ...e } });
}, ue = (e) => {
  if (!e) return re(ae.PLAYER, G.SET_PAUSE_STATE, 0);
  re(ae.PLAYER, G.PLAY, e), P.set({ gloss: e }), Oe.get().onPlay?.(e), P.get().isWelcomeFinished || xa();
}, ka = () => {
  const { showSubtitles: e } = P.get();
  re(ae.PLAYER, G.PLAY_WELCOME), re(ae.PLAYER, G.SET_SUBTITLES_STATE, Number(e)), P.set({ isPlayingWelcome: !0 });
}, xt = (e) => {
  const { region: t } = P.get(), r = `${xe.DICTIONARY_STATIC_URL}${t.abbreviation}/`, o = xe.DICTIONARY_URL;
  yt({ baseUrl: r }), e ? (re(ae.PLAYER, G.PLAY, e), Oe.get().onPlayStatic?.(e)) : re(ae.PLAYER, G.SET_PAUSE_STATE, 0), yt({ baseUrl: o }), P.get().isWelcomeFinished || xa();
}, mo = () => {
  const { gloss: e } = P.get();
  e && ue(e), Oe.get().onRepeat?.();
}, pr = () => {
  re(ae.PLAYER, G.STOP), Oe.get().onStop?.();
}, Rt = () => {
  re(ae.PLAYER, G.SET_PAUSE_STATE, 1), Oe.get().onPause?.();
}, go = (e) => {
  re(ae.PLAYER, G.SET_SPEED, e), P.set({ speed: e });
}, hr = (e) => {
  const t = P.get().avatar, r = (Er.indexOf(e || t) + (e ? 0 : 1)) % Er.length, o = Er[r];
  re(ae.PLAYER, G.SET_AVATAR, o), P.set({ avatar: o });
}, fo = (e) => {
  const { showSubtitles: t } = P.get(), r = e ?? !t;
  re(ae.PLAYER, G.SET_SUBTITLES_STATE, Number(r)), P.set({ showSubtitles: r });
}, Kc = (e) => {
  const t = `${xe.DICTIONARY_URL}${e.abbreviation}/`;
  yt({ baseUrl: t }), P.set({ region: e });
}, _a = (e) => {
  P.set({ emotion: e }), re(ae.EMOTION, e.action);
}, Sa = ({ color: e, outline: t, shadow: r }) => {
  re(ae.CUSTOMIZATION, G.SET_SUBTITLE_COLOR, e), re(ae.CUSTOMIZATION, G.SET_SUBTITLE_OUTLINE_COLOR, t || e), re(ae.CUSTOMIZATION, G.SET_SUBTITLE_SHADOW_COLOR, r || e);
  ...
  {
    onClick: (s) => {
      tr(), xt(t), o?.(s), r && bo({ action: r, auto: !0 });
    },
    type: "button",
  ...
  ur(
    ...
    {
      name: "@vlibras-widget",
      partialize: (e) => cr(e, "position", "isActive", "isOpen", "opacity"),
      version: 1
    }
  )
);
...
function Xc({ children: e }) {
  const t = te(null), r = te({ x: 0, y: 0 }), o = J((g) => g.isExpanded), [n, i] = O({ x: 0, y: 0 }), [s, l] = O(!1), [c, u] = O(!1), p = () => {
    i({ x: 0, y: 0 }), l(!1);
  };
  S(() => {
    ...
    const g = () => {
      !t.current || !s || i((h) => {
        ...
        const f = t.current.getBoundingClientRect(), b = window.innerWidth - f.width, w = window.innerHeight - f.height, A = Math.max(0, Math.min(h.x, b)), v = Math.max(0, Math.min(h.y, w));
  ...
  return /* @__PURE__ */ a(Ea.Provider, { value: d, children: e(d) });
}
const an = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, sn = la, Pt = (e, t) => (r) => {
  var o;
...
), Ra = ({ children: e, className: t, ...r }) => /* @__PURE__ */ a(
  "div",
  {
    autofocus: !0,
    className: C(
...
}, Ia = ({ children: e, className: t, ...r }) => /* @__PURE__ */ a("h3", { className: C("pointer-events-none font-semibold mobile:text-sm text-base", t), ...r, children: e }), Ta = ({ children: e, className: t, ...r }) => /* @__PURE__ */ a("div", { className: C("flex h-full flex-col gap-4 overflow-y-auto p-4", t), ...r, children: e }), ln = ({ label: e, description: t, children: r }) => /* @__PURE__ */ a("div", { className: "flex flex-col gap-2 text-sm", children: [
  ...
  return /* @__PURE__ */ a(Ra, { children: [
    /* @__PURE__ */ a(Pa, { close: !0, children: /* @__PURE__ */ a(Ia, { children: "Sobre" }) }),
    /* @__PURE__ */ a(Ta, { className: "flex flex-col text-sm", children: [
        ...
        ln,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "flex w-full flex-col justify-between gap-2 rounded-lg bg-white p-2", children: [
            /* @__PURE__ */ a("div", { className: "flex w-full items-center justify-between gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 justify-start", children: /* @__PURE__ */ a("img", { src: fl, alt: "logo do Ministério dos Direitos Humanos e da Cidadania" }) }),
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 justify-start", children: /* @__PURE__ */ a("img", { src: bl, alt: "logo do Ministério da Gestão e da Inovação em Serviços Públicos" }) })
            ] }),
            /* @__PURE__ */ a("div", { className: "flex items-center justify-between gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 items-center justify-start", children: /* @__PURE__ */ a("img", { src: gl, alt: "logo do lavid", className: "max-w-15" }) }),
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 items-center justify-start", children: /* @__PURE__ */ a("img", { src: vl, alt: "logo da RNP" }) }),
...
function Ao() {
  const e = He(null), t = ({ children: n, data: i }) => {
    const s = te(null);
    return s.current || (s.current = qn(() => ({ data: i }))), Ke(() => s.current?.setState({ data: i }), [i]), /* @__PURE__ */ a(e.Provider, { value: s.current, children: n });
  };
  function r(n) {
    const i = ke(e);
...
var Na = {}, nd = typeof window > "u" || "Deno" in globalThis;
function de() {
}
function ad(e, t) {
...
function dn(e, t) {
  ...
  if (i) {
    if (!t.options.mutationKey)
      return !1;
    if (r) {
      if (We(t.options.mutationKey) !== We(i))
        return !1;
...
function Ua(e, t) {
  return Na.NODE_ENV !== "production" && e.queryFn === or && console.error(
...
function La(e) {
  let t = !1, r = 0, o;
  const n = Xr(), i = () => n.status !== "pending", s = (f) => {
    if (!i()) {
      const b = new Yr(f);
      d(b), e.onCancel?.(b);
    }
    ...
    t = !1;
  }, u = () => wo.isFocused() && (e.networkMode === "always" || nr.isOnline()) && e.canRun(), p = () => Qa(e.networkMode) && e.canRun(), m = (f) => {
    i() || (o?.(), n.resolve(f));
  }, d = (f) => {
    i() || (o?.(), n.reject(f));
  }, g = () => new Promise((f) => {
    ...
    Promise.resolve(f).then(m).catch((w) => {
      if (i())
        return;
      const A = e.retry ?? (Ct.isServer() ? 0 : 3), v = e.retryDelay ?? md, y = typeof v == "function" ? v(r, w) : v, I = A === !0 || typeof A == "number" && r < A || typeof A == "function" && A(r, w);
      if (t || !I) {
        d(w);
        return;
      }
      r++, e.onFail?.(r, w), sd(y).then(() => u() ? void 0 : g()).then(() => {
        t ? d(w) : h();
      });
    });
  };
...
var Da = class {
  ...
  setData(e, t) {
    const r = qr(this.state.data, e, this.options);
    return this.#l({
      data: r,
      type: "success",
  ...
  isStaleByTime(e = 0) {
    return this.state.data === void 0 ? !0 : e === "static" ? !1 : this.state.isInvalidated ? !0 : !Oa(this.state.dataUpdatedAt, e);
  }
  onFocus() {
  ...
  async fetch(e, t) {
    ...
    this.options.behavior?.onFetch(s, this), this.#t = this.state, (this.state.fetchStatus === "idle" || this.state.fetchMeta !== s.fetchOptions?.meta) && this.#l({ type: "fetch", meta: s.fetchOptions?.meta }), this.#o = La({
...
var fd = class extends ut {
  constructor(e, t) {
    super(), this.options = t, this.#e = e, this.#s = null, this.#i = Xr(), this.bindMethods(), this.setOptions(t);
  }
  #e;
  #t = void 0;
  #r = void 0;
  ...
  getOptimisticResult(e) {
    ...
    return vd(this, r) && (this.#n = r, this.#a = this.options, this.#o = this.#t.state), r;
  }
  getCurrentResult() {
    return this.#n;
  }
  ...
  #f() {
    ...
    if (Ct.isServer() || this.#n.isStale || !Jr(e))
      return;
    const r = Oa(this.#n.dataUpdatedAt, e) + 1;
  ...
  createResult(e, t) {
    ...
    if (t.placeholderData !== void 0 && d === void 0 && f === "pending") {
      ...
      n?.isPlaceholderData && t.placeholderData === s?.placeholderData ? (x = n.data, b = !0) : x = typeof t.placeholderData == "function" ? t.placeholderData(
        this.#m?.state.data,
        this.#m
      ) : t.placeholderData, x !== void 0 && (f = "success", d = qr(
        n?.data,
        x,
        t
      ), m = !0);
    ...
    if (t.select && d !== void 0 && !b)
      if (n && d === i?.data && t.select === this.#l)
        ...
        try {
          this.#l = t.select, d = t.select(d), d = qr(n?.data, d, t), this.#h = d, this.#s = null;
        } catch (x) {
          this.#s = x;
        }
...
function fn(e, t) {
  return bd(e, t) || e.state.data !== void 0 && Zr(e, t, t.refetchOnMount);
}
function Zr(e, t, r) {
  ...
  return {
    onFetch: (t, r) => {
      ...
      const u = async () => {
        ...
        const m = (h) => {
        ...
        }, d = Ua(t.options, t.fetchOptions), g = async (h, f, b) => {
          if (p)
          ...
          const A = (() => {
            ...
            return m(D), D;
          })(), v = await d(A), { maxPages: y } = t.options, I = b ? cd : ld;
          return {
            pages: I(h.pages, v, y),
            pageParams: I(h.pageParams, f, y)
          };
        };
        if (n && i.length) {
          const h = n === "backward", f = h ? Ad : An, b = {
            pages: i,
            pageParams: s
          }, w = f(o, b);
          l = await g(b, w, h);
...
function Ad(e, { pages: t, pageParams: r }) {
  return t.length > 0 ? e.getPreviousPageParam?.(t[0], t, r[0], r) : void 0;
}
var wd = class extends Da {
  #e;
  #t;
  #r;
  #n;
...
var xd = class extends ut {
  ...
  setOptions(t) {
    ...
    this.options = this.#e.defaultMutationOptions(t), rr(this.options, r) || this.#e.getMutationCache().notify({
      ...
      mutation: this.#r,
      observer: this
    }), r?.mutationKey && this.options.mutationKey && We(r.mutationKey) !== We(this.options.mutationKey) ? this.reset() : this.#r?.state.status === "pending" && this.#r.setOptions(this.options);
  }
  onUnsubscribe() {
  ...
  #s;
  constructor(e = {}) {
    this.#e = e.queryCache || new kd(), this.#t = e.mutationCache || new yd(), this.#r = e.defaultOptions || {}, this.#n = /* @__PURE__ */ new Map(), this.#o = /* @__PURE__ */ new Map(), this.#a = 0;
  }
  mount() {
...
var Va = He(
  ...
  e.unmount();
}), [e]), /* @__PURE__ */ a(Va.Provider, { value: e, children: t }));
function Ed() {
  let e = !1;
  return {
    clearReset: () => {
...
var Rd = He(Ed()), Pd = () => ke(Rd), Id = (e, t) => {
  ...
  query: o,
  suspense: n
}) => e.isError && !t.isReset() && !e.isFetching && o && (n && e.data === void 0 || Ba(r, [e.error, o])), Od = (e) => {
  if (e.suspense) {
...
}, Ud = (e, t) => e.isLoading && e.isFetching && !t, Bd = (e, t) => e?.suspense && t.isPending, wn = (e, t, r) => t.fetchOptimistic(e).catch(() => {
  r.clearReset();
});
function Ga(e, t) {
...
function Qd(e, t, r) {
  ...
  const o = Sd(), n = Pd(), i = ja(), s = i.defaultQueryOptions(e);
  ...
  )), s._optimisticResults = o ? "isRestoring" : "optimistic", Od(s), Id(s, n), Td(n);
  ...
  return i.getDefaultOptions().queries?._experimental_afterQuery?.(
    s,
    u
  ), s.experimental_prefetchInRender && !Ct.isServer() && Ud(u, o) && (l ? (
...
function Wa(e, t) {
  ...
  if (n.error && Ba(o.options.throwOnError, [n.error]))
    throw n.error;
...
const Ae = {
  ...
  const e = new AbortController(), t = setTimeout(() => e.abort(), xe.REQUEST_TIMEOUT);
  return { controller: e, timeoutId: t };
}, Ld = async (e) => {
  const { controller: t, timeoutId: r } = ko();
  try {
    const o = await fetch(xe.TRANSLATE_URL, {
      method: "POST",
    ...
    return console.error("Falha na tradução: ", o), o.name === "AbortError" ? {
      success: !1,
      error: Ae.TRANSLATION_TIMEOUT_ERROR,
      code: "TRANSLATION_TIMEOUT_ERROR"
    } : {
      success: !1,
      error: Ae.TRANSLATION_ERROR,
  ...
  try {
    const r = await fetch(xe.SIGNS_URL, {
      method: "GET",
      headers: { "Content-Type": "application/json" },
      signal: e.signal
    });
    ...
    return console.error("Falha na tradução: ", r), r.name === "AbortError" ? {
      success: !1,
      error: Ae.SIGNS_TIMEOUT_ERROR,
      code: "SIGNS_TIMEOUT_ERROR"
    } : {
      success: !1,
      error: Ae.SIGNS_ERROR,
      code: "SIGNS_ERROR"
    };
  } finally {
    clearTimeout(t);
  ...
  const { controller: t, timeoutId: r } = ko();
  try {
    const o = await fetch(xe.REVIEW_URL, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    return console.error("Falha no envio do feedback: ", o), o.name === "AbortError" ? {
      success: !1,
      error: Ae.SEND_REVIEW_TIMEOUT_ERROR,
      code: "SEND_REVIEW_TIMEOUT_ERROR"
    } : {
      success: !1,
      error: Ae.SEND_REVIEW_ERROR,
  ...
  queryFn: async () => {
    ...
    if (!t.data) throw new Error(Ae.SIGNS_EMPTY_ERROR);
    return t.data;
  }
}), Ka = (e) => Wa({
  ...e,
  ...
  mutationFn: async (t) => {
    const r = await Ld(t);
    return r.error && console.error(r.error), r.data || console.error(Ae.TRANSLATION_EMPTY_ERROR), r.data || t;
  }
}), qa = () => {
  const e = new AbortController(), t = setTimeout(() => e.abort(), xe.REQUEST_TIMEOUT);
  return { controller: e, timeoutId: t };
}, Fd = async () => {
  const { controller: e, timeoutId: t } = qa();
  try {
    const r = await fetch(`${xe.DICTIONARY_CATEGORIES_URL}/tags`, {
      method: "GET",
      headers: { "Content-Type": "application/json" },
      signal: e.signal
    });
  ...
  const { controller: t, timeoutId: r } = qa();
  try {
    return { data: await (await fetch(`${xe.DICTIONARY_CATEGORIES_URL}/tagsigns?tag=${e}`, {
      method: "GET",
      headers: { "Content-Type": "application/json" },
      signal: t.signal
    })).json(), success: !0 };
...
}, jd = ["#", ..."ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")], Gd = {
  "1S_": "EU",
  "2S_": "VOCÊ",
  "3S_": "ELE(A)",
  "1P_": "NÓS",
...
function Kd(e) {
  ...
  for (const r of e) {
    ...
    if (t[o] ??= { conjugation: [], desambiguation: [] }, r.includes("&"))
      ...
      const n = r.match(kn);
      if (n) {
        const i = n[1] ?? "", s = n[2], l = n[3] ?? "", c = Gd[i] ?? "", u = Wd[l] ?? "";
...
const rt = fe()(
  ur((e) => ({ isMaxRetries: !1, retriesCount: 0 }), {
    name: "@vlibras/dictionary",
    version: 1,
    storage: dr(() => sessionStorage),
    partialize: (e) => cr(e, "isMaxRetries"),
...
const ot = fe()(
  ...
  const e = te(null), t = te(null), r = te(null), o = rt(), [n, i] = O("categories"), { data: s, isLoading: l, refetch: c } = Ha(), { signs: u } = ot(), [p, m] = O(null), [d, g] = O(null), { data: h = [], isLoading: f } = ar({
    queryKey: ["categories"],
    queryFn: Fd,
    select: ({ data: B }) => B.filter((M) => M.name !== "INDEFINIDO")
  }), { data: b = [], isLoading: w } = ar({
  ...
  }, v = z(() => s ? new Ja(s).searchSigns("") : [], [s]), [{ filteredSigns: y, visibleCount: I, search: D }, V] = O({
    filteredSigns: [],
    search: "",
    visibleCount: ye
  }), x = z(() => {
    ...
    () => se ? Kd(x) : {},
    [x, se]
  ), H = z(() => Object.entries(ie), [ie]), [me, ne] = O(ye);
  S(() => {
    Y(ye), ne(20);
  }, [p]);
  const le = H.slice(0, me), we = Se(
    (B) => {
  ...
  S(() => {
    ...
    const B = new IntersectionObserver(
      (M) => {
        M[0].isIntersecting && y.length > I && V((pe) => ({ ...pe, visibleCount: pe.visibleCount + ye }));
      },
      { threshold: 0.1 }
    );
    return e.current && B.observe(e.current), () => B.disconnect();
  }, [y.length, I]);
  const Qt = y.slice(0, I), Lt = { all: v.length, recents: u.length }, [Xe, Y] = O(ye), ce = z(() => x.slice(0, Xe), [x, Xe]), Ye = Se(
    (B) => {
      const M = B.currentTarget;
      M.scrollTop + M.clientHeight >= M.scrollHeight - 50 && Y((ge) => ge >= x.length ? ge : ge + ye);
    },
    [x.length]
  );
  S(() => {
  ...
  const Ze = z(() => Jd(v), [v]), j = z(() => {
    if (!d) return [];
    const B = D.toLowerCase().trim(), M = Ze.find((pe) => pe.letter === d)?.items ?? [];
    return B === "" ? M : M.filter((pe) => pe.toLowerCase().includes(B));
  }, [d, Ze, D]), [pt, ze] = O(ye), $e = z(() => j.slice(0, pt), [j, pt]), ht = Se(
    (B) => {
      const M = B.currentTarget;
      M.scrollTop + M.clientHeight >= M.scrollHeight - 50 && ze((ge) => ge >= j.length ? ge : ge + ye);
    },
    [j.length]
  );
  return S(() => {
...
}, { Provider: Xd, useCtx: _e } = Ao(), Yd = ({ children: e }) => {
  const t = qd();
  return /* @__PURE__ */ a(Xd, { data: t, children: e });
}, qe = () => zd({
  onMutate: (e) => {
    oe.set({ text: e, isTranslating: !0 });
  },
  onSettled: () => {
    P.set({ gloss: void 0 }), oe.set({ isTranslating: !1 });
  }
}), Sn = 0.07, Ya = "production", Zd = Ya !== "production", Cn = (async () => {
...
const Za = (e) => {
  ...
  return t.querySelectorAll("ul, ol").forEach((r) => r.remove()), t.querySelectorAll("style, script, link, meta, noscript").forEach((r) => r.remove()), t.querySelectorAll("span.mw-cite-backlink, sup.reference, sup.cite_ref").forEach((r) => r.remove()), Za(t.textContent || "");
}, Pn = (e, t) => {
  const o = new DOMParser().parseFromString(e, "text/html"), n = o.querySelector("tbody")?.innerHTML.match(new RegExp(`title='(?<gender>${$d.join("|")})'`))?.groups?.gender, i = Array.from(o.querySelectorAll("ol > li")).map((h) => {
    let f = Rn(h);
  ...
  )?.textContent?.trim(), u = eu(o), p = {}, m = o.querySelector("table.traduções");
  ...
  const [e, t] = O(null), { data: r, isFetching: o } = ar({
  ...
  ), t = gr(), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (g) => {
    try {
      const h = await r(g);
      ue(h), ve.setState({ screen: "main" });
    } catch (h) {
  ...
  if (S(() => {
    ...
    const h = new IntersectionObserver(
      ([f]) => {
        f.isIntersecting && u((b) => Math.min(b + jt, e.filteredSigns.length));
      },
      { threshold: 0.1 }
    );
  ...
  const m = (g) => {
    ...
    (g) => {
      ...
      h.scrollTop + h.clientHeight >= h.scrollHeight - 100 && u((b) => Math.min(b + jt, e.filteredSigns.length));
    },
...
}, So = () => /* @__PURE__ */ a("div", { className: "grid h-full place-content-center", children: /* @__PURE__ */ a(_o, {}) }), nu = () => {
  const { search: e, setSelectedCategory: t, categories: r, listRef: o, setFilter: n, isLoadingCategories: i } = _e(
  ...
  return r.length ? s.length ? /* @__PURE__ */ a("div", { ref: o, className: "h-full overflow-auto", children: /* @__PURE__ */ a("ul", { className: "flex flex-col", children: [
    s.map((l) => {
      const c = Xa[l.id] || "categories/undefined";
      return /* @__PURE__ */ a("li", { children: [
        /* @__PURE__ */ a(
          "button",
          {
  ...
  const { selectedCategory: e, setSelectedCategory: t } = _e(
    q("selectedCategory", "setSelectedCategory")
  );
  if (!e) return null;
  const r = Xa[e.id] || "categories/undefined";
  ...
  const e = gr(), t = _e(q("visibleVerbGroups", "onVerbScroll", "listRef")), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (c) => {
    try {
      const u = await r(c);
      ue(u), ve.setState({ screen: "main" });
    } catch (u) {
  ...
  const e = gr(), t = _e(q("visibleCategoryWords", "isVerbCategory", "listRef", "onCategoryScroll")), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (u) => {
    try {
      const p = await r(u);
      ue(p), ve.setState({ screen: "main" });
    } catch (p) {
      console.error("Erro ao reproduzir definição: ", p);
    }
  };
  if (t.isVerbCategory) return /* @__PURE__ */ a(iu, {});
  const c = z(() => Hd(t.visibleCategoryWords), [t.visibleCategoryWords]);
  ...
  const { signs: e } = ot(), { setFilter: t, filter: r, handleHistoryClear: o } = _e(
  ...
  const { selectedLetter: e, setSelectedLetter: t } = _e(q("selectedLetter", "setSelectedLetter"));
  return e ? /* @__PURE__ */ a("div", { className: "flex w-full animate-move-up items-center gap-1 bg-primary/20 mobile:px-3 px-4 mobile:py-2 py-3", children: /* @__PURE__ */ a(
    "button",
    {
      type: "button",
  ...
  const e = _e(q("visibleLetterWords", "onLetterScroll", "listRef")), t = gr(), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (c) => {
    try {
      const u = await r(c);
      ue(u), ve.setState({ screen: "main" });
    } catch (u) {
...
}, gu = () => /* @__PURE__ */ a(Q, { children: [
  /* @__PURE__ */ a(hu, {}),
  /* @__PURE__ */ a(mu, {})
] }), fu = () => {
  const { search: e, searchRef: t, handleSearchChange: r, handleClearSearch: o } = _e(
  ...
  if (!e.data && e.filter === "all") return /* @__PURE__ */ a(du, { onRetry: e.retry, isMaxRetries: e.isMaxRetries });
  ...
  return /* @__PURE__ */ a("div", { className: "flex h-full flex-col gap-2 overflow-hidden text-primary dark:text-white", children: [
    ...
    e.filter === "categories" && e.selectedCategory && /* @__PURE__ */ a(lu, {}),
    t && /* @__PURE__ */ a(gu, {}),
    e.filter !== "categories" && !t && !r && /* @__PURE__ */ a(ou, {}),
...
}, vu = () => /* @__PURE__ */ a(Yd, { children: /* @__PURE__ */ a(Ra, { children: [
  /* @__PURE__ */ a(Pa, { close: !0, children: /* @__PURE__ */ a(Ia, { children: "Dicionário" }) }),
  /* @__PURE__ */ a(Ta, { className: "overflow-hidden p-0", children: /* @__PURE__ */ a(bu, {}) })
] }) }), Au = () => {
  const e = ve((t) => t.screen);
  return /* @__PURE__ */ a(Q, { children: [
    e === "dictionary" && /* @__PURE__ */ a(vu, {}),
    e === "about" && /* @__PURE__ */ a($c, {})
  ] });
};
let tt = [], Kt = [];
const Pr = () => Kt.forEach((e) => e([...tt])), ir = (e, t) => {
  ...
  return S(() => wu(t), []), r ? lo(
    /* @__PURE__ */ a("div", { className: "pointer-events-none absolute inset-0 z-2147483647", children: e.map((o) => /* @__PURE__ */ a(xu, { ...o }, o.id)) }),
    r
  ) : null;
}, _u = () => {
...
const Eu = () => {
  const e = $a((n) => n.onClose), { status: t, gloss: r } = X(q("gloss", "status")), o = z(() => r && t === "idle", [r, t]);
  ...
  const e = te(null), t = te(null), { index: r, setIndex: o, onClose: n } = $a(q("index", "setIndex", "onClose")), i = z(() => r === 0, [r]), s = z(() => r === $r.length - 1, [r]);
  ...
  get: Ee.getState,
  set: Ee.setState
}, Pu = Pt("absolute flex flex-col gap-4 z-50 widget-radius bg-primary p-4 transition-position", {
  variants: {
    isMobile: { true: "", false: "" },
    isLeft: { true: "", false: "" },
    isTop: { true: "", false: "" },
...
}), { Provider: Iu, useCtx: $a } = Ao(), Tu = () => {
  const { pos: e } = mr(), { innerWidth: t, innerHeight: r } = window, [o, n] = O(0), i = Ee(), s = J((f) => f.isExpanded), l = J((f) => f.isTranslating), c = nt((f) => f.appRoot), u = ee(), p = z(() => e.x < (t - (c?.clientWidth || 0)) / 2, [e.x, t]), m = z(() => e.y < (r - (c?.clientHeight || 0)) / 2, [e.y, r]), d = z(() => $r[o], [o]), g = () => {
    oe.set({ text: void 0 }), P.set({ gloss: void 0 }), In.get().reset(), h(), pr();
  };
  if (S(() => {
    l && g();
  }, [l]), S(() => {
  ...
  return /* @__PURE__ */ a(Iu, { data: { index: o, setIndex: n, onClose: g, ...i }, children: /* @__PURE__ */ a(
    "div",
    {
      className: C(
        Pu({ isMobile: u, isLeft: p, isTop: m, isExpanded: s }),
        !s && !u && d.guideClx,
  ...
  const e = Ee((t) => t.open);
  return /* @__PURE__ */ a(Q, { children: e && /* @__PURE__ */ a(Tu, {}) });
}, Ou = Pt("fixed z-2147483647", {
  variants: {
  ...
  const t = (r) => {
    if (r.data?.type === "unity_event") {
      ...
      if (r.data.event === ft.ON_PLAYING_STATE_CHANGE) {
        const { isPlaying: o, isPaused: n, isLoading: i } = Uu(r.data.data);
  ...
  const { path: t } = na(), r = X((s) => s.isLoaded), o = te(null), n = Xi(`${t}/unity/index.html`), i = (s, l, c) => {
    if (!o.current) return;
  ...
  if (S(() => {
    ...
    return /* @__PURE__ */ a(Q, { children: [
      ...
      /* @__PURE__ */ a(Bu, { path: t })
    ] });
}, ei = ({ variant: e, asChild: t, size: r, className: o, disabled: n, ...i }) => t ? /* @__PURE__ */ a("div", { inert: n, role: "button", tabIndex: 0, className: o, ...i, children: i.children }) : /* @__PURE__ */ a(
  "div",
  {
    "aria-disabled": n,
    inert: n,
  ...
  const e = ee(), t = X((n) => n.emotion), r = (n) => {
    _a(n), he.trackEvent("change_emotion", { emotion: n.name });
  }, o = t === Gr.default;
  return /* @__PURE__ */ a("div", { className: "dropdown dropdown-center dropdown-top focus-within:**:data-[slot=tooltip-content]:hidden", children: [
    /* @__PURE__ */ a(Me, { offset: 8, content: "Emoções", placement: "top", arrow: { position: "bottom" }, children: /* @__PURE__ */ a(
      ei,
      {
        ...
        children: /* @__PURE__ */ a("div", { className: "relative flex items-center justify-center", children: [
          ...
          /* @__PURE__ */ a(
            "ul",
            {
              ...
              children: Object.values(Gr).map((n) => {
                const i = n === t;
                return /* @__PURE__ */ a("li", { children: /* @__PURE__ */ a(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ a("div", { className: "flex items-center justify-start gap-1.5", children: [
                      /* @__PURE__ */ a(R, { name: n.icon, className: "mobile:size-4.5 size-5" }),
  ...
  const e = ee(), { gloss: t, status: r, isPlayingWelcome: o } = X(q("gloss", "status", "isPlayingWelcome")), n = () => {
    ...
    s === "idle" ? mo() : s === "paused" ? ue() : s === "playing" && (Rt(), oe.set({ isPausedByUser: !0 }));
  }, i = Du[r];
  return /* @__PURE__ */ a(
    Me,
    {
...
}, It = He(null), Fu = ({ children: e }) => {
  const t = aa(), r = ke(It), o = X((s) => s.status === "playing"), [n, i] = O(!0);
  return S(() => {
  ...
  return S(() => {
    if (e) return;
    const { isPausedByUser: u } = oe.get(), { gloss: p, isWelcomeFinished: m, status: d } = P.get();
    if (l && d === "playing") return Rt();
  ...
  const n = ke(It), i = nt((s) => s.appRoot);
  return !n || !i ? null : lo(
    /* @__PURE__ */ a(Fu, { children: /* @__PURE__ */ a(
      "div",
      {
...
}, { Provider: ju, useCtx: Co } = Ao(), Gu = () => {
  const e = te(null), t = J((n) => n.opacity), r = Co((n) => n.onOpen), o = (n) => {
    oe.set({ opacity: n / 100 }), e.current && clearTimeout(e.current), e.current = setTimeout(() => he.trackEvent("opacity_change", { opacity: n }), 2e3);
  };
...
}, Wu = ({ isSelected: e, region: t, onSelect: r }) => /* @__PURE__ */ a(
  "button",
  {
    inert: e,
    type: "button",
  ...
  return /* @__PURE__ */ a("div", { className: "flex w-full items-center justify-between", children: [
    ...
    /* @__PURE__ */ a(Tt, { nested: !0, children: [
      /* @__PURE__ */ a(Vu, { className: C(vo({ variant: "ghost" }), "h-auto border p-1"), children: [
  ...
  const r = ee(), o = X((u) => u.region), n = J((u) => u.opacity), { theme: i, setTheme: s } = wt(), l = () => {
    const u = ho[0];
    s("light"), P.set({ region: u }), oe.set({ opacity: 1 });
  ...
  return /* @__PURE__ */ a(Q, { children: [
    ...
    /* @__PURE__ */ a(Ku, { open: t, onOpenChange: r })
  ] });
}, Xu = [2.5, 2, 1.5, 1, 0.5], Yu = () => {
  const e = ee(), t = X((n) => n.speed), r = (n, i) => {
    (n.key === "Enter" || n.key === " ") && (n.preventDefault(), o(i));
  }, o = (n) => {
    go(n), he.trackEvent("change_speed", { speed: n });
  };
  return /* @__PURE__ */ a("div", { className: "dropdown dropdown-center dropdown-top focus-within:**:data-[slot=tooltip-content]:hidden", children: [
    /* @__PURE__ */ a(Me, { offset: 8, content: "Velocidade", placement: "top", arrow: { position: "bottom" }, children: /* @__PURE__ */ a(ei, { "aria-label": "Alterar velocidade", variant: "ghost-gov", size: e ? "icon-sm" : "icon", children: /* @__PURE__ */ a("span", { inert: !0, className: "-mt-0.5 font-bold mobile:text-xs text-sm", children: [
      t,
      "x"
    ] }) }) }),
  ...
  return /* @__PURE__ */ a(
    Me,
    {
      ...
      children: /* @__PURE__ */ a(U, { onClick: () => {
        fo(), he.trackEvent("subtitles_toggled", { status: t ? "disabled" : "enabled" });
      }, variant: "ghost-gov", size: e ? "icon-sm" : "icon", children: /* @__PURE__ */ a(R, { name: t ? "subtitle" : "subtitle-off" }) })
    }
  );
}, $u = () => {
  const e = J((o) => o.isOpen), t = Ee((o) => o.open), { onPointerDown: r } = mr();
  return /* @__PURE__ */ a(
    "div",
    {
      className: C(
        ...
        /* @__PURE__ */ a(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ a("div", { id: "settings-option", className: "col-span-1!", children: /* @__PURE__ */ a(qu, {}) })
            ]
          }
        )
      ]
...
}, ep = ({ className: e, ...t }) => /* @__PURE__ */ a("div", { className: C("h-4", e), ...t }), tp = "@media screen and (max-width:640px){body[data-vlibras-expanded=true]{overflow:hidden!important}}", rp = () => {
  const e = ee(), { isOpen: t, isExpanded: r } = J(q("isOpen", "isExpanded"));
  S(() => {
    const { root: s } = De.get();
    !s || t || (delete s.dataset.expanded, delete document.body.dataset.vlibrasExpanded);
  }, [t]);
  const o = () => {
    ia(tp, "@expanded-mode.style");
    const { root: s } = De.get(), { isExpanded: l } = oe.get();
    s && (oe.set({ isExpanded: !l }), he.trackEvent("expanded"));
...
}, op = ({ open: e, onOpenChange: t }) => {
  const r = te(null), o = J((d) => d.isTranslating), [n, i] = O(""), { mutateAsync: s, isPending: l } = qe(), c = uo(i, 300);
  S(() => {
  ...
  const e = ee(), t = ve((i) => i.open), r = Ee((i) => i.onOpenChange), [o, n] = O(!1);
  return /* @__PURE__ */ a(Q, { children: [
    /* @__PURE__ */ a("div", { className: "dropdown dropdown-bottom z-1", children: [
      ...
      /* @__PURE__ */ a("ul", { className: "dropdown-content mt-4 space-y-2", children: [
        /* @__PURE__ */ a(Gt, { onClick: () => t("dictionary"), label: "Dicionário", icon: "dictionary" }),
        /* @__PURE__ */ a(Gt, { onClick: () => n(!0), label: "Tradutor", icon: "translator" }),
        /* @__PURE__ */ a(Gt, { onClick: () => r(!0), label: "Guia Rápido", icon: "help" }),
        /* @__PURE__ */ a(Gt, { onClick: () => t("about"), label: "Sobre o VLibras", icon: "info" })
      ] })
    ] }),
    /* @__PURE__ */ a(op, { open: o, onOpenChange: n })
  ] });
}, ap = () => {
  const { onPointerDown: e } = mr(), t = ee(), r = J((i) => i.setOpen), o = Ee((i) => i.open), n = () => {
    r(!1), Rt();
  };
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Q, { children: [
            /* @__PURE__ */ a(ep, { className: "w-full" }),
...
const cp = ({ suggestions: e, coords: t, onSelect: r }) => e.length === 0 ? null : /* @__PURE__ */ a(
  "div",
  {
...
), dp = ({ open: e, onOpenChange: t }) => {
  const r = te(null), o = ee(), { data: n } = Ha(), { mutateAsync: i, isPending: s } = Ka(), [l, c] = O([]), [u, p] = O({ top: 0, left: 0 }), [m, d] = O(""), g = !m.trim();
  S(() => d(P.get().gloss || ""), []);
  const h = z(() => n ? new Ja(n) : null, [n]), f = uo(() => {
    if (!r.current) return;
  ...
  return /* @__PURE__ */ a(Tt, { open: e, onOpenChange: t, children: /* @__PURE__ */ a(Ut, { children: [
    ...
    /* @__PURE__ */ a("div", { className: "flex h-full flex-col gap-2 px-4 py-4", children: [
      ...
      /* @__PURE__ */ a("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ a(cp, { onSelect: (A) => {
          if (!r.current) return;
          const v = r.current.selectionStart ?? 0;
          d(sp(m, v, A)), c([]), r.current.focus();
      ...
      /* @__PURE__ */ a("div", { className: "space-y-2 [&>button]:h-10 [&>button]:w-full [&>button]:rounded-full mobile:[&>button]:text-sm", children: [
        /* @__PURE__ */ a(U, { variant: "default", onClick: async () => {
          const { text: A } = oe.get(), { gloss: v } = P.get();
          if (!(!A || !v || !m))
            try {
              await i({
                text: A,
                ...
                rating: "bad"
              }), t(!1), ir("Agradecemos sua contribuição!", { variant: "primary", className: "font-semibold" }), xt("AGRADECER"), oe.set({ text: void 0 });
            } catch (y) {
              const I = y;
              I.message && ir(I.message, { variant: "destructive" });
            }
        }, disabled: s || g, children: s ? "Enviando..." : "Enviar sugestão" }),
        /* @__PURE__ */ a(U, { disabled: s || g, variant: "outline", onClick: () => xt(m), children: "Reproduzir" })
      ] })
    ] })
  ] }) });
}, up = ({ open: e, onOpenChange: t }) => {
  const [r, o] = O(!1), { mutateAsync: n, isPending: i } = Ka();
  return /* @__PURE__ */ a(Q, { children: [
        ...
        /* @__PURE__ */ a("div", { className: "flex items-center justify-center gap-4 [&>button]:flex-col [&>button]:text-muted-foreground", children: [
          /* @__PURE__ */ a(
            U,
            {
              ...
              onClick: async () => {
                const { gloss: c } = P.get(), { text: u } = oe.get();
                if (!(!c || !u))
                  try {
                    await n({
                      text: u,
                    ...
                    const m = p;
                    m.message && ir(m.message, { variant: "destructive" });
                  } finally {
                    t(!1);
                  }
              },
    ...
    /* @__PURE__ */ a(dp, { open: r, onOpenChange: o })
  ] });
}, pp = () => {
  const [e, t] = O(!1), r = ee(), o = J((i) => i.isExpanded);
  return Ee((i) => i.open) ? null : /* @__PURE__ */ a(Q, { children: [
    /* @__PURE__ */ a(
      U,
      {
        onClick: () => t(!0),
    ...
    /* @__PURE__ */ a(up, { open: e, onOpenChange: t })
  ] });
}, Ir = [
  ...
  const e = X((n) => n.avatar), t = Ee((n) => n.open), r = Ir.find(({ name: n }) => n === e) || Ir[0], o = (n) => {
    document.activeElement?.blur(), setTimeout(() => hr(n), 150), he.trackEvent("avatar_selected", { avatar: n });
  };
  return /* @__PURE__ */ a(
    "div",
    {
        ...
        /* @__PURE__ */ a("ul", { className: "dropdown-content mb-2 space-y-2", children: Ir.filter(({ name: n }) => n !== e).map((n) => /* @__PURE__ */ a("li", { className: "flex animate-move-up items-center justify-end gap-2", children: [
          ...
          /* @__PURE__ */ a(
            U,
            {
              ...
              size: "icon",
              children: /* @__PURE__ */ a("img", { src: hp(n.path), alt: n.name })
            }
          )
        ] }, n.name)) })
      ]
  ...
  const e = ee(), t = Ee((v) => v.open), { status: r, gloss: o, isPlayingWelcome: n } = X(q("status", "gloss", "isPlayingWelcome")), { isExpanded: i, isTranslating: s, text: l } = J(q("isExpanded", "text", "isTranslating")), { action: c, content: u } = kt(q("action", "content")), p = r === "playing", m = r === "paused", d = r === "idle";
  S(() => {
    if (!d) return;
  ...
  const g = () => {
    ...
    oe.set({ text: void 0 }), pr();
  }, f = c && u && r === "idle", b = !!(r === "idle" && o && l), w = n ? !0 : (p || m) && !t, A = r === "idle" || t;
  ...
  onLoaded: () => {
    ...
    yt({ baseUrl: xe.DICTIONARY_URL, personalizationUrl: e }), hr(t || r), go(o), setTimeout(ka, 1e3);
  },
  onPlay: () => {
    const { screen: e, open: t } = _t.get();
    e !== "main" && t("main"), oe.set({ isPausedByUser: !1 });
  },
  onPlayStatic: () => {
    const { screen: e, open: t } = _t.get();
    e !== "main" && t("main"), oe.set({ isPausedByUser: !1 });
  ...
  const e = ve((n) => n.screen), { isOpen: t, position: r, isExpanded: o } = J(q("isOpen", "position", "isExpanded"));
  return /* @__PURE__ */ a(Xc, { children: ({ ref: n, hasMoved: i, pos: s, isDragging: l, reset: c }) => (S(() => {
    !t && c();
  }, [t]), /* @__PURE__ */ a(
    "div",
    {
  ...
  return S(() => {
    ...
    if (r && e.current) {
      l(xp({ event: r, tooltip: e.current }));
      const c = e.current;
  ...
  const e = te(null), t = J((r) => r.isOpen);
  return S(() => {
    const r = Je("#vlibras-access-wrapper")?.shadowRoot, o = r ? Je("#vlibras-access", r) : null;
    o && (e.current = o);
  }, []), S(() => {
...
}, Gp = ({ callback: e, isWordByWord: t, hoverClss: r, activeClass: o }) => {
  const n = (p) => {
    const m = p.target;
    (!(Tr(m) && t) || !Ce(m, "IMG")) && m.classList.add(r);
  }, i = (p) => {
    !t || !r || io(() => {
      const m = p.target;
      if (!Tr(m)) return;
      Vp(r);
      const { word: d, node: g, offset: h } = Fp(p.clientX, p.clientY) || {};
    ...
    if (Xt.set({ isActive: !1 }), jp(o), g || m.classList.add(o), !Tr(m)) return;
    if (g && !t) return e?.({ text: g, element: m });
    if (p.preventDefault(), p.stopPropagation(), t && r) {
      const f = Je(`.${r}`), b = f?.textContent?.trim();
      b && f && e?.({ text: b, element: f });
    } else {
      const f = !!m.dataset.vlibrasGloss?.trim(), b = Up(m)?.trim();
      b && e?.({ text: b, element: m, isGloss: f });
    }
    const h = m.tagName === "A" ? m : ti(m);
    h && c(h, p), Ce(m, "LABEL") ? zp(m) : (Ce(m, "BUTTON") || Eo(m)) && c(m, p);
  }, l = (p) => {
  ...
  const e = X((o) => o.isLoaded), t = J((o) => o.isOpen), { mutateAsync: r } = qe();
  S(() => {
    e && (t ? ia(Tp, "@text-capture.style") : $i("@text-capture.style"));
  }, [t, e]), S(() => {
    if (!e) return;
    const o = Gp({
...
}, Hp = () => (Wp(), Sp(), Jp(), Ip(), Cp(), Pp(), Ep(), null), Kp = ({ children: e, root: t }) => {
  const [r, o] = O(!1);
  return S(() => {
    t && Cu(t, () => o(!0));
  }, [t]), r ? /* @__PURE__ */ a(_p, { root: t, children: /* @__PURE__ */ a(Cd, { client: wp, children: [
    /* @__PURE__ */ a(kp, {}),
    /* @__PURE__ */ a(Hp, {}),
    e
  ] }) }) : null;
}, { root: Nr, shadowRoot: vt, isRootActive: Nn } = Zi();
function qp() {
  ...
  return S(() => De.set({ root: Nr, shadowRoot: vt }), [Nr, vt]), S(() => {
    ...
    if (!o || ((async () => (await es(o, vt), r(!0)))(), !t)) return;
    e(Nn());
  ...
  }, [o, e, t, r]), t ? /* @__PURE__ */ a(Kp, { root: vt, children: /* @__PURE__ */ a(Ap, {}) }) : null;
}
it(/* @__PURE__ */ a(qp, {}), vt);
