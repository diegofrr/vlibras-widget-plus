var N, Nn, Ve, Ro, Yt, On, Un, eo, Or, Ur, Bn, Zt = {}, Qn = [], ei = /(mi|mn|mo|ms$|mte|msp)/, Et = Array.isArray, sr = Qn.slice, Ie = Object.assign;
function to(e) {
...
function Br(e) {
  (8 & e.__g || !(e.__g |= 8) || !Ve.push(e) || Yt++) && Ro == N.debounceRendering || ((Ro = N.debounceRendering) || queueMicrotask)(ri);
}
function ri() {
  for (var e, t, r, o, n, i, s, l, c = 1; Ve.length; ) Ve.length > c && Ve.sort(On), e = Ve.shift(), c = Ve.length, 8 & e.__g && (r = void 0, o = void 0, n = (o = (t = e).__v).__e, i = [], s = [], (l = t.__P) && ((r = Ie({}, o)).__v = o.__v + 1, N.vnode && N.vnode(r), ro(l, r, o, t.__n, l.namespaceURI, 32 & o.__u ? [n] : null, i, n ?? at(o), !!(32 & o.__u), s, l.ownerDocument), r.__v = o.__v, r.__.__k[r.__i] = r, Mn(i, r, s), o.__ = o.__e = null, r.__e != n && Ln(r)));
  Yt = 0;
}
function Dn(e, t, r, o, n, i, s, l, c, u, p, m) {
  var d, g, h, f, b, w, A, v = o && o.__k || Qn, y = t.length;
  for (c = oi(r, t, v, c, y), d = 0; d < y; d++) (h = r.__k[d]) != null && (g = h.__i != -1 && v[h.__i] || Zt, h.__i = d, w = ro(e, h, g, n, i, s, l, c, u, p, m), f = h.__e, h.ref && g.ref != h.ref && (g.ref && oo(g.ref, null, h), p.push(h.ref, h.__c || f, h)), b == null && f != null && (b = f), (A = 4 & h.__u) || g.__k === h.__k ? c = zn(h, c, e, A) : typeof h.type == "function" && w !== void 0 ? c = w : f && (c = f.nextSibling), h.__u &= -7);
  return r.__e = b, c;
}
function oi(e, t, r, o, n) {
  var i, s, l, c, u, p = r.length, m = p, d = 0;
  for (e.__k = new Array(n), i = 0; i < n; i++) (s = t[i]) != null && typeof s != "boolean" && typeof s != "function" ? (typeof s == "string" || typeof s == "number" || typeof s == "bigint" || s.constructor == String ? s = e.__k[i] = At(null, s, null, null, null) : Et(s) ? s = e.__k[i] = At(Q, { children: s }, null, null, null) : s.constructor === void 0 && s.__b > 0 ? s = e.__k[i] = At(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v) : e.__k[i] = s, c = i + d, s.__ = e, s.__b = e.__b + 1, l = null, (u = s.__i = ni(s, r, c, m)) != -1 && (m--, (l = r[u]) && (l.__u |= 2)), l == null || l.__v == null ? (u == -1 && (n > p ? d-- : n < p && d++), typeof s.type != "function" && (s.__u |= 4)) : u != c && (u == c - 1 ? d-- : u == c + 1 ? d++ : (u > c ? d-- : d++, s.__u |= 4))) : e.__k[i] = null;
...
function ro(e, t, r, o, n, i, s, l, c, u, p) {
  ...
  e: if (typeof ne == "function") try {
    ...
    while (8 & d.__g && ++D < 25);
    d.state = d.__s, d.getChildContext != null && (o = Ie({}, o, d.getChildContext())), w && r.__c && d.getSnapshotBeforeUpdate != null && (f = d.getSnapshotBeforeUpdate(g, h)), x = m != null && m.type === Q && m.key == null ? Fn(m.props.children) : m, l = Dn(e, Et(x) ? x : [x], t, r, o, n, i, s, l, c, u, p), t.__u &= -161, d.__h.length && s.push(d), 2 & d.__g && (d.__g &= -4);
  } catch (le) {
  ...
  else l = t.__e = ai(r.__e, t, r, o, n, i, s, c, u, p);
...
function ai(e, t, r, o, n, i, s, l, c, u) {
  ...
  if (y == null) A === v || l && e.data == v || (e.data = v);
    ...
    else if (d && (e.innerHTML = ""), (y == "foreignObject" || n == "http://www.w3.org/1998/Math/MathML" && ei.test(y)) && (n = "http://www.w3.org/1999/xhtml"), Dn(y == "template" ? e.content : e, Et(g) ? g : [g], t, r, o, n, i, s, i ? i[0] : r.__k && at(r, 0), l, c, u), i != null) for (p = i.length; p--; ) to(i[p]);
...
function it(e, t) {
  var r, o, n, i;
  t == document && (t = document.documentElement), N.__ && N.__(e, t), o = (r = e && 32 & e.__u) ? null : t.__k, t.__k = Ne(Q, null, [e]), n = [], i = [], ro(t, t.__k, o || Zt, Zt, t.namespaceURI, o ? null : t.firstChild ? sr.call(t.childNodes) : null, n, o ? o.__e : t.firstChild, r, i, t.ownerDocument), Mn(n, t.__k, i);
}
function si(e, t) {
  e.__u |= 32, it(e, t);
}
...
function a(e, t, r, o, n, i) {
  ...
  var u = { type: e, props: c, key: r, ref: s, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --ci, __i: -1, __u: 0, __source: n, __self: i };
  return N.vnode && N.vnode(u), u;
}
var Le, F, Ar, To, Lr = Object.is, st = 0, jn = [], G = N, No = G.__b, Oo = G.__r, Uo = G.diffed, Bo = G.__c, Qo = G.unmount, Lo = G.__;
function lt(e, t) {
  G.__h && G.__h(F, e, st || t), st = 0;
...
function no(e, t, r) {
  var o = lt(Le++, 2);
  if (o.t = e, !o.__c && (o.__ = [r ? r(t) : Hn(void 0, t), function(l) {
...
function S(e, t) {
  var r = lt(Le++, 3);
  !G.__s && ao(r.__H, t) && (r.__ = e, r.u = t, F.__H.__h.push(r));
}
function Ke(e, t) {
  var r = lt(Le++, 4);
  !G.__s && ao(r.__H, t) && (r.__ = e, r.u = t, F.__h.push(r));
}
function te(e) {
...
function di() {
  for (var e; e = jn.shift(); ) if (e.__P && e.__H) try {
    e.__H.__h.some(Gt), e.__H.__h.some(Dr), e.__H.__h = [];
  } catch (t) {
...
G.__b = function(e) {
  ...
  })) : (t.__h.some(Gt), t.__h.some(Dr), t.__h = [], Le = 0)), Ar = F;
}, G.diffed = function(e) {
  Uo && Uo(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (jn.push(t) !== 1 && To === G.requestAnimationFrame || ((To = G.requestAnimationFrame) || ui)(di)), t.__H.__.some(function(r) {
...
var pi = /^(-|f[lo].*[^se]$|g.{5,}[^ps]$|z|o[pr]|(W.{5})?[lL]i.*(t|mp)$|an|(bo|s).{4}Im|sca|m.{6}[ds]|ta|c.*[st]$|wido|ini)/;
function Mr(e, t) {
...
var mi = /* @__PURE__ */ Symbol.for("react.forward_ref");
function gi(e) {
  function t(r) {
    var o = so({}, r);
    return delete o.ref, e(o, r.ref || null);
  }
  return t.$$typeof = mi, t.render = e, t.prototype.isReactComponent = !0, t.displayName = "ForwardRef(" + (e.displayName || e.name) + ")", t;
}
var Mo = function(e, t, r) {
  return e == null ? null : Be(Be(e).map(t.bind(r)));
}, fi = { map: Mo, forEach: Mo, count: function(e) {
...
function wi(e) {
  ...
  it(Ne(Ai, { context: t.context }, e.__v), t.l);
}
function lo(e, t) {
  var r = Ne(wi, { __v: e, i: t });
...
var ta = /* @__PURE__ */ Symbol.for("react.element"), yi = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, xi = /[A-Z0-9]/g, ki = typeof document < "u", _i = function(e) {
...
function Ci(e, t, r) {
  return si(e, t), typeof r == "function" && r(), e ? e.__c : null;
}
...
N.event = function(e) {
  return Vo && (e = Vo(e)), e.persist = Ei, e.isPropagationStopped = Ri, e.isDefaultPrevented = Pi, e.nativeEvent = e;
};
var co, Ii = { enumerable: !1, configurable: !0, get: function() {
  return this.class;
} }, jo = N.vnode;
N.vnode = function(e) {
  if (typeof e.type == "string") (function(o) {
    ...
    for (var c in n) {
      var u = n[c];
      if (!(c === "value" && "defaultValue" in n && u == null || ki && c === "children" && i === "noscript" || c === "class" || c === "className")) {
        if (c === "style" && typeof u == "object") for (var p in u) typeof u[p] != "number" || pi.test(p) || (u[p] += "px");
        else if (c === "defaultValue" && "value" in n && n.value == null) c = "value";
        else if (c === "download" && u === !0) u = "";
        else if (c === "translate" && u === "no") u = !1;
        else if (c[0] === "o" && c[1] === "n") {
          var m = c.toLowerCase();
          m === "ondoubleclick" ? c = "ondblclick" : m !== "onchange" || i !== "input" && i !== "textarea" || _i(n.type) ? m === "onfocus" ? c = "onfocusin" : m === "onblur" && (c = "onfocusout") : m = c = "oninput", m === "oninput" && s[c = m] && (c = "oninputCapture");
        } else l && yi.test(c) ? c = c.replace(xi, "-$&").toLowerCase() : u === null && (u = void 0);
        s[c] = u;
      }
    }
    ...
    })), n.class && !n.className ? (s.class = n.class, Object.defineProperty(s, "className", Ii)) : n.className && (s.class = s.className = n.className), o.props = s;
  })(e);
...
}, useCallback: _e, useContext: xe, useDebugValue: Gn, useDeferredValue: Xn, useEffect: S, useId: Jn, useImperativeHandle: Wn, useInsertionEffect: Zn, useLayoutEffect: Ke, useMemo: M, useReducer: no, useRef: te, useState: O, useSyncExternalStore: qn, useTransition: Yn } } };
function Ni(e) {
...
function Bi(e) {
  return lr(e) ? li.apply(null, arguments) : e;
}
function Qi(e) {
...
var Mi = Q, Fi = lr, bt = { useState: O, useId: Jn, useReducer: no, useEffect: S, useLayoutEffect: Ke, useInsertionEffect: Zn, useTransition: Yn, useDeferredValue: Xn, useSyncExternalStore: qn, startTransition: io, useRef: te, useImperativeHandle: Wn, useMemo: M, useCallback: _e, useContext: xe, useDebugValue: Gn, version: "18.3.1", Children: fi, render: Si, hydrate: Ci, unmountComponentAtNode: Qi, createPortal: lo, createElement: Ne, createContext: He, createFactory: Ni, cloneElement: Bi, createRef: ti, Fragment: Q, isValidElement: lr, isElement: Fi, isFragment: Oi, isMemo: Ui, findDOMNode: Li, Component: Te, PureComponent: Mr, memo: hi, forwardRef: gi, flushSync: Di, unstable_batchedUpdates: zi, StrictMode: Mi, Suspense: Jt, lazy: vi, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ti };
const Vi = (e) => e;
function ra(e, t = Vi) {
...
}, ge = ((e) => e ? Jo(e) : Jo), Ht = ge()(() => ({ path: "", version: "" })), oa = () => (S(() => {
  const e = Ht.getState();
...
function Ji(e, t) {
  return Object.is(e, t) ? !0 : typeof e != "object" || e === null || typeof t != "object" || t === null || Object.getPrototypeOf(e) !== Object.getPrototypeOf(t) ? !1 : Ho(e) && Ho(t) ? Ko(e) && Ko(t) ? qo(e, t) : Gi(e, t) : qo(
...
const Ki = (e) => e.replace(new RegExp("(?<!:)\\/+", "g"), "/"), na = () => Math.random().toString(36).slice(2, 8), q = (...e) => {
  const t = M(() => (r) => cr(r, ...e), [JSON.stringify(e)]);
  return Hi(t);
}, xr = "@vlibras-theme", qi = (e) => ["light", "dark"].includes(e), wt = ge((e) => ({
  theme: (() => {
...
const es = (e, t) => {
...
}, ns = (e) => e.slice(1, -1).indexOf(":") === -1 ? void 0 : (() => {
  const t = e.slice(1, -1), r = t.indexOf(":"), o = t.slice(0, r);
  return o ? rs + o : void 0;
})(), as = (e) => {
  const {
    theme: t,
    classGroups: r
  ...
  t.validators === null && (t.validators = []), t.validators.push(ts(r, e));
}, ds = (e, t, r, o) => {
  ...
  return r;
}, us = (e) => "isThemeGetter" in e && e.isThemeGetter === !0, ps = (e) => {
  if (e < 1)
    return {
      get: () => {
      },
  ...
  if (t) {
    const n = t + Yo, i = o;
    o = (s) => s.startsWith(n) ? i(s.slice(n.length)) : Zo(hs, !1, s, void 0, !0);
  }
  if (r) {
    const n = o;
    o = (i) => r({
  ...
  const s = (c) => {
    ...
    return r = fs(u), o = r.cache.get, n = r.cache.set, i = l, l(c);
  }, l = (c) => {
    const u = o(c);
    if (u)
      return u;
...
}, pa = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, ha = /^\((?:(\w[\w-]*):)?(.+)\)$/i, xs = /^\d+\/\d+$/, ks = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, _s = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Ss = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, Cs = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Es = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, et = (e) => xs.test(e), T = (e) => !!e && !Number.isNaN(Number(e)), Ue = (e) => !!e && Number.isInteger(Number(e)), _r = (e) => e.endsWith("%") && T(e.slice(0, -1)), Pe = (e) => ks.test(e), Rs = () => !0, Ps = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  _s.test(e) && !Ss.test(e)
), ma = () => !1, Is = (e) => Cs.test(e), Ts = (e) => Es.test(e), Ns = (e) => !k(e) && !_(e), Os = (e) => ct(e, ba, ma), k = (e) => pa.test(e), Fe = (e) => ct(e, va, Ps), Sr = (e) => ct(e, Ds, T), $o = (e) => ct(e, ga, ma), Us = (e) => ct(e, fa, Ts), zt = (e) => ct(e, Aa, Is), _ = (e) => ha.test(e), gt = (e) => dt(e, va), Bs = (e) => dt(e, zs), en = (e) => dt(e, ga), Qs = (e) => dt(e, ba), Ls = (e) => dt(e, fa), Mt = (e) => dt(e, Aa, !0), ct = (e, t, r) => {
  const o = pa.exec(e);
  return o ? o[1] ? t(o[1]) : r(o[2]) : !1;
}, dt = (e, t, r = !1) => {
  const o = ha.exec(e);
  return o ? o[1] ? t(o[1]) : r : !1;
}, ga = (e) => e === "position" || e === "percentage", fa = (e) => e === "image" || e === "url", ba = (e) => e === "length" || e === "size" || e === "bg-size", va = (e) => e === "length", Ds = (e) => e === "number", zs = (e) => e === "family-name", Aa = (e) => e === "shadow", Ms = () => {
  const e = Z("color"), t = Z("font"), r = Z("text"), o = Z("font-weight"), n = Z("tracking"), i = Z("leading"), s = Z("breakpoint"), l = Z("container"), c = Z("spacing"), u = Z("radius"), p = Z("shadow"), m = Z("inset-shadow"), d = Z("text-shadow"), g = Z("drop-shadow"), h = Z("blur"), f = Z("perspective"), b = Z("aspect"), w = Z("ease"), A = Z("animate"), v = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], y = () => [
    ...
    span: ["full", Ue, _, k]
  }, Ue, _, k], H = () => [Ue, "auto", _, k], he = () => ["auto", "min", "max", "fr", _, k], ne = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], le = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], Ae = () => ["auto", ...x()], Re = () => [et, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...x()], E = () => [e, _, k], Bt = () => [...y(), en, $o, {
    position: [_, k]
  }], Qt = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], Lt = () => ["auto", "cover", "contain", Qs, Os, {
    size: [_, k]
  }], Xe = () => [_r, gt, Fe], Y = () => [
    ...
    _,
    k
  ], Me = () => ["none", T, _, k], $e = () => ["none", T, _, k], ht = () => [T, _, k], B = () => [et, "full", ...x()];
  return {
    cacheSize: 500,
    theme: {
...
const Vs = () => /* @__PURE__ */ a("div", { className: "absolute bottom-15 left-1/2 grid -translate-x-1/2 animate-move-up place-content-center rounded-full border bg-background p-0.5 pr-2", children: /* @__PURE__ */ a("span", { className: "flex items-center gap-1 font-semibold text-xs", children: [
...
const jr = (e) => (t) => {
...
}, bl = "data:image/webp;base64,UklGRn4AAABXRUJQVlA4THIAAAAvP8APEA+wTyvxWv9dj2Ewim27yacvkRApSANpSEFClvQ0buj7iP4rchs1CrQndniF/EH67MgAdHVkxLeCPTlijpG6FkkbJFVIWiNp9XRSY4ypRHRAXYcmIVCkfvbD/tgv++c84vN5tvDIPrgf7usPRyE=", vl = "data:image/webp;base64,UklGRnoAAABXRUJQVlA4TG0AAAAvP8APEA+wUDPxWv9Vj2GwiWS7zXcuPwRBETQLmqAYgkrn+JNTH9F/RW7bNsx1t7+AP0RoGGQc45mWJW7MmlFzQfUNlZDqHBWfXTxu27YhQLo4O57CD+b7a/ds/F5+v/Ye6emhwav/gcJ//SAAAA==", Al = "data:image/webp;base64,", wl = "data:image/webp;base64,UklGRqIAAABXRUJQVlA4TJYAAAAvP8APEA8QEfMfwnFt205yzEMaAG3Dka8tM8wsSzqwBUr4Q8NfXMP75gIi+j8B/OExzB8MYqJNdTylek71xMipn8icJnWYOCG1M+eoVOnEJ/QK0VmzdqZMHf8djTInyJzje3LLw8PMrNYEyr1xzEAy4shre9BqgjoQlVUCjhrVJRDUazSBRp0gg1ocH6rSwwjOmKAJ/xc=", yl = "data:image/webp;base64,", xl = "data:image/webp;base64,", kl = "data:image/webp;base64,UklGRqwAAABXRUJQVlA4TJ8AAAAvP8APEA8QEfMfwlEkSY7TF3LPg7BQBtrJEFshEAUx8F4TW481cgQi+j8B+sc4KqWhEGGU7aHPHCxLMEiaA3RSxJyRtCXcmUn7rG+5Z0FyzDHJT7AxKa1hNUgpwmiQyGhawwrNucGObk7xC7E0ajAvhXvWzT+luTlgmgNIEmCVUOmz9Ja3hOxe2bdYtq3EyryiVPHKvhIJBaW+FEelHwcA", _l = "data:image/webp;base64,UklGRqIAAABXRUJQVlA4TJYAAAAvP8APEA8QEfMfwm1t7W3ymfSXbIBH0Vp0qPNaGsXZrUuCDh9Bn4gDRPRfkdu2jXIancov8IvwRUpYptT2X+yf7IBY1OYdEJe1hSfb2uYnrrbogCNrYwnU7CoaEDhNXAIgSQCIpHsyk2XyLdISbWQq7nqAooku0YMy79f/ZP6Hmk1F0/+LD/WT8aX+1Oe/zenV/D1+EQA=", Sl = "data:image/webp;base64,", Cl = "data:image/webp;base64,UklGRqgAAABXRUJQVlA4TJsAAAAvP8APEA8QEfMfAm5t7W2bp4gSrTLWkOSAtdxBo3ETYwSUzF/xw9kDRPR/AkCSgGwcFOOhNQFGE2E26TOqfio9P88/U/2O2SQYTfxMawJk46ExK2B8HyJA60uouFxbPGpQeYOLucLJ7GBnfrzxUFaQA7QO2gRz+MwoUPwLbYI5fCYHaB00HsqKh+SytGgkX6RVlkIruSLFUfL/FwA=", El = "data:image/webp;base64,", Rl = "data:image/webp;base64,", Pl = "data:image/webp;base64,UklGRnQAAABXRUJQVlA4TGcAAAAvP8APEA8QEfMfwk0kSY5Ur82DcFAW2h7UhTDm6zLmTz+AiP5PADt8qycYVHtoqUCM3Ge9dwT3VCFSgZbqlEiq26gQIy2VkQqRhPsP9X/0Izd4H6AlVjuMqHZwT2VKjLSRYYS32rF9AA==", Il = "data:image/webp;base64,", Tl = "data:image/webp;base64,", Nl = "data:image/webp;base64,", Ol = "data:image/webp;base64,", Ul = "data:image/webp;base64,", Bl = "data:image/webp;base64,", Ql = "data:image/webp;base64,", Ll = "data:image/webp;base64,", Dl = "data:image/webp;base64,", zl = "data:image/webp;base64,", Ml = "data:image/webp;base64,", Fl = "data:image/webp;base64,", Vl = "data:image/webp;base64,UklGRqwAAABXRUJQVlA4TJ8AAAAvP8APEA8QEfMfwm1tu23zFVliBIyC0STZi6VFOAJKBRyhIEynBSL6PwH4x7mJlKKV63IyyQlQMlECVjZZucbExKRm5ZVXLpQKpZyUCqC4dcCtw1dzilYuNJlkAiydUxbgTO55AvzqfveKOWpqnu5Pb25R942r+927OWpqknv2BhFw0jnpBBiZqADGJutfrAUDSiZKAGCC8NXK0a2LfhwA", jl = "data:image/webp;base64,UklGRpQAAABXRUJQVlA4TIcAAAAvP8APEA8QEfMfwlFs223znLqLGFhM8ill2fMFzVAEQcuUP2r+rggi+j8BAPwRajDax2pCUyIvJTTlY7VgNNf0fAO4IxB6BpCGxBEQPcmRgfOHxD6BVkjoCpyEI12AVlKi6xyLd0ndroKjRjKFo9ZfABoW7FJKaTvG9Zo1oIdVxJR4HZISjQEA", Wl = "data:image/webp;base64,UklGRpgAAABXRUJQVlA4TIwAAAAvP8APEA8QEfMfwlFsW3H0My+RgBRaSjtJpEVKJLDsgeIueGQ0ENH/CbBHviufTqVJZaeo+auyO5ImFRt1ODUqT4vAxc7MFvxnMrMVn1TIxQbsi0BXaczsA7OpUCTwKrki8+nEHBv1MhHsiD+SarP6oCKN2JjEghNGUHkuVqDYgOZQV2l2rYCVEMTdAQ==", Gl = "data:image/webp;base64,", Jl = "data:image/webp;base64,UklGRnoAAABXRUJQVlA4TG4AAAAvP8APEA8QEfMfwnEkSY4yJ4DnmjCOIBw7ZdqasufBPhET0YgRKAMi+j8B9HczgFPFrgDgM1J9EQefYx0RDYtB2t4YDFkMfMuwaHuKDIsm+JmVzwCSZIUlcw0VZeWsgMl6/Y4CsCcpZ+1UsaO/Cw==", Hl = "data:image/webp;base64,", Kl = "data:image/webp;base64,", ql = "data:image/webp;base64,UklGRoAAAABXRUJQVlA4THMAAAAvP8APEA+wUDNx2v+tj2G4iW0rkk7vIQ4GKdiaDKQhBQmEs1CNg44j+p+e+w0vBiTGQkmMjZoYFy3xCfRIj3wCLTEuaubeKJO5YC5lwr3VDONqCT6hR+jxE6ClcUHN9wZlzgXMCdwZGAn4RKAHoF1AWTwAAA==", Xl = "data:image/webp;base64,UklGRnQAAABXRUJQVlA4TGgAAAAvP8APEA8wUTMxtFsfh2AU23aTl4SyRAJSkEakIQUJWdL7pQuI6L8it20b5dRpO/mFflkBNObIACYwH/GzDlTlkbqAaA7RDKIpRN3nopfpRbjgFX5E/8zDfFd5/UmAHxm/nFcDgn5YAg==", Yl = "data:image/webp;base64,UklGRoAAAABXRUJQVlA4THMAAAAvP8APEA8wUTNx2v+tj2G4iW0rkk7vIQ4GKdiaDKQhBQmEs1CNg44j+p8eQFmAdgE9AJ8IjATcGZgTlDkXqPneoKVxQY+fAJ/QI4yrJbi3mmEuZaJM5kLN3BstMS565BP4BHpkXLTE2KiJsVASAxJveHluAA==", Zl = "data:image/webp;base64,UklGRpwAAABXRUJQVlA4TJAAAAAvP8APEA+wUCuxs2QDFIX/7zXGh8NVtW1tAyfzjigIRjJsdbdOagUpSOCyG5L8b5eCiP5PgPrzBlbwgJeWYrZoTlLnYrXY+ZgtHiFq4RqVEI8wggUDFWSgP8qgAgMWRrAf/PgSxw8ecIEAHhycPnLgIcAFHvCCeBZO0QguVsPCx6xbuKhrSYmno6RGaKGGvwU=", $l = "data:image/webp;base64,UklGRpoAAABXRUJQVlA4TI4AAAAvP8APEA8wUSMxtGTSNm3n3/Cu+HA4qm3baQ59iASkII0v7TuIBSRkSL+D+yBFQUT/J4B/zlUkBbPU2SINdkmTSRKQrIDZOnhbD4sNTw4b4bLpicIHKSruclT9zxx1n+Wo+l2Kis+IeHDZ9OSwERYb4LD+poPLqpsC5EQjJOvtJVWQVR0jRjgPUe6ixL8D", ec = "data:image/webp;base64,", tc = "data:image/webp;base64,", rc = "data:image/webp;base64,UklGRrYAAABXRUJQVlA4TKoAAAAvP8APEA8QEfMfAlJsW3GgR2VaIgEpSAsO2hJSkJDeZaByF48eFUT0fwL0n9s2gkGFyU5I1iEbgKRiQao2Sc026bAonZakbvk7r+0Sw18oo/BVJffcmSrpTKfFMx3fS2c6mRq5587WGP6DOpr+4gM+mQoRDkIhvvtBEOlMJxK5Tt126UV6CYVd6sSDbGCnJemwKDXbpGqTVCxIMknqkO2EZBUmE2jYttE/BQ==", oc = "data:image/webp;base64,", nc = "data:image/webp;base64,", ac = "data:image/webp;base64,", ic = "data:image/webp;base64,", sc = "data:image/webp;base64,UklGRrIAAABXRUJQVlA4TKUAAAAvP8APEA8QEfMfwlFsW3H0qB5YIgEpSAvSkIKELHugchfv96ggov8ToH+eOYJgwMluUG1BMwBJ3ZI07CRNy9JuRbpZlZa1dw7bJMIv9Ci9GrTVFqdBvdWblVvd36u3euM0aast8iT8gwHbAacBZY/yjE7jrR6lDqlDUiTBabx32CYt8qRZ2e3GdlClHaBI07I07CR1S5JMkhY0u0G1AScTKJw5+lMA", lc = "data:image/webp;base64,", cc = "data:image/webp;base64,UklGRpAAAABXRUJQVlA4TIQAAAAvP8APEA8wUSuxsxegj0M4qm2rrWClDZGAFKSBk1h5UpDAMJ12b35RENH/CVD//WTdhZwHsnxHsYdcZPvoIg/JKBAhkaS8gy0ncPk4ACfIKrgZlBYUByQa/ToMSBYUDUoWba6T4ULLA6LJFqzZgJwXMhBNFPLEEfuRI55kpr8jJGSv/hs=", dc = "data:image/webp;base64,UklGRq4AAABXRUJQVlA4TKEAAAAvP8APEA8wUSuxs2TSNm3n3+7u+HC4iW07bq7GSX4pCIYiSmFgQROUD+GX2V/xlZ1ARP8ngF8ey0yaDGlJIdV0k1qSJKCnAiMt4FJxg9CGVzip4SvctOIt1ckjbckmSpoMiS6ZS+XZkCxeWb7nM3NV8CfxypgtXzq9ULpkoQ/AGxs8Xmtwe3JK65MKkQw8LTBSgZ4AHhYt3SxqCosldTvyjwA=", uc = "data:image/webp;base64,", pc = "data:image/webp;base64,UklGRqAAAABXRUJQVlA4TJMAAAAvP8APEA8wUSsxtGTSNm3n3/Cu+HA4im0rcm7mJRKQ0tIaaTgJElj2/BafD5UoiOj/BEC60Sw4ZW7UQ5+GFM0lTeaQ5N2AS9IDkiR9IJvoTFDM3FONepa+rxP/LvyiDpWhbCKkvgnwLudwFkkRqJICULo+QHaSg6SHubxw3IxCpvHBJicPFYWh2KgdkzMPLJJ3+wUA", hc = "data:image/webp;base64,", mc = "data:image/webp;base64,", gc = "data:image/webp;base64,UklGRqQAAABXRUJQVlA4TJgAAAAvP8APEA+wUCsxs2TSNm3nX/C++HA4qm2rdW76EAlIQRpIQ0qKgd5ZnAHllxiI6P8ESApG1bOvJVwlQxGAhaQI7KR4Aox0BrDSu5EKJ+U+38Pf5D7bkwa9G+fCSbGhM+Al7QG6IuAbTlIArCRlcEUCW5wb+0YEM84edkXgtqqpem75Ie/REq1FJbMaALuGKUKPHeSK2OPHAA==", fc = "data:image/webp;base64,", bc = "data:image/webp;base64,UklGRrAAAABXRUJQVlA4TKQAAAAvP8APEA8wUSsxtGQDFIX/zzXHh8NRbdtNdbNoQyQgJdKItCcFCQxbFmdw86uCiP5PgP45uhZrI6CzHWarkA1AUrEkhXXSZpO02ywdtkjV8juPrZarwXLAG6WVXgXk2vLuJ90B3QbpgOmt7sVkAfmA7nellQpMW6sLSIJUQG88dMFqYNXyO4ct0m6ztNkkhXVSsSTJJKlCth1mC+hMz6pmdK0/BQ==", vc = "data:image/webp;base64,", Ac = "data:image/webp;base64,", wc = "data:image/webp;base64,UklGRoAAAABXRUJQVlA4THQAAAAvP8APEA+wUCuxsy+wj0O4rm2ria75kxIshdLAziiFEvhUJ9wJ7y5jARH9nwDcorOit1LYkrmlqGDNm55+y3vcQuUAREaSROL0V4kmbxlEs1slICrR7DaIZrfKCjibF6NwyKzUWzxFIQckVtlCJBvAAyXgxA==", yc = "data:image/webp;base64,UklGRowAAABXRUJQVlA4TH8AAAAvP8APEA+wUCsxtATZNtvu73qE+HC4jWw3bj5HB0KUgFJUmlAaSmEJCCVfP/jjVHFE/ycAz7XozQVoxkUHLgngJ6d4CwGAyEM+I0OuUS69lMlcypIcUuQyl2lT7F9ZyVKWJASAuPSSIdfIQz4DFAI/evOUuOSSAFocKHpzwXMFAA==", xc = "data:image/webp;base64,UklGRlwAAABXRUJQVlA4TE8AAAAvP8APEA8wUCsxtATZNtvuT3uB+HAwjiSpzWRCKIRG2t57kP4R/SeatmndXHcG/1GnlJKA2FCQOtdMZnxD8jnHnnv9k78+59i1378xf1YAAA==", kc = "data:image/webp;base64,UklGRlgAAABXRUJQVlA4TEwAAAAvP8APEA8wUSsxtGQDFIX/7zXGh4NRbLtO7m+wjIRIwRrSIiVO6L0uI/ovICgywQtuUFfTJWg7sU7AOvW5xjsF/31shXony78rvy8P", _c = "data:image/webp;base64,UklGRnwAAABXRUJQVlA4TG8AAAAvP8APEA+wUDNx2v8L7McwXMW2GzfSePtUGJhCGQiaiHfvu90QRPR/Aux/T3CGa1O3gIQbNViwoeDmsGBDwc2hQUDCjRoEJBTcHNpH66P2kasylRDQwFRCQANTBRsWuCpTGxY0MJUQ6trU2fQBfwsA", Sc = "data:image/webp;base64,", Cc = "data:image/webp;base64,", Ec = "data:image/webp;base64,UklGRqoAAABXRUJQVlA4TJ4AAAAvP8APEA+wUCtx2n8yaZu28693b2w8XEW23TY3/VMQBEXQFDMzg1AwhPSeHDdVBBH9V+S2bcPcuuv2FapZ3W7uaee+rpa/z3NsoDHS8wAXOwIYfSdO+k98hJhVjj/ui5e+mCNOerLrsNKRVYuROhZ7dlI7WcVJMenmcKHw/OF9wvvN71uSRzq3MM8w30jeOi6gMbnvU/t9nzbyPyqWAA==", Rc = "data:image/webp;base64,UklGRnYAAABXRUJQVlA4TGkAAAAvP8APEA+wUDOxs2TSNm3n3/Cu+HAwaiPJUV+c50JYKANtqQ2UCwAOQpz6LYCI/k+A+hsmxSRFlTaTNoebBjAo4NDgHsCggEODe4cTLri7c8EJe9a2zKGAwZA1ZQ4FDAZQ5llUMCkm9RcA", Pc = "data:image/webp;base64,UklGRq4AAABXRUJQVlA4TKEAAAAvP8APEA+wUCsxsy+Ij0M4qm2ndi5lkCESkIKlOgBpkRIJGb5+M+CmXwMR/Z8A/L0lXpKayBERAWu+Fe22VR1KbK5NLJCUJ6t3JgdrzrqxoWwuFkjKk9U7k4M1Z93YUDbX1jwAFxOLAiM1kaRtEdE1yEjmYoGkPFm9iwngchBrzrqxoWIN8LnEYocoKSdWsYgApIFqZ2swzOSZ3JMjOSffBAA=", Ic = "data:image/webp;base64,UklGRlwAAABXRUJQVlA4TFAAAAAvP8APEA+wUCsxtC+gj0MwaiPJUV/s51BeaAtlIAyDS5vDvSP6PwEY9xWECy0+tMU0xB8gJoBRqQS0xhVsiYBSawhgYtQrSB/aYi60IIRxAw==", Tc = "data:image/webp;base64,UklGRrYAAABXRUJQVlA4TKoAAAAvP8APEA+wUJ/4n1kCAYrC/6suRKcDcm3tjZNnG/iXKkGNzNFPSXQwf2l/KWS2XpK/hTSBUEBE/yeA//hVPvjW3IWkLiUdgFvntTsb5wN8vp24PYEEt0ZohtuyyiEKaQ5U0uoescCSL7SFaaFt8oW64AttYdrUSHMk70KqpM25pnQhnUhTFCBM1E46LDUAvZwG3w+jm7SpI60NoixUH6kOWPouo9fT6Jo/CQ==", Nc = "data:image/webp;base64,UklGRqgAAABXRUJQVlA4TJwAAAAvP8APEA+wUJ/431kCAYrC/6suRKfDUSRZldQTP45IeEYmeOuM52As4WAtIGGPnOgDvP0LiOj/BOAXb05bZz3OKC+Y6CymSQneOalreuGxeDJpcCwOPRu5AsyFjLCJwKjmgFSUIACSc76UHHXEUSc550vJUUc+os9YRAkZKE4dCNQwrKjrEPBYYBcVbYHxTnK4SAJg6MwA+tqo+MM=", Oc = "data:image/webp;base64,UklGRrAAAABXRUJQVlA4TKQAAAAvP8APEA+wUCuxs2QDFIX/v7XHh8NxZNtSchn/khBIw52GZADgkBlm8s1gnn9xF+9dKI0gov8TgB+m4LF1dtw6kVSZOTWpMK/i5WUxmASvw+CthsaJe2dzmtNNOKhgknidjuJQmPVpnxmcMvwLuRTMRBDNlIVpgVHwKp7CtsAoknjNOokoBrGbBTWKJF6TGgAnEUkGAAPJAsCOZAYA5Bb2xeD8KQ==", Uc = "data:image/webp;base64,", Bc = "data:image/webp;base64,UklGRmgAAABXRUJQVlA4TFsAAAAvP8APEA+wUJ/4P+0/2QBF4f97jZH5YBvbVpTnHloCpVgalEYplmC4ewPA3Tyi/xOgJ+82BhEH2TEPhaQRwEhr0N0xBkYP7gGaL/BB8UcuyL5EgSTtYIMB2uDpAA==", Qc = "data:image/webp;base64,", Lc = "data:image/webp;base64,UklGRrYAAABXRUJQVlA4TKkAAAAvP8APEA+wUCuxs2QDFIX/37XGh8NRbdtNRWcYCUiJtJcZtiIlOMgQfnl3LV6hKIjoPwO3bRux+/ad7xXNmyX3GpO+HKCGCgTxA6IAgFMSrbqHOrCIWd1MnbiLRd0RiB4W5IEqjqS117LW37HF33qivOw994VyqD3PhVKorccu9CHehe6/z/33v/xO19/x+jvb72/zsPnYvGx+Jk+br83bz79hcv6PF0sDAA==", Dc = "data:image/webp;base64,", zc = "data:image/webp;base64,UklGRqwAAABXRUJQVlA4TJ8AAAAvP8APEA/wqP+RmNllD0s4im0rjm7PSyR8KUgL0iIFCSx7zvB4rCIgov9q27ZhnKkX+wuOaw0gwfMEJeB5gVl4QBUStIDWpaBm+D5gnuB/gbLAcgKWkwIqV1IjagZ4phYALbRUh2upDtdSKEu3FJaFDv+pA9/cgWc43BmU+CC/3//x//xf/9/5GPDjfDl/zqfz63wb/67HQB/Xa6DfYQ0A", Mc = "data:image/webp;base64,UklGRnYAAABXRUJQVlA4TGkAAAAvP8APEA8wUStx2v8n1McwWEW21eZlEIAEpCCNwRlWcMAnqbR70wVE9H8C5H9zKaUYCQWqhHRGZkOWHci9r5QyFxyJJ9NBNpJIIMK2SwUFkshGDuQLjmQejgLd+zZkWUYmIR2QkjwY+V8A", Fc = /* @__PURE__ */ Object.assign({
  "/src/widget/icons/arrow-left.webp": bl,
  "/src/widget/icons/arrow-right.webp": vl,
  "/src/widget/icons/categories/adjective.webp": Al,
  "/src/widget/icons/categories/all.webp": wl,
  "/src/widget/icons/categories/alphabet.webp": yl,
  "/src/widget/icons/categories/animals.webp": xl,
  "/src/widget/icons/categories/art.webp": kl,
  "/src/widget/icons/categories/asterisk.webp": _l,
  "/src/widget/icons/categories/body.webp": Sl,
  "/src/widget/icons/categories/communication.webp": Cl,
  "/src/widget/icons/categories/countries.webp": El,
  "/src/widget/icons/categories/economy.webp": Rl,
  "/src/widget/icons/categories/education.webp": Pl,
  "/src/widget/icons/categories/family.webp": Il,
  "/src/widget/icons/categories/fashion.webp": Tl,
  "/src/widget/icons/categories/feelings.webp": Nl,
  "/src/widget/icons/categories/foods.webp": Ol,
  "/src/widget/icons/categories/fruits.webp": Ul,
  "/src/widget/icons/categories/health.webp": Bl,
  "/src/widget/icons/categories/jobs.webp": Ql,
  "/src/widget/icons/categories/locations.webp": Ll,
  "/src/widget/icons/categories/machines.webp": Dl,
  "/src/widget/icons/categories/measures.webp": zl,
  "/src/widget/icons/categories/nature.webp": Ml,
  "/src/widget/icons/categories/numbers.webp": Fl,
  "/src/widget/icons/categories/people.webp": Vl,
  "/src/widget/icons/categories/politics.webp": jl,
  "/src/widget/icons/categories/religion.webp": Wl,
  "/src/widget/icons/categories/sports.webp": Gl,
  "/src/widget/icons/categories/technology.webp": Jl,
  "/src/widget/icons/categories/undefined.webp": Hl,
  "/src/widget/icons/categories/verbs.webp": Kl,
  "/src/widget/icons/chevron-down.webp": ql,
  "/src/widget/icons/chevron-left.webp": Xl,
  "/src/widget/icons/chevron-up.webp": Yl,
  "/src/widget/icons/collapse.webp": Zl,
  "/src/widget/icons/comment.webp": $l,
  "/src/widget/icons/dictionary.webp": ec,
  "/src/widget/icons/emotions/angry.webp": tc,
  ...
  "/src/widget/icons/emotions/upset.webp": lc,
  "/src/widget/icons/expand.webp": cc,
  "/src/widget/icons/facebook.webp": dc,
  "/src/widget/icons/govbr.webp": uc,
  "/src/widget/icons/guga.webp": pc,
  "/src/widget/icons/hands.webp": hc,
  "/src/widget/icons/help.webp": mc,
  "/src/widget/icons/hosana.webp": gc,
  "/src/widget/icons/icaro.webp": fc,
  "/src/widget/icons/info.webp": bc,
  "/src/widget/icons/instagram.webp": vc,
  "/src/widget/icons/libras.webp": Ac,
  "/src/widget/icons/like.webp": wc,
  "/src/widget/icons/link.webp": yc,
  "/src/widget/icons/menu.webp": xc,
  "/src/widget/icons/pause.webp": kc,
  "/src/widget/icons/play.webp": _c,
  "/src/widget/icons/repeat.webp": Sc,
  "/src/widget/icons/rotate-left.webp": Cc,
  "/src/widget/icons/settings.webp": Ec,
  "/src/widget/icons/skip.webp": Rc,
  "/src/widget/icons/subtitle-off.webp": Pc,
  "/src/widget/icons/subtitle.webp": Ic,
  "/src/widget/icons/thumbs-down.webp": Tc,
  "/src/widget/icons/thumbs-up.webp": Nc,
  "/src/widget/icons/touch.webp": Oc,
  "/src/widget/icons/translator.webp": Uc,
  "/src/widget/icons/trash.webp": Bc,
  "/src/widget/icons/twitter.webp": Qc,
  "/src/widget/icons/waiting.webp": Lc,
  "/src/widget/icons/worldwide.webp": Dc,
  "/src/widget/icons/x.webp": zc,
  "/src/widget/icons/youtube.webp": Mc
}), R = ({ className: e, name: t, colored: r = !1, style: o, ...n }) => {
  const i = Fc[`/src/widget/icons/${t}.webp`];
  return /* @__PURE__ */ a(
    "i",
    {
      ...n,
...
}, jc = { BASE_URL: "/", DEV: !1, MODE: "production", PROD: !0, SSR: !1, VITE_PUBLIC_POSTHOG_DEBUG: "true", VITE_PUBLIC_POSTHOG_ENABLED: "false", VITE_PUBLIC_POSTHOG_HOST: "https://us.i.posthog.com", VITE_PUBLIC_POSTHOG_PROJECT_TOKEN: "phc_rkupE6DkPSJl7SntaagI0wq0FCKtg3lVP0UkC95NGYe" }, Wc = 1e4, rn = {
  development: {
...
}, wa = "production", Gc = rn[wa] || rn.development, ye = {
  ...jc,
  ...Gc,
  REQUEST_TIMEOUT: Wc,
  MODE: wa
  ...
  e.baseUrl && re(ae.PLAYER, W.SET_BASE_URL, e.baseUrl), e.personalizationUrl && re(ae.CUSTOMIZATION, W.SET_PERSONALIZATION, e.personalizationUrl);
  const { config: t } = P.get();
  P.set({ config: { ...t, ...e } });
}, ue = (e) => {
  if (!e) return re(ae.PLAYER, W.SET_PAUSE_STATE, 0);
  re(ae.PLAYER, W.PLAY, e), P.set({ gloss: e }), Oe.get().onPlay?.(e), P.get().isWelcomeFinished || ya();
}, xa = () => {
  const { showSubtitles: e } = P.get();
  re(ae.PLAYER, W.PLAY_WELCOME), re(ae.PLAYER, W.SET_SUBTITLES_STATE, Number(e)), P.set({ isPlayingWelcome: !0 });
}, xt = (e) => {
  const { region: t } = P.get(), r = `${ye.DICTIONARY_STATIC_URL}${t.abbreviation}/`, o = ye.DICTIONARY_URL;
  yt({ baseUrl: r }), e ? (re(ae.PLAYER, W.PLAY, e), Oe.get().onPlayStatic?.(e)) : re(ae.PLAYER, W.SET_PAUSE_STATE, 0), yt({ baseUrl: o }), P.get().isWelcomeFinished || ya();
}, mo = () => {
  const { gloss: e } = P.get();
  e && ue(e), Oe.get().onRepeat?.();
}, pr = () => {
  re(ae.PLAYER, W.STOP), Oe.get().onStop?.();
}, Rt = () => {
  re(ae.PLAYER, W.SET_PAUSE_STATE, 1), Oe.get().onPause?.();
}, go = (e) => {
  re(ae.PLAYER, W.SET_SPEED, e), P.set({ speed: e });
}, hr = (e) => {
  const t = P.get().avatar, r = (Er.indexOf(e || t) + (e ? 0 : 1)) % Er.length, o = Er[r];
  re(ae.PLAYER, W.SET_AVATAR, o), P.set({ avatar: o });
}, fo = (e) => {
  const { showSubtitles: t } = P.get(), r = e ?? !t;
  re(ae.PLAYER, W.SET_SUBTITLES_STATE, Number(r)), P.set({ showSubtitles: r });
}, Jc = (e) => {
  ...
  re(ae.CUSTOMIZATION, W.SET_SUBTITLE_COLOR, e), re(ae.CUSTOMIZATION, W.SET_SUBTITLE_OUTLINE_COLOR, t || e), re(ae.CUSTOMIZATION, W.SET_SUBTITLE_SHADOW_COLOR, r || e);
        ...
        ln,
        {
          ...
          children: /* @__PURE__ */ a("div", { className: "flex w-full flex-col justify-between gap-2 rounded-lg bg-white p-2", children: [
            /* @__PURE__ */ a("div", { className: "flex w-full items-center justify-between gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 justify-start", children: /* @__PURE__ */ a("img", { src: ml, alt: "logo do Ministério dos Direitos Humanos e da Cidadania" }) }),
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 justify-start", children: /* @__PURE__ */ a("img", { src: gl, alt: "logo do Ministério da Gestão e da Inovação em Serviços Públicos" }) })
            ] }),
            /* @__PURE__ */ a("div", { className: "flex items-center justify-between gap-2", children: [
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 items-center justify-start", children: /* @__PURE__ */ a("img", { src: hl, alt: "logo do lavid", className: "max-w-15" }) }),
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 items-center justify-start", children: /* @__PURE__ */ a("img", { src: fl, alt: "logo da RNP" }) }),
              /* @__PURE__ */ a("div", { className: "flex min-w-0 flex-1 items-center justify-start", children: /* @__PURE__ */ a("img", { src: Ws, alt: "logo da Câmara dos Deputados" }) })
            ] })
          ] })
        }
      ),
...
var Ta = {}, rd = typeof window > "u" || "Deno" in globalThis;
function de() {
}
function od(e, t) {
...
function Qa(e) {
  ...
  const n = Xr(), i = () => n.status !== "pending", s = (f) => {
    ...
    t = !1;
  }, u = () => wo.isFocused() && (e.networkMode === "always" || nr.isOnline()) && e.canRun(), p = () => Ba(e.networkMode) && e.canRun(), m = (f) => {
    i() || (o?.(), n.resolve(f));
  }, d = (f) => {
    i() || (o?.(), n.reject(f));
  }, g = () => new Promise((f) => {
    ...
    Promise.resolve(f).then(m).catch((w) => {
      if (i())
        return;
      const A = e.retry ?? (Ct.isServer() ? 0 : 3), v = e.retryDelay ?? pd, y = typeof v == "function" ? v(r, w) : v, I = A === !0 || typeof A == "number" && r < A || typeof A == "function" && A(r, w);
      if (t || !I) {
        d(w);
        return;
      }
      r++, e.onFail?.(r, w), ad(y).then(() => u() ? void 0 : g()).then(() => {
        t ? d(w) : h();
      });
    });
  };
...
var md = class extends ut {
  ...
  getOptimisticResult(e) {
    ...
    return fd(this, r) && (this.#n = r, this.#a = this.options, this.#o = this.#t.state), r;
  }
  getCurrentResult() {
    return this.#n;
  }
  ...
  #v(e) {
    this.#y(), this.#c = e, !(Ct.isServer() || fe(this.options.enabled, this.#t) === !1 || !Jr(this.#c) || this.#c === 0) && (this.#u = je.setInterval(() => {
  ...
  createResult(e, t) {
    ...
    if (this.options.experimental_prefetchInRender) {
      const x = V.data !== void 0, L = V.status === "error" && !x, se = (he) => {
        L ? he.reject(V.error) : x && he.resolve(V.data);
      }, ie = () => {
        const he = this.#i = V.promise = Xr();
        se(he);
      }, H = this.#i;
      switch (H.status) {
        case "pending":
...
function fn(e, t) {
  return gd(e, t) || e.state.data !== void 0 && Zr(e, t, t.refetchOnMount);
}
function Zr(e, t, r) {
      ...
      const u = async () => {
        ...
        const m = (h) => {
          ...
          const A = (() => {
            ...
            return m(D), D;
          })(), v = await d(A), { maxPages: y } = t.options, I = b ? sd : id;
          return {
            pages: I(h.pages, v, y),
        ...
        if (n && i.length) {
          const h = n === "backward", f = h ? bd : An, b = {
            pages: i,
            pageParams: s
          }, w = f(o, b);
          l = await g(b, w, h);
...
function bd(e, { pages: t, pageParams: r }) {
  return t.length > 0 ? e.getPreviousPageParam?.(t[0], t, r[0], r) : void 0;
}
var vd = class extends La {
  #e;
  #t;
  #r;
  #n;
...
var wd = class extends ut {
  ...
  #s;
  constructor(e = {}) {
    this.#e = e.queryCache || new yd(), this.#t = e.mutationCache || new Ad(), this.#r = e.defaultOptions || {}, this.#n = /* @__PURE__ */ new Map(), this.#o = /* @__PURE__ */ new Map(), this.#a = 0;
  }
  mount() {
...
var Cd = He(Sd()), Ed = () => xe(Cd), Rd = (e, t) => {
  ...
  query: o,
  suspense: n
}) => e.isError && !t.isReset() && !e.isFetching && o && (n && e.data === void 0 || Ua(r, [e.error, o])), Td = (e) => {
  if (e.suspense) {
...
}, Nd = (e, t) => e.isLoading && e.isFetching && !t, Od = (e, t) => e?.suspense && t.isPending, wn = (e, t, r) => t.fetchOptimistic(e).catch(() => {
  r.clearReset();
});
function ja(e, t) {
...
function Ud(e, t, r) {
  ...
  const o = kd(), n = Ed(), i = Va(), s = i.defaultQueryOptions(e);
  ...
  )), s._optimisticResults = o ? "isRestoring" : "optimistic", Td(s), Rd(s, n), Pd(n);
  ...
  return i.getDefaultOptions().queries?._experimental_afterQuery?.(
    s,
    u
  ), s.experimental_prefetchInRender && !Ct.isServer() && Nd(u, o) && (l ? (
...
const ve = {
  ...
  const { controller: e, timeoutId: t } = Ka();
  try {
  ...
  const { controller: t, timeoutId: r } = Ka();
  try {
...
}, Fd = ["#", ..."ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")], Vd = {
  "1S_": "EU",
  "2S_": "VOCÊ",
  "3S_": "ELE(A)",
  "1P_": "NÓS",
...
function Jd(e) {
  ...
  for (const r of e) {
    ...
    if (t[o] ??= { conjugation: [], desambiguation: [] }, r.includes("&"))
      ...
      const n = r.match(kn);
      if (n) {
        const i = n[1] ?? "", s = n[2], l = n[3] ?? "", c = Vd[i] ?? "", u = jd[l] ?? "";
...
const ot = ge()(
  ...
  const e = te(null), t = te(null), r = te(null), o = rt(), [n, i] = O("categories"), { data: s, isLoading: l, refetch: c } = Ja(), { signs: u } = ot(), [p, m] = O(null), [d, g] = O(null), { data: h = [], isLoading: f } = ar({
    queryKey: ["categories"],
    queryFn: zd,
  ...
  }, v = M(() => s ? new Ga(s).searchSigns("") : [], [s]), [{ filteredSigns: y, visibleCount: I, search: D }, V] = O({
    filteredSigns: [],
    search: "",
    visibleCount: we
  }), x = M(() => {
    ...
    (B) => {
      const z = B.toUpperCase().trim(), pe = (n === "all" ? v : u).filter((me) => me.toUpperCase().includes(z));
      V((me) => ({
        ...me,
        search: B,
        filteredSigns: pe,
    ...
    [n, u, v]
  ), se = p?.name === "VERBOS", ie = M(
    () => se ? Jd(x) : {},
    [x, se]
  ), H = M(() => Object.entries(ie), [ie]), [he, ne] = O(we);
  S(() => {
    Y(we), ne(20);
  }, [p]);
  const le = H.slice(0, he), Ae = _e(
    (B) => {
      const z = B.currentTarget;
      z.scrollTop + z.clientHeight >= z.scrollHeight - 50 && ne((me) => Math.min(me + 20, H.length));
    },
    [H.length]
  ), Re = uo(L, 500), E = () => {
  ...
  S(() => {
    ...
    const B = new IntersectionObserver(
      (z) => {
        z[0].isIntersecting && y.length > I && V((pe) => ({ ...pe, visibleCount: pe.visibleCount + we }));
      },
      { threshold: 0.1 }
    );
    return e.current && B.observe(e.current), () => B.disconnect();
  }, [y.length, I]);
  const Qt = y.slice(0, I), Lt = { all: v.length, recents: u.length }, [Xe, Y] = O(we), ce = M(() => x.slice(0, Xe), [x, Xe]), Ye = _e(
    (B) => {
      const z = B.currentTarget;
...
}, { Provider: Kd, useCtx: ke } = Ao(), qd = ({ children: e }) => {
  const t = Hd();
  return /* @__PURE__ */ a(Kd, { data: t, children: e });
}, qe = () => Dd({
  onMutate: (e) => {
...
const Xa = (e) => {
  ...
  const o = new DOMParser().parseFromString(e, "text/html"), n = o.querySelector("tbody")?.innerHTML.match(new RegExp(`title='(?<gender>${Xd.join("|")})'`))?.groups?.gender, i = Array.from(o.querySelectorAll("ol > li")).map((h) => {
    ...
    if (b.length) {
      const w = Array.from(b).map((A) => En(A)).filter(Boolean);
      w.length && (f = `${f} §${w.join("§")}`);
    }
    return f;
  ...
  )?.textContent?.trim(), u = Yd(o), p = {}, m = o.querySelector("table.traduções");
...
}, So = () => /* @__PURE__ */ a("div", { className: "grid h-full place-content-center", children: /* @__PURE__ */ a(_o, {}) }), tu = () => {
  ...
  return r.length ? s.length ? /* @__PURE__ */ a("div", { ref: o, className: "h-full overflow-auto", children: /* @__PURE__ */ a("ul", { className: "flex flex-col", children: [
    s.map((l) => {
      const c = qa[l.id] || "categories/undefined";
      return /* @__PURE__ */ a("li", { children: [
        /* @__PURE__ */ a(
          "button",
          {
  ...
  if (!e) return null;
  const r = qa[e.id] || "categories/undefined";
  ...
  const e = gr(), t = ke(q("visibleVerbGroups", "onVerbScroll", "listRef")), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (c) => {
    try {
      const u = await r(c);
  ...
  const e = gr(), t = ke(q("visibleCategoryWords", "isVerbCategory", "listRef", "onCategoryScroll")), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (u) => {
    try {
      const p = await r(u);
  ...
  if (t.isVerbCategory) return /* @__PURE__ */ a(ou, {});
  const c = M(() => Gd(t.visibleCategoryWords), [t.visibleCategoryWords]);
  ...
  const e = ke(q("visibleLetterWords", "onLetterScroll", "listRef")), t = gr(), { mutateAsync: r } = qe(), { expandedWord: o, wordMeanings: n, loadingMeaning: i, toggleWordMeaning: s } = fr(), l = async (c) => {
    try {
      const u = await r(c);
      ue(u), be.setState({ screen: "main" });
    } catch (u) {
  ...
  if (!e.data && e.filter === "all") return /* @__PURE__ */ a(su, { onRetry: e.retry, isMaxRetries: e.isMaxRetries });
  ...
  return /* @__PURE__ */ a("div", { className: "flex h-full flex-col gap-2 overflow-hidden text-primary dark:text-white", children: [
    /* @__PURE__ */ a(hu, {}),
    /* @__PURE__ */ a(cu, {}),
    e.filter === "categories" && !e.selectedCategory && /* @__PURE__ */ a(tu, {}),
    e.filter === "categories" && e.selectedCategory && /* @__PURE__ */ a(au, {}),
    t && /* @__PURE__ */ a(pu, {}),
    e.filter !== "categories" && !t && !r && /* @__PURE__ */ a(eu, {}),
...
}, gu = () => /* @__PURE__ */ a(qd, { children: /* @__PURE__ */ a(Ea, { children: [
  /* @__PURE__ */ a(Ra, { close: !0, children: /* @__PURE__ */ a(Pa, { children: "Dicionário" }) }),
  /* @__PURE__ */ a(Ia, { className: "overflow-hidden p-0", children: /* @__PURE__ */ a(mu, {}) })
] }) }), fu = () => {
  const e = be((t) => t.screen);
  return /* @__PURE__ */ a(Q, { children: [
    e === "dictionary" && /* @__PURE__ */ a(gu, {}),
    e === "about" && /* @__PURE__ */ a(Yc, {})
  ] });
};
let tt = [], Kt = [];
const Pr = () => Kt.forEach((e) => e([...tt])), ir = (e, t) => {
  ...
  return S(() => bu(t), []), r ? lo(
    /* @__PURE__ */ a("div", { className: "pointer-events-none absolute inset-0 z-2147483647", children: e.map((o) => /* @__PURE__ */ a(Au, { ...o }, o.id)) }),
    r
  ) : null;
}, yu = () => {
...
const _u = () => {
  const e = Ya((n) => n.onClose), { status: t, gloss: r } = X(q("gloss", "status")), o = M(() => r && t === "idle", [r, t]);
  ...
  const e = te(null), t = te(null), { index: r, setIndex: o, onClose: n } = Ya(q("index", "setIndex", "onClose")), i = M(() => r === 0, [r]), s = M(() => r === $r.length - 1, [r]);
  ...
  get: Ce.getState,
  set: Ce.setState
}, Cu = Pt("absolute flex flex-col gap-4 z-50 widget-radius bg-primary p-4 transition-position", {
  variants: {
    isMobile: { true: "", false: "" },
    isLeft: { true: "", false: "" },
    isTop: { true: "", false: "" },
...
}), { Provider: Eu, useCtx: Ya } = Ao(), Ru = () => {
  const { pos: e } = mr(), { innerWidth: t, innerHeight: r } = window, [o, n] = O(0), i = Ce(), s = J((f) => f.isExpanded), l = J((f) => f.isTranslating), c = nt((f) => f.appRoot), u = ee(), p = M(() => e.x < (t - (c?.clientWidth || 0)) / 2, [e.x, t]), m = M(() => e.y < (r - (c?.clientHeight || 0)) / 2, [e.y, r]), d = M(() => $r[o], [o]), g = () => {
    oe.set({ text: void 0 }), P.set({ gloss: void 0 }), Pn.get().reset(), h(), pr();
  };
  if (S(() => {
    l && g();
  }, [l]), S(() => {
  ...
  return /* @__PURE__ */ a(Eu, { data: { index: o, setIndex: n, onClose: g, ...i }, children: /* @__PURE__ */ a(
    "div",
    {
      className: C(
        Cu({ isMobile: u, isLeft: p, isTop: m, isExpanded: s }),
        !s && !u && d.guideClx,
  ...
  const e = Ce((t) => t.open);
  return /* @__PURE__ */ a(Q, { children: e && /* @__PURE__ */ a(Ru, {}) });
}, Iu = Pt("fixed z-2147483647", {
  variants: {
  ...
  const t = (r) => {
    if (r.data?.type === "unity_event") {
      ...
      if (r.data.event === ft.ON_PLAYING_STATE_CHANGE) {
        const { isPlaying: o, isPaused: n, isLoading: i } = Tu(r.data.data);
  ...
  const { path: t } = oa(), r = X((s) => s.isLoaded), o = te(null), n = Ki(`${t}/unity/index.html`), i = (s, l, c) => {
    if (!o.current) return;
  ...
  if (S(() => {
    ...
    return /* @__PURE__ */ a(Q, { children: [
      ...
      /* @__PURE__ */ a(Nu, { path: t })
    ] });
}, Za = ({ variant: e, asChild: t, size: r, className: o, disabled: n, ...i }) => t ? /* @__PURE__ */ a("div", { inert: n, role: "button", tabIndex: 0, className: o, ...i, children: i.children }) : /* @__PURE__ */ a(
  "div",
  {
    "aria-disabled": n,
    inert: n,
        ...
        children: /* @__PURE__ */ a("div", { className: "relative flex items-center justify-center", children: [
          ...
          /* @__PURE__ */ a(
            "ul",
            {
              ...
              children: Object.values(Wr).map((n) => {
                const i = n === t;
                return /* @__PURE__ */ a("li", { children: /* @__PURE__ */ a(
                  "button",
                  {
  ...
  const { max: e, count: t } = X((o) => o.countGloss), r = M(() => e === 0 ? 0 : t / Math.max(e, t) * 100, [e, t]);
  ...
  return !n || !i ? null : lo(
    /* @__PURE__ */ a(Du, { children: /* @__PURE__ */ a(
      "div",
      {
...
}, { Provider: Mu, useCtx: Co } = Ao(), Fu = () => {
  const e = te(null), t = J((n) => n.opacity), r = Co((n) => n.onOpen), o = (n) => {
    oe.set({ opacity: n / 100 }), e.current && clearTimeout(e.current), e.current = setTimeout(() => Ee.trackEvent("opacity_change", { opacity: n }), 2e3);
  };
...
}, Vu = ({ isSelected: e, region: t, onSelect: r }) => /* @__PURE__ */ a(
  "button",
  {
    inert: e,
    type: "button",
  ...
  return /* @__PURE__ */ a("div", { className: "flex w-full items-center justify-between", children: [
    ...
    /* @__PURE__ */ a(Tt, { nested: !0, children: [
      /* @__PURE__ */ a(zu, { className: C(vo({ variant: "ghost" }), "h-auto border p-1"), children: [
  ...
  return /* @__PURE__ */ a(Q, { children: [
    ...
    /* @__PURE__ */ a(Gu, { open: t, onOpenChange: r })
  ] });
}, Hu = [2.5, 2, 1.5, 1, 0.5], Ku = () => {
  ...
  return /* @__PURE__ */ a("div", { className: "dropdown dropdown-center dropdown-top focus-within:**:data-[slot=tooltip-content]:hidden", children: [
    /* @__PURE__ */ a(ze, { offset: 8, content: "Velocidade", placement: "top", arrow: { position: "bottom" }, children: /* @__PURE__ */ a(Za, { "aria-label": "Alterar velocidade", variant: "ghost-gov", size: e ? "icon-sm" : "icon", children: /* @__PURE__ */ a("span", { inert: !0, className: "-mt-0.5 font-bold mobile:text-xs text-sm", children: [
      t,
      "x"
    ] }) }) }),
  ...
  const e = J((o) => o.isOpen), t = Ce((o) => o.open), { onPointerDown: r } = mr();
  return /* @__PURE__ */ a(
    "div",
    {
      className: C(
...
}, Yu = ({ className: e, ...t }) => /* @__PURE__ */ a("div", { className: C("h-4", e), ...t }), Zu = "@media screen and (max-width:640px){body[data-vlibras-expanded=true]{overflow:hidden!important}}", $u = () => {
  ...
  const o = () => {
    aa(Zu, "@expanded-mode.style");
    const { root: s } = De.get(), { isExpanded: l } = oe.get();
    s && (oe.set({ isExpanded: !l }), Ee.trackEvent("expanded"));
...
}, ep = ({ open: e, onOpenChange: t }) => {
  const r = te(null), o = J((d) => d.isTranslating), [n, i] = O(""), { mutateAsync: s, isPending: l } = qe(), c = uo(i, 300), u = async () => {
  ...
  const e = ee(), t = be((i) => i.open), r = Ce((i) => i.onOpenChange), [o, n] = O(!1);
  return /* @__PURE__ */ a(Q, { children: [
    ...
    /* @__PURE__ */ a(ep, { open: o, onOpenChange: n })
  ] });
}, rp = () => {
  const { onPointerDown: e } = mr(), t = ee(), r = J((i) => i.setOpen), o = Ce((i) => i.open), n = () => {
    r(!1), Rt();
  };
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ a(Q, { children: [
            /* @__PURE__ */ a(Yu, { className: "w-full" }),
...
const ip = ({ suggestions: e, coords: t, onSelect: r }) => e.length === 0 ? null : /* @__PURE__ */ a(
  "div",
  {
  ...
  const r = te(null), o = ee(), { data: n } = Ja(), { mutateAsync: i, isPending: s } = Ha(), [l, c] = O([]), [u, p] = O({ top: 0, left: 0 }), [m, d] = O(""), g = !m.trim();
  S(() => d(P.get().gloss || ""), []);
  const h = M(() => n ? new Ga(n) : null, [n]), f = uo(() => {
    if (!r.current) return;
  ...
  return /* @__PURE__ */ a(Tt, { open: e, onOpenChange: t, children: /* @__PURE__ */ a(Ut, { children: [
    ...
    /* @__PURE__ */ a("div", { className: "flex h-full flex-col gap-2 px-4 py-4", children: [
      ...
      /* @__PURE__ */ a("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ a(ip, { onSelect: (A) => {
          if (!r.current) return;
          const v = r.current.selectionStart ?? 0;
          d(np(m, v, A)), c([]), r.current.focus();
  ...
  const [r, o] = O(!1), { mutateAsync: n, isPending: i } = Ha();
  return /* @__PURE__ */ a(Q, { children: [
    ...
    /* @__PURE__ */ a(sp, { open: r, onOpenChange: o })
  ] });
}, cp = () => {
  ...
  return Ce((i) => i.open) ? null : /* @__PURE__ */ a(Q, { children: [
    ...
    /* @__PURE__ */ a(lp, { open: e, onOpenChange: t })
  ] });
}, Ir = [
  ...
  const e = X((n) => n.avatar), t = Ce((n) => n.open), r = Ir.find(({ name: n }) => n === e) || Ir[0], o = (n) => {
        ...
        /* @__PURE__ */ a("ul", { className: "dropdown-content mb-2 space-y-2", children: Ir.filter(({ name: n }) => n !== e).map((n) => /* @__PURE__ */ a("li", { className: "flex animate-move-up items-center justify-end gap-2", children: [
          ...
          /* @__PURE__ */ a(
            U,
            {
              ...
              size: "icon",
              children: /* @__PURE__ */ a("img", { src: dp(n.path), alt: n.name })
            }
          )
        ] }, n.name)) })
      ]
  ...
  const e = ee(), t = Ce((v) => v.open), { status: r, gloss: o, isPlayingWelcome: n } = X(q("status", "gloss", "isPlayingWelcome")), { isExpanded: i, isTranslating: s, text: l } = J(q("isExpanded", "text", "isTranslating")), { action: c, content: u } = kt(q("action", "content")), p = r === "playing", m = r === "paused", d = r === "idle";
  S(() => {
    if (!d) return;
  ...
  const r = be((n) => n.screen), o = X((n) => n.isLoaded);
  return /* @__PURE__ */ a(
    "div",
    {
      ...t,
  ...
  const e = be((n) => n.screen), { isOpen: t, position: r, isExpanded: o } = J(q("isOpen", "position", "isExpanded"));
  return /* @__PURE__ */ a(Kc, { children: ({ ref: n, hasMoved: i, pos: s, isDragging: l, reset: c }) => (S(() => {
    !t && c();
  }, [t]), /* @__PURE__ */ a(
    "div",
    {
  ...
  return S(() => {
    ...
    if (r && e.current) {
      l(Ap({ event: r, tooltip: e.current }));
      const c = e.current;
  ...
  return null;
}, Tr = (e) => Ip?.contains(e) || e.matches(".vlibras-links") ? !1 : Qp(e) || $a(e) || Eo(e) || Op(e) || Up(e), Se = (e, t) => t.includes(e.tagName), Np = (e) => Se(e, ["A", "BUTTON"]), Eo = (e) => Se(e, "INPUT") && e.type === "submit", Op = (e) => Se(e, "IMG") && e.alt && e.alt.trim(), Up = (e) => Se(e, "SELECT"), Bp = (e) => Se(e, ["SVG", "PATH"]), Qp = (e) => {
  ...
  const n = (p) => {
    ...
    if (Xt.set({ isActive: !1 }), Mp(o), g || m.classList.add(o), !Tr(m)) return;
    ...
    if (p.preventDefault(), p.stopPropagation(), t && r) {
      ...
      const f = !!m.dataset.vlibrasGloss?.trim(), b = Tp(m)?.trim();
      b && e?.({ text: b, element: m, isGloss: f });
    }
    const h = m.tagName === "A" ? m : $a(m);
  ...
  S(() => {
    e && (t ? aa(Rp, "@text-capture.style") : Yi("@text-capture.style"));
  }, [t, e]), S(() => {
    if (!e) return;
    const o = Fp({
...
}, Wp = () => (Vp(), xp(), jp(), Ep(), kp(), Cp(), _p(), null), Gp = ({ children: e, root: t }) => {
  const [r, o] = O(!1);
  return S(() => {
    t && ku(t, () => o(!0));
  }, [t]), r ? /* @__PURE__ */ a(yp, { root: t, children: /* @__PURE__ */ a(_d, { client: bp, children: [
    /* @__PURE__ */ a(wp, {}),
    /* @__PURE__ */ a(Wp, {}),
    e
  ] }) }) : null;
...
function Jp() {
  const { setOpen: e, isLoaded: t, setLoaded: r } = J(q("setOpen", "isLoaded", "setLoaded")), { path: o } = oa();
  return S(() => De.set({ root: Nr, shadowRoot: vt }), [Nr, vt]), S(() => {
    Ee.trackLoad();
  }, []), S(() => {
    if (!o || ((async () => (await Zi(o, vt), r(!0)))(), !t)) return;
    e(Tn());
  ...
  }, [o, e, t, r]), t ? /* @__PURE__ */ a(Gp, { root: vt, children: /* @__PURE__ */ a(fp, {}) }) : null;
}
it(/* @__PURE__ */ a(Jp, {}), vt);
